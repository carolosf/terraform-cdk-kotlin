...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.workspaces.DataAwsWorkspacesDirectoryWorkspaceAccessPropertiesList")
public class DataAwsWorkspacesDirectoryWorkspaceAccessPropertiesList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsWorkspacesDirectoryWorkspaceAccessPropertiesList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsWorkspacesDirectoryWorkspaceAccessPropertiesList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.workspaces.DataAwsWorkspacesDirectoryWorkspaceAccessPropertiesOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.workspaces.DataAwsWorkspacesDirectoryWorkspaceAccessPropertiesOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
