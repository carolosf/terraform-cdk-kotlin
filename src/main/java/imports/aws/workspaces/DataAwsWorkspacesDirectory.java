 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:20.601Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.workspaces.DataAwsWorkspacesDirectory")
public class DataAwsWorkspacesDirectory extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsWorkspacesDirectory(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsWorkspacesDirectory(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.workspaces.DataAwsWorkspacesDirectory.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsWorkspacesDirectory(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.workspaces.DataAwsWorkspacesDirectoryConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.workspaces.DataAwsWorkspacesDirectorySelfServicePermissionsList getSelfServicePermissions() {
        return software.amazon.jsii.Kernel.get(this, "selfServicePermissions", software.amazon.jsii.NativeType.forClass(imports.aws.workspaces.DataAwsWorkspacesDirectorySelfServicePermissionsList.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.workspaces.DataAwsWorkspacesDirectoryWorkspaceAccessPropertiesList getWorkspaceAccessProperties() {
        return software.amazon.jsii.Kernel.get(this, "workspaceAccessProperties", software.amazon.jsii.NativeType.forClass(imports.aws.workspaces.DataAwsWorkspacesDirectoryWorkspaceAccessPropertiesList.class));
    }

    public @org.jetbrains.annotations.NotNull imports.aws.workspaces.DataAwsWorkspacesDirectoryWorkspaceCreationPropertiesList getWorkspaceCreationProperties() {
        return software.amazon.jsii.Kernel.get(this, "workspaceCreationProperties", software.amazon.jsii.NativeType.forClass(imports.aws.workspaces.DataAwsWorkspacesDirectoryWorkspaceCreationPropertiesList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.workspaces.DataAwsWorkspacesDirectory}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.workspaces.DataAwsWorkspacesDirectory> {
        /**
        ...
        private final imports.aws.workspaces.DataAwsWorkspacesDirectoryConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.workspaces.DataAwsWorkspacesDirectoryConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param directoryId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/workspaces_directory#directory_id DataAwsWorkspacesDirectory#directory_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/workspaces_directory#id DataAwsWorkspacesDirectory#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/workspaces_directory#tags DataAwsWorkspacesDirectory#tags}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.workspaces.DataAwsWorkspacesDirectory}.
         */
        @Override
        public imports.aws.workspaces.DataAwsWorkspacesDirectory build() {
            return new imports.aws.workspaces.DataAwsWorkspacesDirectory(
                this.scope,
                this.id,
                this.config.build()
            );
