 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:20.602Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.workspaces.DataAwsWorkspacesWorkspace")
public class DataAwsWorkspacesWorkspace extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsWorkspacesWorkspace(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsWorkspacesWorkspace(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.workspaces.DataAwsWorkspacesWorkspace.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     * @param config
     */
    public DataAwsWorkspacesWorkspace(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.workspaces.DataAwsWorkspacesWorkspaceConfig config) {
     ...
     * @param id The scoped construct ID. This parameter is required.
     */
    public DataAwsWorkspacesWorkspace(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
    ...
    public void resetWorkspaceId() {
        software.amazon.jsii.Kernel.call(this, "resetWorkspaceId", software.amazon.jsii.NativeType.VOID);
    }
    ...
    public @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IResolvable getRootVolumeEncryptionEnabled() {
        return software.amazon.jsii.Kernel.get(this, "rootVolumeEncryptionEnabled", software.amazon.jsii.NativeType.forClass(com.hashicorp.cdktf.IResolvable.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IResolvable getUserVolumeEncryptionEnabled() {
        return software.amazon.jsii.Kernel.get(this, "userVolumeEncryptionEnabled", software.amazon.jsii.NativeType.forClass(com.hashicorp.cdktf.IResolvable.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.workspaces.DataAwsWorkspacesWorkspaceWorkspacePropertiesList getWorkspaceProperties() {
        return software.amazon.jsii.Kernel.get(this, "workspaceProperties", software.amazon.jsii.NativeType.forClass(imports.aws.workspaces.DataAwsWorkspacesWorkspaceWorkspacePropertiesList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.workspaces.DataAwsWorkspacesWorkspace}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.workspaces.DataAwsWorkspacesWorkspace> {
        /**
        ...
        private imports.aws.workspaces.DataAwsWorkspacesWorkspaceConfig.Builder config;
         ...
         * <p>
         * @return {@code this}
         * @param directoryId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/workspaces_workspace#directory_id DataAwsWorkspacesWorkspace#directory_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/workspaces_workspace#id DataAwsWorkspacesWorkspace#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/workspaces_workspace#tags DataAwsWorkspacesWorkspace#tags}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param userName Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/workspaces_workspace#user_name DataAwsWorkspacesWorkspace#user_name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param workspaceId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/workspaces_workspace#workspace_id DataAwsWorkspacesWorkspace#workspace_id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.workspaces.DataAwsWorkspacesWorkspace}.
         */
        @Override
        public imports.aws.workspaces.DataAwsWorkspacesWorkspace build() {
            return new imports.aws.workspaces.DataAwsWorkspacesWorkspace(
                this.scope,
                this.id,
        ...
        private imports.aws.workspaces.DataAwsWorkspacesWorkspaceConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.workspaces.DataAwsWorkspacesWorkspaceConfig.Builder();
            }
            return this.config;
        }
    }
