...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:19.153Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.appmesh.AppmeshRouteSpecGrpcRouteTimeout")
...
public interface AppmeshRouteSpecGrpcRouteTimeout extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.aws.appmesh.AppmeshRouteSpecGrpcRouteTimeoutIdle getIdle() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.aws.appmesh.AppmeshRouteSpecGrpcRouteTimeoutPerRequest getPerRequest() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<AppmeshRouteSpecGrpcRouteTimeout> {
        imports.aws.appmesh.AppmeshRouteSpecGrpcRouteTimeoutIdle idle;
        imports.aws.appmesh.AppmeshRouteSpecGrpcRouteTimeoutPerRequest perRequest;
         ...
         * @return {@code this}
         */
        public Builder idle(imports.aws.appmesh.AppmeshRouteSpecGrpcRouteTimeoutIdle idle) {
            this.idle = idle;
            return this;
        }
         ...
         * @return {@code this}
         */
        public Builder perRequest(imports.aws.appmesh.AppmeshRouteSpecGrpcRouteTimeoutPerRequest perRequest) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements AppmeshRouteSpecGrpcRouteTimeout {
        private final imports.aws.appmesh.AppmeshRouteSpecGrpcRouteTimeoutIdle idle;
        private final imports.aws.appmesh.AppmeshRouteSpecGrpcRouteTimeoutPerRequest perRequest;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.idle = software.amazon.jsii.Kernel.get(this, "idle", software.amazon.jsii.NativeType.forClass(imports.aws.appmesh.AppmeshRouteSpecGrpcRouteTimeoutIdle.class));
            this.perRequest = software.amazon.jsii.Kernel.get(this, "perRequest", software.amazon.jsii.NativeType.forClass(imports.aws.appmesh.AppmeshRouteSpecGrpcRouteTimeoutPerRequest.class));
        }
        ...
        @Override
        public final imports.aws.appmesh.AppmeshRouteSpecGrpcRouteTimeoutIdle getIdle() {
            return this.idle;
        }

        @Override
        public final imports.aws.appmesh.AppmeshRouteSpecGrpcRouteTimeoutPerRequest getPerRequest() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.appmesh.AppmeshRouteSpecGrpcRouteTimeout"));
