...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.appmesh.AppmeshVirtualNodeSpecLoggingAccessLog")
...
public interface AppmeshVirtualNodeSpecLoggingAccessLog extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.aws.appmesh.AppmeshVirtualNodeSpecLoggingAccessLogFile getFile() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<AppmeshVirtualNodeSpecLoggingAccessLog> {
        imports.aws.appmesh.AppmeshVirtualNodeSpecLoggingAccessLogFile file;
         ...
         * @return {@code this}
         */
        public Builder file(imports.aws.appmesh.AppmeshVirtualNodeSpecLoggingAccessLogFile file) {
            this.file = file;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements AppmeshVirtualNodeSpecLoggingAccessLog {
        private final imports.aws.appmesh.AppmeshVirtualNodeSpecLoggingAccessLogFile file;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.file = software.amazon.jsii.Kernel.get(this, "file", software.amazon.jsii.NativeType.forClass(imports.aws.appmesh.AppmeshVirtualNodeSpecLoggingAccessLogFile.class));
        }
        ...
        @Override
        public final imports.aws.appmesh.AppmeshVirtualNodeSpecLoggingAccessLogFile getFile() {
            return this.file;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.appmesh.AppmeshVirtualNodeSpecLoggingAccessLog"));
