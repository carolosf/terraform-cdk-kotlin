...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.appmesh.AppmeshVirtualNodeSpecListenerTlsCertificateFile")
@software.amazon.jsii.Jsii.Proxy(AppmeshVirtualNodeSpecListenerTlsCertificateFile.Jsii$Proxy.class)
public interface AppmeshVirtualNodeSpecListenerTlsCertificateFile extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link AppmeshVirtualNodeSpecListenerTlsCertificateFile}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link AppmeshVirtualNodeSpecListenerTlsCertificateFile}
     */
    public static final class Builder implements software.amazon.jsii.Builder<AppmeshVirtualNodeSpecListenerTlsCertificateFile> {
        java.lang.String certificateChain;
        java.lang.String privateKey;

        /**
         * Sets the value of {@link AppmeshVirtualNodeSpecListenerTlsCertificateFile#getCertificateChain}
        ...
        /**
         * Sets the value of {@link AppmeshVirtualNodeSpecListenerTlsCertificateFile#getPrivateKey}
         ...
         * @return a new instance of {@link AppmeshVirtualNodeSpecListenerTlsCertificateFile}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public AppmeshVirtualNodeSpecListenerTlsCertificateFile build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link AppmeshVirtualNodeSpecListenerTlsCertificateFile}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements AppmeshVirtualNodeSpecListenerTlsCertificateFile {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.appmesh.AppmeshVirtualNodeSpecListenerTlsCertificateFile"));
        ...
        public final boolean equals(final Object o) {
            ...
            AppmeshVirtualNodeSpecListenerTlsCertificateFile.Jsii$Proxy that = (AppmeshVirtualNodeSpecListenerTlsCertificateFile.Jsii$Proxy) o;
