...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.appmesh.AppmeshRouteSpecTcpRouteAction")
...
public interface AppmeshRouteSpecTcpRouteAction extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<AppmeshRouteSpecTcpRouteAction> {
         ...
         * @return {@code this}
         */
        public Builder weightedTarget(java.util.List<? extends imports.aws.appmesh.AppmeshRouteSpecTcpRouteActionWeightedTarget> weightedTarget) {
            this.weightedTarget = weightedTarget;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements AppmeshRouteSpecTcpRouteAction {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.appmesh.AppmeshRouteSpecTcpRouteAction"));
