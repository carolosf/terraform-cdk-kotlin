...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.appmesh.AppmeshVirtualRouter")
public class AppmeshVirtualRouter extends com.hashicorp.cdktf.TerraformResource {

    protected AppmeshVirtualRouter(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected AppmeshVirtualRouter(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.appmesh.AppmeshVirtualRouter.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public AppmeshVirtualRouter(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.appmesh.AppmeshVirtualRouterConfig config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public void putSpec(final @org.jetbrains.annotations.NotNull imports.aws.appmesh.AppmeshVirtualRouterSpec value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.appmesh.AppmeshVirtualRouterSpecOutputReference getSpec() {
        return software.amazon.jsii.Kernel.get(this, "spec", software.amazon.jsii.NativeType.forClass(imports.aws.appmesh.AppmeshVirtualRouterSpecOutputReference.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.appmesh.AppmeshVirtualRouterSpec getSpecInput() {
        return software.amazon.jsii.Kernel.get(this, "specInput", software.amazon.jsii.NativeType.forClass(imports.aws.appmesh.AppmeshVirtualRouterSpec.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.appmesh.AppmeshVirtualRouter}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.appmesh.AppmeshVirtualRouter> {
        /**
        ...
        private final imports.aws.appmesh.AppmeshVirtualRouterConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.appmesh.AppmeshVirtualRouterConfig.Builder();
        }
         ...
         */
        public Builder spec(final imports.aws.appmesh.AppmeshVirtualRouterSpec spec) {
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/appmesh_virtual_router#id AppmeshVirtualRouter#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param meshOwner Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/appmesh_virtual_router#mesh_owner AppmeshVirtualRouter#mesh_owner}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/appmesh_virtual_router#tags AppmeshVirtualRouter#tags}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tagsAll Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/appmesh_virtual_router#tags_all AppmeshVirtualRouter#tags_all}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.appmesh.AppmeshVirtualRouter}.
         */
        @Override
        public imports.aws.appmesh.AppmeshVirtualRouter build() {
            return new imports.aws.appmesh.AppmeshVirtualRouter(
                this.scope,
                this.id,
                this.config.build()
            );
