...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.appmesh.AppmeshVirtualGatewaySpecListenerTlsCertificateFile")
@software.amazon.jsii.Jsii.Proxy(AppmeshVirtualGatewaySpecListenerTlsCertificateFile.Jsii$Proxy.class)
public interface AppmeshVirtualGatewaySpecListenerTlsCertificateFile extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link AppmeshVirtualGatewaySpecListenerTlsCertificateFile}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link AppmeshVirtualGatewaySpecListenerTlsCertificateFile}
     */
    public static final class Builder implements software.amazon.jsii.Builder<AppmeshVirtualGatewaySpecListenerTlsCertificateFile> {
        java.lang.String certificateChain;
        java.lang.String privateKey;

        /**
         * Sets the value of {@link AppmeshVirtualGatewaySpecListenerTlsCertificateFile#getCertificateChain}
        ...
        /**
         * Sets the value of {@link AppmeshVirtualGatewaySpecListenerTlsCertificateFile#getPrivateKey}
         ...
         * @return a new instance of {@link AppmeshVirtualGatewaySpecListenerTlsCertificateFile}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public AppmeshVirtualGatewaySpecListenerTlsCertificateFile build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link AppmeshVirtualGatewaySpecListenerTlsCertificateFile}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements AppmeshVirtualGatewaySpecListenerTlsCertificateFile {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.appmesh.AppmeshVirtualGatewaySpecListenerTlsCertificateFile"));
        ...
        public final boolean equals(final Object o) {
            ...
            AppmeshVirtualGatewaySpecListenerTlsCertificateFile.Jsii$Proxy that = (AppmeshVirtualGatewaySpecListenerTlsCertificateFile.Jsii$Proxy) o;
