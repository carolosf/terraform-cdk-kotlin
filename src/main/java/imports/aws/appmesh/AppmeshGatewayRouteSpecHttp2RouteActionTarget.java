...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.appmesh.AppmeshGatewayRouteSpecHttp2RouteActionTarget")
...
public interface AppmeshGatewayRouteSpecHttp2RouteActionTarget extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull imports.aws.appmesh.AppmeshGatewayRouteSpecHttp2RouteActionTargetVirtualService getVirtualService();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<AppmeshGatewayRouteSpecHttp2RouteActionTarget> {
        imports.aws.appmesh.AppmeshGatewayRouteSpecHttp2RouteActionTargetVirtualService virtualService;
         ...
         * @return {@code this}
         */
        public Builder virtualService(imports.aws.appmesh.AppmeshGatewayRouteSpecHttp2RouteActionTargetVirtualService virtualService) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements AppmeshGatewayRouteSpecHttp2RouteActionTarget {
        private final imports.aws.appmesh.AppmeshGatewayRouteSpecHttp2RouteActionTargetVirtualService virtualService;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.virtualService = software.amazon.jsii.Kernel.get(this, "virtualService", software.amazon.jsii.NativeType.forClass(imports.aws.appmesh.AppmeshGatewayRouteSpecHttp2RouteActionTargetVirtualService.class));
        }
        ...
        @Override
        public final imports.aws.appmesh.AppmeshGatewayRouteSpecHttp2RouteActionTargetVirtualService getVirtualService() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.appmesh.AppmeshGatewayRouteSpecHttp2RouteActionTarget"));
