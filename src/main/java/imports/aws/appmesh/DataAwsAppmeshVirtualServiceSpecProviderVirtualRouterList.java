...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.appmesh.DataAwsAppmeshVirtualServiceSpecProviderVirtualRouterList")
public class DataAwsAppmeshVirtualServiceSpecProviderVirtualRouterList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsAppmeshVirtualServiceSpecProviderVirtualRouterList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsAppmeshVirtualServiceSpecProviderVirtualRouterList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.appmesh.DataAwsAppmeshVirtualServiceSpecProviderVirtualRouterOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.appmesh.DataAwsAppmeshVirtualServiceSpecProviderVirtualRouterOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
