...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:19.155Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.appmesh.AppmeshRouteSpecHttp2RouteRetryPolicy")
@software.amazon.jsii.Jsii.Proxy(AppmeshRouteSpecHttp2RouteRetryPolicy.Jsii$Proxy.class)
public interface AppmeshRouteSpecHttp2RouteRetryPolicy extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull imports.aws.appmesh.AppmeshRouteSpecHttp2RouteRetryPolicyPerRetryTimeout getPerRetryTimeout();
    ...
    /**
     * @return a {@link Builder} of {@link AppmeshRouteSpecHttp2RouteRetryPolicy}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link AppmeshRouteSpecHttp2RouteRetryPolicy}
     */
    public static final class Builder implements software.amazon.jsii.Builder<AppmeshRouteSpecHttp2RouteRetryPolicy> {
        ...
        imports.aws.appmesh.AppmeshRouteSpecHttp2RouteRetryPolicyPerRetryTimeout perRetryTimeout;
        java.util.List<java.lang.String> httpRetryEvents;
        java.util.List<java.lang.String> tcpRetryEvents;

        /**
         * Sets the value of {@link AppmeshRouteSpecHttp2RouteRetryPolicy#getMaxRetries}
        ...
        /**
         * Sets the value of {@link AppmeshRouteSpecHttp2RouteRetryPolicy#getPerRetryTimeout}
         * @param perRetryTimeout per_retry_timeout block. This parameter is required.
         *                        Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/aws/r/appmesh_route#per_retry_timeout AppmeshRoute#per_retry_timeout}
         * @return {@code this}
         */
        public Builder perRetryTimeout(imports.aws.appmesh.AppmeshRouteSpecHttp2RouteRetryPolicyPerRetryTimeout perRetryTimeout) {
            this.perRetryTimeout = perRetryTimeout;
            return this;
        }

        /**
         * Sets the value of {@link AppmeshRouteSpecHttp2RouteRetryPolicy#getHttpRetryEvents}
        ...
        /**
         * Sets the value of {@link AppmeshRouteSpecHttp2RouteRetryPolicy#getTcpRetryEvents}
         ...
         * @return a new instance of {@link AppmeshRouteSpecHttp2RouteRetryPolicy}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public AppmeshRouteSpecHttp2RouteRetryPolicy build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link AppmeshRouteSpecHttp2RouteRetryPolicy}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements AppmeshRouteSpecHttp2RouteRetryPolicy {
        private final java.lang.Number maxRetries;
        private final imports.aws.appmesh.AppmeshRouteSpecHttp2RouteRetryPolicyPerRetryTimeout perRetryTimeout;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.perRetryTimeout = software.amazon.jsii.Kernel.get(this, "perRetryTimeout", software.amazon.jsii.NativeType.forClass(imports.aws.appmesh.AppmeshRouteSpecHttp2RouteRetryPolicyPerRetryTimeout.class));
        ...
        @Override
        public final imports.aws.appmesh.AppmeshRouteSpecHttp2RouteRetryPolicyPerRetryTimeout getPerRetryTimeout() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.appmesh.AppmeshRouteSpecHttp2RouteRetryPolicy"));
        ...
        public final boolean equals(final Object o) {
            ...
            AppmeshRouteSpecHttp2RouteRetryPolicy.Jsii$Proxy that = (AppmeshRouteSpecHttp2RouteRetryPolicy.Jsii$Proxy) o;
