...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.lakeformation.LakeformationPermissions")
public class LakeformationPermissions extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.lakeformation.LakeformationPermissions.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public LakeformationPermissions(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.lakeformation.LakeformationPermissionsConfig config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public void putDatabase(final @org.jetbrains.annotations.NotNull imports.aws.lakeformation.LakeformationPermissionsDatabase value) {
    ...
    public void putDataLocation(final @org.jetbrains.annotations.NotNull imports.aws.lakeformation.LakeformationPermissionsDataLocation value) {
    ...
    public void putTable(final @org.jetbrains.annotations.NotNull imports.aws.lakeformation.LakeformationPermissionsTable value) {
    ...
    public void putTableWithColumns(final @org.jetbrains.annotations.NotNull imports.aws.lakeformation.LakeformationPermissionsTableWithColumns value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.lakeformation.LakeformationPermissionsDatabaseOutputReference getDatabase() {
        return software.amazon.jsii.Kernel.get(this, "database", software.amazon.jsii.NativeType.forClass(imports.aws.lakeformation.LakeformationPermissionsDatabaseOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull imports.aws.lakeformation.LakeformationPermissionsDataLocationOutputReference getDataLocation() {
        return software.amazon.jsii.Kernel.get(this, "dataLocation", software.amazon.jsii.NativeType.forClass(imports.aws.lakeformation.LakeformationPermissionsDataLocationOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull imports.aws.lakeformation.LakeformationPermissionsTableOutputReference getTable() {
        return software.amazon.jsii.Kernel.get(this, "table", software.amazon.jsii.NativeType.forClass(imports.aws.lakeformation.LakeformationPermissionsTableOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull imports.aws.lakeformation.LakeformationPermissionsTableWithColumnsOutputReference getTableWithColumns() {
        return software.amazon.jsii.Kernel.get(this, "tableWithColumns", software.amazon.jsii.NativeType.forClass(imports.aws.lakeformation.LakeformationPermissionsTableWithColumnsOutputReference.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.lakeformation.LakeformationPermissionsDatabase getDatabaseInput() {
        return software.amazon.jsii.Kernel.get(this, "databaseInput", software.amazon.jsii.NativeType.forClass(imports.aws.lakeformation.LakeformationPermissionsDatabase.class));
    }

    public @org.jetbrains.annotations.Nullable imports.aws.lakeformation.LakeformationPermissionsDataLocation getDataLocationInput() {
        return software.amazon.jsii.Kernel.get(this, "dataLocationInput", software.amazon.jsii.NativeType.forClass(imports.aws.lakeformation.LakeformationPermissionsDataLocation.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.lakeformation.LakeformationPermissionsTable getTableInput() {
        return software.amazon.jsii.Kernel.get(this, "tableInput", software.amazon.jsii.NativeType.forClass(imports.aws.lakeformation.LakeformationPermissionsTable.class));
    }

    public @org.jetbrains.annotations.Nullable imports.aws.lakeformation.LakeformationPermissionsTableWithColumns getTableWithColumnsInput() {
        return software.amazon.jsii.Kernel.get(this, "tableWithColumnsInput", software.amazon.jsii.NativeType.forClass(imports.aws.lakeformation.LakeformationPermissionsTableWithColumns.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.lakeformation.LakeformationPermissions}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.lakeformation.LakeformationPermissions> {
        /**
        ...
        private final imports.aws.lakeformation.LakeformationPermissionsConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.lakeformation.LakeformationPermissionsConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param catalogId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/lakeformation_permissions#catalog_id LakeformationPermissions#catalog_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param catalogResource Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/lakeformation_permissions#catalog_resource LakeformationPermissions#catalog_resource}. This parameter is required.
         */
         ...
         */
        public Builder database(final imports.aws.lakeformation.LakeformationPermissionsDatabase database) {
         ...
         */
        public Builder dataLocation(final imports.aws.lakeformation.LakeformationPermissionsDataLocation dataLocation) {
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/lakeformation_permissions#id LakeformationPermissions#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param permissionsWithGrantOption Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/lakeformation_permissions#permissions_with_grant_option LakeformationPermissions#permissions_with_grant_option}. This parameter is required.
         */
         ...
         */
        public Builder table(final imports.aws.lakeformation.LakeformationPermissionsTable table) {
         ...
         */
        public Builder tableWithColumns(final imports.aws.lakeformation.LakeformationPermissionsTableWithColumns tableWithColumns) {
            this.config.tableWithColumns(tableWithColumns);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.lakeformation.LakeformationPermissions}.
         */
        @Override
        public imports.aws.lakeformation.LakeformationPermissions build() {
            return new imports.aws.lakeformation.LakeformationPermissions(
                this.scope,
                this.id,
                this.config.build()
            );
