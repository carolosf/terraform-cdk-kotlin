...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.lakeformation.DataAwsLakeformationPermissionsTableWithColumnsOutputReference")
public class DataAwsLakeformationPermissionsTableWithColumnsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsLakeformationPermissionsTableWithColumnsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsLakeformationPermissionsTableWithColumnsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public DataAwsLakeformationPermissionsTableWithColumnsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.lakeformation.DataAwsLakeformationPermissionsTableWithColumns getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.lakeformation.DataAwsLakeformationPermissionsTableWithColumns.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.lakeformation.DataAwsLakeformationPermissionsTableWithColumns value) {
