...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.rds.DbProxyDefaultTargetGroupTimeouts")
@software.amazon.jsii.Jsii.Proxy(DbProxyDefaultTargetGroupTimeouts.Jsii$Proxy.class)
public interface DbProxyDefaultTargetGroupTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DbProxyDefaultTargetGroupTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DbProxyDefaultTargetGroupTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DbProxyDefaultTargetGroupTimeouts> {
        java.lang.String create;
        java.lang.String update;

        /**
         * Sets the value of {@link DbProxyDefaultTargetGroupTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link DbProxyDefaultTargetGroupTimeouts#getUpdate}
         ...
         * @return a new instance of {@link DbProxyDefaultTargetGroupTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DbProxyDefaultTargetGroupTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DbProxyDefaultTargetGroupTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DbProxyDefaultTargetGroupTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.rds.DbProxyDefaultTargetGroupTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            DbProxyDefaultTargetGroupTimeouts.Jsii$Proxy that = (DbProxyDefaultTargetGroupTimeouts.Jsii$Proxy) o;
