...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.rds.DataAwsDbEventCategories")
public class DataAwsDbEventCategories extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.rds.DataAwsDbEventCategories.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     * @param config
     */
    public DataAwsDbEventCategories(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.rds.DataAwsDbEventCategoriesConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.rds.DataAwsDbEventCategories}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.rds.DataAwsDbEventCategories> {
        /**
        ...
        private imports.aws.rds.DataAwsDbEventCategoriesConfig.Builder config;
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/db_event_categories#id DataAwsDbEventCategories#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param sourceType Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/db_event_categories#source_type DataAwsDbEventCategories#source_type}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.rds.DataAwsDbEventCategories}.
         */
        @Override
        public imports.aws.rds.DataAwsDbEventCategories build() {
            return new imports.aws.rds.DataAwsDbEventCategories(
                this.scope,
                this.id,
        ...
        private imports.aws.rds.DataAwsDbEventCategoriesConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.rds.DataAwsDbEventCategoriesConfig.Builder();
            }
            return this.config;
        }
    }
