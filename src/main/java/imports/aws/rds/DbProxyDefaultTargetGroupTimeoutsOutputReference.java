...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.rds.DbProxyDefaultTargetGroupTimeoutsOutputReference")
public class DbProxyDefaultTargetGroupTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DbProxyDefaultTargetGroupTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DbProxyDefaultTargetGroupTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public DbProxyDefaultTargetGroupTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.rds.DbProxyDefaultTargetGroupTimeouts value) {
