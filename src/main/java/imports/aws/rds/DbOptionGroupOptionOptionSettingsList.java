...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.rds.DbOptionGroupOptionOptionSettingsList")
public class DbOptionGroupOptionOptionSettingsList extends com.hashicorp.cdktf.ComplexList {

    protected DbOptionGroupOptionOptionSettingsList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DbOptionGroupOptionOptionSettingsList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public DbOptionGroupOptionOptionSettingsList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.rds.DbOptionGroupOptionOptionSettingsOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.rds.DbOptionGroupOptionOptionSettingsOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.aws.rds.DbOptionGroupOptionOptionSettings> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
