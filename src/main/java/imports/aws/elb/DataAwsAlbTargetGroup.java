 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:19.652Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.elb.DataAwsAlbTargetGroup")
public class DataAwsAlbTargetGroup extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.elb.DataAwsAlbTargetGroup.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     * @param config
     */
    public DataAwsAlbTargetGroup(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.elb.DataAwsAlbTargetGroupConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.elb.DataAwsAlbTargetGroupHealthCheckList getHealthCheck() {
        return software.amazon.jsii.Kernel.get(this, "healthCheck", software.amazon.jsii.NativeType.forClass(imports.aws.elb.DataAwsAlbTargetGroupHealthCheckList.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.elb.DataAwsAlbTargetGroupStickinessList getStickiness() {
        return software.amazon.jsii.Kernel.get(this, "stickiness", software.amazon.jsii.NativeType.forClass(imports.aws.elb.DataAwsAlbTargetGroupStickinessList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.elb.DataAwsAlbTargetGroup}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.elb.DataAwsAlbTargetGroup> {
        /**
        ...
        private imports.aws.elb.DataAwsAlbTargetGroupConfig.Builder config;
         ...
         * <p>
         * @return {@code this}
         * @param arn Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/alb_target_group#arn DataAwsAlbTargetGroup#arn}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/alb_target_group#id DataAwsAlbTargetGroup#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param name Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/alb_target_group#name DataAwsAlbTargetGroup#name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/alb_target_group#tags DataAwsAlbTargetGroup#tags}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.elb.DataAwsAlbTargetGroup}.
         */
        @Override
        public imports.aws.elb.DataAwsAlbTargetGroup build() {
            return new imports.aws.elb.DataAwsAlbTargetGroup(
                this.scope,
                this.id,
        ...
        private imports.aws.elb.DataAwsAlbTargetGroupConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.elb.DataAwsAlbTargetGroupConfig.Builder();
            }
            return this.config;
        }
    }
