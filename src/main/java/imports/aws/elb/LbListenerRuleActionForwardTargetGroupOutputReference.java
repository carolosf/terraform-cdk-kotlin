...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.elb.LbListenerRuleActionForwardTargetGroupOutputReference")
public class LbListenerRuleActionForwardTargetGroupOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected LbListenerRuleActionForwardTargetGroupOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected LbListenerRuleActionForwardTargetGroupOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.elb.LbListenerRuleActionForwardTargetGroup value) {
