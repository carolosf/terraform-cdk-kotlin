...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.elb.LbListenerCertificate")
public class LbListenerCertificate extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.elb.LbListenerCertificate.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public LbListenerCertificate(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.elb.LbListenerCertificateConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.elb.LbListenerCertificate}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.elb.LbListenerCertificate> {
        /**
        ...
        private final imports.aws.elb.LbListenerCertificateConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.elb.LbListenerCertificateConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/lb_listener_certificate#id LbListenerCertificate#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.elb.LbListenerCertificate}.
         */
        @Override
        public imports.aws.elb.LbListenerCertificate build() {
            return new imports.aws.elb.LbListenerCertificate(
                this.scope,
                this.id,
                this.config.build()
            );
