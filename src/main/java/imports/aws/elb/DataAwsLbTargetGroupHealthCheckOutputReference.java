...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.elb.DataAwsLbTargetGroupHealthCheckOutputReference")
public class DataAwsLbTargetGroupHealthCheckOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsLbTargetGroupHealthCheckOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsLbTargetGroupHealthCheckOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.elb.DataAwsLbTargetGroupHealthCheck getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.elb.DataAwsLbTargetGroupHealthCheck.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.elb.DataAwsLbTargetGroupHealthCheck value) {
