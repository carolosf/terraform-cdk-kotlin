 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:19.655Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.elb.DataAwsLb")
public class DataAwsLb extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.elb.DataAwsLb.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     * @param config
     */
    public DataAwsLb(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.elb.DataAwsLbConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.elb.DataAwsLbAccessLogsList getAccessLogs() {
        return software.amazon.jsii.Kernel.get(this, "accessLogs", software.amazon.jsii.NativeType.forClass(imports.aws.elb.DataAwsLbAccessLogsList.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.elb.DataAwsLbSubnetMappingList getSubnetMapping() {
        return software.amazon.jsii.Kernel.get(this, "subnetMapping", software.amazon.jsii.NativeType.forClass(imports.aws.elb.DataAwsLbSubnetMappingList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.elb.DataAwsLb}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.elb.DataAwsLb> {
        /**
        ...
        private imports.aws.elb.DataAwsLbConfig.Builder config;
         ...
         * <p>
         * @return {@code this}
         * @param arn Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/lb#arn DataAwsLb#arn}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/lb#id DataAwsLb#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param name Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/lb#name DataAwsLb#name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/lb#tags DataAwsLb#tags}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.elb.DataAwsLb}.
         */
        @Override
        public imports.aws.elb.DataAwsLb build() {
            return new imports.aws.elb.DataAwsLb(
                this.scope,
                this.id,
        ...
        private imports.aws.elb.DataAwsLbConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.elb.DataAwsLbConfig.Builder();
            }
            return this.config;
        }
    }
