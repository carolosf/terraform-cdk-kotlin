...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.elb.DataAwsAlbTargetGroupHealthCheckOutputReference")
public class DataAwsAlbTargetGroupHealthCheckOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsAlbTargetGroupHealthCheckOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsAlbTargetGroupHealthCheckOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.elb.DataAwsAlbTargetGroupHealthCheck getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.elb.DataAwsAlbTargetGroupHealthCheck.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.elb.DataAwsAlbTargetGroupHealthCheck value) {
