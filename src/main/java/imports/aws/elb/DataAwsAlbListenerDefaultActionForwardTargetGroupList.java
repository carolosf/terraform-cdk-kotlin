...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.elb.DataAwsAlbListenerDefaultActionForwardTargetGroupList")
public class DataAwsAlbListenerDefaultActionForwardTargetGroupList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsAlbListenerDefaultActionForwardTargetGroupList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsAlbListenerDefaultActionForwardTargetGroupList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.elb.DataAwsAlbListenerDefaultActionForwardTargetGroupOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.elb.DataAwsAlbListenerDefaultActionForwardTargetGroupOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
