...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.iam.DataAwsIamGroup")
public class DataAwsIamGroup extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.iam.DataAwsIamGroup.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsIamGroup(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.iam.DataAwsIamGroupConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.iam.DataAwsIamGroupUsersList getUsers() {
        return software.amazon.jsii.Kernel.get(this, "users", software.amazon.jsii.NativeType.forClass(imports.aws.iam.DataAwsIamGroupUsersList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.iam.DataAwsIamGroup}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.iam.DataAwsIamGroup> {
        /**
        ...
        private final imports.aws.iam.DataAwsIamGroupConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.iam.DataAwsIamGroupConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/iam_group#id DataAwsIamGroup#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.iam.DataAwsIamGroup}.
         */
        @Override
        public imports.aws.iam.DataAwsIamGroup build() {
            return new imports.aws.iam.DataAwsIamGroup(
                this.scope,
                this.id,
                this.config.build()
            );
