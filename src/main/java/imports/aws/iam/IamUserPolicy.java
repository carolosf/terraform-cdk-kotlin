...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.iam.IamUserPolicy")
public class IamUserPolicy extends com.hashicorp.cdktf.TerraformResource {

    protected IamUserPolicy(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected IamUserPolicy(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.iam.IamUserPolicy.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public IamUserPolicy(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.iam.IamUserPolicyConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.iam.IamUserPolicy}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.iam.IamUserPolicy> {
        /**
        ...
        private final imports.aws.iam.IamUserPolicyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.iam.IamUserPolicyConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/iam_user_policy#id IamUserPolicy#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param name Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/iam_user_policy#name IamUserPolicy#name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param namePrefix Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/iam_user_policy#name_prefix IamUserPolicy#name_prefix}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.iam.IamUserPolicy}.
         */
        @Override
        public imports.aws.iam.IamUserPolicy build() {
            return new imports.aws.iam.IamUserPolicy(
                this.scope,
                this.id,
                this.config.build()
            );
