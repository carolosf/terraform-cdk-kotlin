...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.iam.IamUserGroupMembership")
public class IamUserGroupMembership extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.iam.IamUserGroupMembership.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public IamUserGroupMembership(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.iam.IamUserGroupMembershipConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.iam.IamUserGroupMembership}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.iam.IamUserGroupMembership> {
        /**
        ...
        private final imports.aws.iam.IamUserGroupMembershipConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.iam.IamUserGroupMembershipConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/iam_user_group_membership#id IamUserGroupMembership#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.iam.IamUserGroupMembership}.
         */
        @Override
        public imports.aws.iam.IamUserGroupMembership build() {
            return new imports.aws.iam.IamUserGroupMembership(
                this.scope,
                this.id,
                this.config.build()
            );
