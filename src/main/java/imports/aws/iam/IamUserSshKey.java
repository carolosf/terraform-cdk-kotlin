...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.iam.IamUserSshKey")
public class IamUserSshKey extends com.hashicorp.cdktf.TerraformResource {

    protected IamUserSshKey(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected IamUserSshKey(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.iam.IamUserSshKey.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public IamUserSshKey(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.iam.IamUserSshKeyConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.iam.IamUserSshKey}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.iam.IamUserSshKey> {
        /**
        ...
        private final imports.aws.iam.IamUserSshKeyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.iam.IamUserSshKeyConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param encoding Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/iam_user_ssh_key#encoding IamUserSshKey#encoding}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param publicKey Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/iam_user_ssh_key#public_key IamUserSshKey#public_key}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param username Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/iam_user_ssh_key#username IamUserSshKey#username}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/iam_user_ssh_key#id IamUserSshKey#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param status Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/iam_user_ssh_key#status IamUserSshKey#status}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.iam.IamUserSshKey}.
         */
        @Override
        public imports.aws.iam.IamUserSshKey build() {
            return new imports.aws.iam.IamUserSshKey(
                this.scope,
                this.id,
                this.config.build()
            );
