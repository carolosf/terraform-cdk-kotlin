...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.eks.EksIdentityProviderConfigTimeoutsOutputReference")
public class EksIdentityProviderConfigTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected EksIdentityProviderConfigTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected EksIdentityProviderConfigTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public EksIdentityProviderConfigTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.eks.EksIdentityProviderConfigTimeouts value) {
