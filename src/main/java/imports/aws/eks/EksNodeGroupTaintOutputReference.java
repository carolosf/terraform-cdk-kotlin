...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.eks.EksNodeGroupTaintOutputReference")
public class EksNodeGroupTaintOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected EksNodeGroupTaintOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected EksNodeGroupTaintOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.eks.EksNodeGroupTaint value) {
