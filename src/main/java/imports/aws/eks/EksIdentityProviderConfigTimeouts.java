...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:19.615Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.eks.EksIdentityProviderConfigTimeouts")
@software.amazon.jsii.Jsii.Proxy(EksIdentityProviderConfigTimeouts.Jsii$Proxy.class)
public interface EksIdentityProviderConfigTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link EksIdentityProviderConfigTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link EksIdentityProviderConfigTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<EksIdentityProviderConfigTimeouts> {
        java.lang.String create;
        java.lang.String delete;

        /**
         * Sets the value of {@link EksIdentityProviderConfigTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link EksIdentityProviderConfigTimeouts#getDelete}
         ...
         * @return a new instance of {@link EksIdentityProviderConfigTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public EksIdentityProviderConfigTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link EksIdentityProviderConfigTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements EksIdentityProviderConfigTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.eks.EksIdentityProviderConfigTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            EksIdentityProviderConfigTimeouts.Jsii$Proxy that = (EksIdentityProviderConfigTimeouts.Jsii$Proxy) o;
