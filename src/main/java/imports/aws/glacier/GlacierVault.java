...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.glacier.GlacierVault")
public class GlacierVault extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.glacier.GlacierVault.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public GlacierVault(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.glacier.GlacierVaultConfig config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public void putNotification(final @org.jetbrains.annotations.NotNull imports.aws.glacier.GlacierVaultNotification value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.glacier.GlacierVaultNotificationOutputReference getNotification() {
        return software.amazon.jsii.Kernel.get(this, "notification", software.amazon.jsii.NativeType.forClass(imports.aws.glacier.GlacierVaultNotificationOutputReference.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.glacier.GlacierVaultNotification getNotificationInput() {
        return software.amazon.jsii.Kernel.get(this, "notificationInput", software.amazon.jsii.NativeType.forClass(imports.aws.glacier.GlacierVaultNotification.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.glacier.GlacierVault}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.glacier.GlacierVault> {
        /**
        ...
        private final imports.aws.glacier.GlacierVaultConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.glacier.GlacierVaultConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param accessPolicy Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/glacier_vault#access_policy GlacierVault#access_policy}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/glacier_vault#id GlacierVault#id}. This parameter is required.
         */
         ...
         */
        public Builder notification(final imports.aws.glacier.GlacierVaultNotification notification) {
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/glacier_vault#tags GlacierVault#tags}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tagsAll Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/glacier_vault#tags_all GlacierVault#tags_all}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.glacier.GlacierVault}.
         */
        @Override
        public imports.aws.glacier.GlacierVault build() {
            return new imports.aws.glacier.GlacierVault(
                this.scope,
                this.id,
                this.config.build()
            );
