...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.config.ConfigOrganizationConformancePackTimeouts")
@software.amazon.jsii.Jsii.Proxy(ConfigOrganizationConformancePackTimeouts.Jsii$Proxy.class)
public interface ConfigOrganizationConformancePackTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link ConfigOrganizationConformancePackTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ConfigOrganizationConformancePackTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ConfigOrganizationConformancePackTimeouts> {
        java.lang.String create;
        java.lang.String delete;
        java.lang.String update;

        /**
         * Sets the value of {@link ConfigOrganizationConformancePackTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link ConfigOrganizationConformancePackTimeouts#getDelete}
        ...
        /**
         * Sets the value of {@link ConfigOrganizationConformancePackTimeouts#getUpdate}
         ...
         * @return a new instance of {@link ConfigOrganizationConformancePackTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ConfigOrganizationConformancePackTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ConfigOrganizationConformancePackTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ConfigOrganizationConformancePackTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.config.ConfigOrganizationConformancePackTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            ConfigOrganizationConformancePackTimeouts.Jsii$Proxy that = (ConfigOrganizationConformancePackTimeouts.Jsii$Proxy) o;
