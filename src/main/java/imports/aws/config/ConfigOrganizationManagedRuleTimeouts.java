...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:19.370Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.config.ConfigOrganizationManagedRuleTimeouts")
@software.amazon.jsii.Jsii.Proxy(ConfigOrganizationManagedRuleTimeouts.Jsii$Proxy.class)
public interface ConfigOrganizationManagedRuleTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link ConfigOrganizationManagedRuleTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ConfigOrganizationManagedRuleTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ConfigOrganizationManagedRuleTimeouts> {
        java.lang.String create;
        java.lang.String delete;
        java.lang.String update;

        /**
         * Sets the value of {@link ConfigOrganizationManagedRuleTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link ConfigOrganizationManagedRuleTimeouts#getDelete}
        ...
        /**
         * Sets the value of {@link ConfigOrganizationManagedRuleTimeouts#getUpdate}
         ...
         * @return a new instance of {@link ConfigOrganizationManagedRuleTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ConfigOrganizationManagedRuleTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ConfigOrganizationManagedRuleTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ConfigOrganizationManagedRuleTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.config.ConfigOrganizationManagedRuleTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            ConfigOrganizationManagedRuleTimeouts.Jsii$Proxy that = (ConfigOrganizationManagedRuleTimeouts.Jsii$Proxy) o;
