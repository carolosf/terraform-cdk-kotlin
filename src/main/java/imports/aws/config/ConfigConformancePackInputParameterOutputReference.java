...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.config.ConfigConformancePackInputParameterOutputReference")
public class ConfigConformancePackInputParameterOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected ConfigConformancePackInputParameterOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected ConfigConformancePackInputParameterOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.config.ConfigConformancePackInputParameter value) {
