...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.config.ConfigOrganizationManagedRuleTimeoutsOutputReference")
public class ConfigOrganizationManagedRuleTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected ConfigOrganizationManagedRuleTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected ConfigOrganizationManagedRuleTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public ConfigOrganizationManagedRuleTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.config.ConfigOrganizationManagedRuleTimeouts value) {
