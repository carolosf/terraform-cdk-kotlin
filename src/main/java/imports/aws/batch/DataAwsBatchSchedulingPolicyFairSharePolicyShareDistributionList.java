...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.batch.DataAwsBatchSchedulingPolicyFairSharePolicyShareDistributionList")
public class DataAwsBatchSchedulingPolicyFairSharePolicyShareDistributionList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsBatchSchedulingPolicyFairSharePolicyShareDistributionList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsBatchSchedulingPolicyFairSharePolicyShareDistributionList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.batch.DataAwsBatchSchedulingPolicyFairSharePolicyShareDistributionOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.batch.DataAwsBatchSchedulingPolicyFairSharePolicyShareDistributionOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
