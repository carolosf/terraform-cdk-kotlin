...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.acm.AcmCertificateOptionsOutputReference")
public class AcmCertificateOptionsOutputReference extends com.hashicorp.cdktf.ComplexObject {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.acm.AcmCertificateOptions getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.acm.AcmCertificateOptions.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.acm.AcmCertificateOptions value) {
