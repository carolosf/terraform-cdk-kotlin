...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.CloudcontrolapiResourceTimeoutsOutputReference")
public class CloudcontrolapiResourceTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected CloudcontrolapiResourceTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CloudcontrolapiResourceTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public CloudcontrolapiResourceTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.CloudcontrolapiResourceTimeouts value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
