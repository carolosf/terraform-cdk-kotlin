...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.neptune.NeptuneEventSubscriptionTimeoutsOutputReference")
public class NeptuneEventSubscriptionTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected NeptuneEventSubscriptionTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected NeptuneEventSubscriptionTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public NeptuneEventSubscriptionTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.neptune.NeptuneEventSubscriptionTimeouts value) {
