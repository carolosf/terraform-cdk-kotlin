...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.efs.DataAwsEfsAccessPoints")
public class DataAwsEfsAccessPoints extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsEfsAccessPoints(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsEfsAccessPoints(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.efs.DataAwsEfsAccessPoints.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsEfsAccessPoints(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.efs.DataAwsEfsAccessPointsConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.efs.DataAwsEfsAccessPoints}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.efs.DataAwsEfsAccessPoints> {
        /**
        ...
        private final imports.aws.efs.DataAwsEfsAccessPointsConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.efs.DataAwsEfsAccessPointsConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/efs_access_points#id DataAwsEfsAccessPoints#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.efs.DataAwsEfsAccessPoints}.
         */
        @Override
        public imports.aws.efs.DataAwsEfsAccessPoints build() {
            return new imports.aws.efs.DataAwsEfsAccessPoints(
                this.scope,
                this.id,
                this.config.build()
            );
