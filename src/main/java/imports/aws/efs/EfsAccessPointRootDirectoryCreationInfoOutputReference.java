...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.efs.EfsAccessPointRootDirectoryCreationInfoOutputReference")
public class EfsAccessPointRootDirectoryCreationInfoOutputReference extends com.hashicorp.cdktf.ComplexObject {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.efs.EfsAccessPointRootDirectoryCreationInfo getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.efs.EfsAccessPointRootDirectoryCreationInfo.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.efs.EfsAccessPointRootDirectoryCreationInfo value) {
