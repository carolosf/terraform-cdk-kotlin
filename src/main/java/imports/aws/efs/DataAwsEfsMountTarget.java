...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.efs.DataAwsEfsMountTarget")
public class DataAwsEfsMountTarget extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsEfsMountTarget(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsEfsMountTarget(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.efs.DataAwsEfsMountTarget.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     * @param config
     */
    public DataAwsEfsMountTarget(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.efs.DataAwsEfsMountTargetConfig config) {
     ...
     * @param id The scoped construct ID. This parameter is required.
     */
    public DataAwsEfsMountTarget(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
    ...
    public void resetMountTargetId() {
        software.amazon.jsii.Kernel.call(this, "resetMountTargetId", software.amazon.jsii.NativeType.VOID);
    }
    ...
    public @org.jetbrains.annotations.Nullable java.lang.String getMountTargetIdInput() {
        return software.amazon.jsii.Kernel.get(this, "mountTargetIdInput", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getMountTargetId() {
        return software.amazon.jsii.Kernel.get(this, "mountTargetId", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }

    public void setMountTargetId(final @org.jetbrains.annotations.NotNull java.lang.String value) {
        software.amazon.jsii.Kernel.set(this, "mountTargetId", java.util.Objects.requireNonNull(value, "mountTargetId is required"));
    }

    /**
     * A fluent builder for {@link imports.aws.efs.DataAwsEfsMountTarget}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.efs.DataAwsEfsMountTarget> {
        /**
        ...
        private imports.aws.efs.DataAwsEfsMountTargetConfig.Builder config;
         ...
         * <p>
         * @return {@code this}
         * @param accessPointId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/efs_mount_target#access_point_id DataAwsEfsMountTarget#access_point_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param fileSystemId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/efs_mount_target#file_system_id DataAwsEfsMountTarget#file_system_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/efs_mount_target#id DataAwsEfsMountTarget#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param mountTargetId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/efs_mount_target#mount_target_id DataAwsEfsMountTarget#mount_target_id}. This parameter is required.
         */
        public Builder mountTargetId(final java.lang.String mountTargetId) {
            this.config().mountTargetId(mountTargetId);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.efs.DataAwsEfsMountTarget}.
         */
        @Override
        public imports.aws.efs.DataAwsEfsMountTarget build() {
            return new imports.aws.efs.DataAwsEfsMountTarget(
                this.scope,
                this.id,
        ...
        private imports.aws.efs.DataAwsEfsMountTargetConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.efs.DataAwsEfsMountTargetConfig.Builder();
            }
            return this.config;
        }
    }
