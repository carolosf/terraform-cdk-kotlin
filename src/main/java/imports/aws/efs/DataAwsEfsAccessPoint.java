...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.efs.DataAwsEfsAccessPoint")
public class DataAwsEfsAccessPoint extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.efs.DataAwsEfsAccessPoint.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsEfsAccessPoint(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.efs.DataAwsEfsAccessPointConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.efs.DataAwsEfsAccessPointPosixUserList getPosixUser() {
        return software.amazon.jsii.Kernel.get(this, "posixUser", software.amazon.jsii.NativeType.forClass(imports.aws.efs.DataAwsEfsAccessPointPosixUserList.class));
    }

    public @org.jetbrains.annotations.NotNull imports.aws.efs.DataAwsEfsAccessPointRootDirectoryList getRootDirectory() {
        return software.amazon.jsii.Kernel.get(this, "rootDirectory", software.amazon.jsii.NativeType.forClass(imports.aws.efs.DataAwsEfsAccessPointRootDirectoryList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.efs.DataAwsEfsAccessPoint}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.efs.DataAwsEfsAccessPoint> {
        /**
        ...
        private final imports.aws.efs.DataAwsEfsAccessPointConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.efs.DataAwsEfsAccessPointConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/efs_access_point#id DataAwsEfsAccessPoint#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/efs_access_point#tags DataAwsEfsAccessPoint#tags}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.efs.DataAwsEfsAccessPoint}.
         */
        @Override
        public imports.aws.efs.DataAwsEfsAccessPoint build() {
            return new imports.aws.efs.DataAwsEfsAccessPoint(
                this.scope,
                this.id,
                this.config.build()
            );
