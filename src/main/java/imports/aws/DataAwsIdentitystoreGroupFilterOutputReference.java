...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.DataAwsIdentitystoreGroupFilterOutputReference")
public class DataAwsIdentitystoreGroupFilterOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsIdentitystoreGroupFilterOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsIdentitystoreGroupFilterOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.DataAwsIdentitystoreGroupFilter value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
