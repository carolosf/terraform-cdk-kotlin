...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.datasources.LaunchConfigurationEbsBlockDeviceOutputReference")
public class LaunchConfigurationEbsBlockDeviceOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected LaunchConfigurationEbsBlockDeviceOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected LaunchConfigurationEbsBlockDeviceOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.datasources.LaunchConfigurationEbsBlockDevice value) {
