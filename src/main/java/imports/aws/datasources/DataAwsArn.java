...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.datasources.DataAwsArn")
public class DataAwsArn extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsArn(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsArn(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.datasources.DataAwsArn.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsArn(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.datasources.DataAwsArnConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.datasources.DataAwsArn}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.datasources.DataAwsArn> {
        /**
        ...
        private final imports.aws.datasources.DataAwsArnConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.datasources.DataAwsArnConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/arn#id DataAwsArn#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.datasources.DataAwsArn}.
         */
        @Override
        public imports.aws.datasources.DataAwsArn build() {
            return new imports.aws.datasources.DataAwsArn(
                this.scope,
                this.id,
                this.config.build()
            );
