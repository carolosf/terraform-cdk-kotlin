...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.datasources.DataAwsAvailabilityZonesFilterOutputReference")
public class DataAwsAvailabilityZonesFilterOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsAvailabilityZonesFilterOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsAvailabilityZonesFilterOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.datasources.DataAwsAvailabilityZonesFilter value) {
