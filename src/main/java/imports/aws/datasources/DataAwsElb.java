 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:19.417Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.datasources.DataAwsElb")
public class DataAwsElb extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.datasources.DataAwsElb.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsElb(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.datasources.DataAwsElbConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.datasources.DataAwsElbAccessLogsList getAccessLogs() {
        return software.amazon.jsii.Kernel.get(this, "accessLogs", software.amazon.jsii.NativeType.forClass(imports.aws.datasources.DataAwsElbAccessLogsList.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IResolvable getConnectionDraining() {
        return software.amazon.jsii.Kernel.get(this, "connectionDraining", software.amazon.jsii.NativeType.forClass(com.hashicorp.cdktf.IResolvable.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IResolvable getCrossZoneLoadBalancing() {
        return software.amazon.jsii.Kernel.get(this, "crossZoneLoadBalancing", software.amazon.jsii.NativeType.forClass(com.hashicorp.cdktf.IResolvable.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.datasources.DataAwsElbHealthCheckList getHealthCheck() {
        return software.amazon.jsii.Kernel.get(this, "healthCheck", software.amazon.jsii.NativeType.forClass(imports.aws.datasources.DataAwsElbHealthCheckList.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.datasources.DataAwsElbListenerList getListener() {
        return software.amazon.jsii.Kernel.get(this, "listener", software.amazon.jsii.NativeType.forClass(imports.aws.datasources.DataAwsElbListenerList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.datasources.DataAwsElb}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.datasources.DataAwsElb> {
        /**
        ...
        private final imports.aws.datasources.DataAwsElbConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.datasources.DataAwsElbConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param name Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/elb#name DataAwsElb#name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/elb#id DataAwsElb#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/elb#tags DataAwsElb#tags}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.datasources.DataAwsElb}.
         */
        @Override
        public imports.aws.datasources.DataAwsElb build() {
            return new imports.aws.datasources.DataAwsElb(
                this.scope,
                this.id,
                this.config.build()
            );
