...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.datasources.DataAwsAvailabilityZoneFilterOutputReference")
public class DataAwsAvailabilityZoneFilterOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsAvailabilityZoneFilterOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsAvailabilityZoneFilterOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.datasources.DataAwsAvailabilityZoneFilter value) {
