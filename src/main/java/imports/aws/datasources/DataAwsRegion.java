...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.datasources.DataAwsRegion")
public class DataAwsRegion extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.datasources.DataAwsRegion.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     * @param config
     */
    public DataAwsRegion(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.datasources.DataAwsRegionConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.datasources.DataAwsRegion}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.datasources.DataAwsRegion> {
        /**
        ...
        private imports.aws.datasources.DataAwsRegionConfig.Builder config;
         ...
         * <p>
         * @return {@code this}
         * @param endpoint Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/region#endpoint DataAwsRegion#endpoint}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/region#id DataAwsRegion#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param name Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/region#name DataAwsRegion#name}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.datasources.DataAwsRegion}.
         */
        @Override
        public imports.aws.datasources.DataAwsRegion build() {
            return new imports.aws.datasources.DataAwsRegion(
                this.scope,
                this.id,
        ...
        private imports.aws.datasources.DataAwsRegionConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.datasources.DataAwsRegionConfig.Builder();
            }
            return this.config;
        }
    }
