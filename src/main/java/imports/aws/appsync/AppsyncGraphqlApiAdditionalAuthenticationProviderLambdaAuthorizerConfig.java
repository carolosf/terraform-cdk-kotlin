...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:19.205Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.appsync.AppsyncGraphqlApiAdditionalAuthenticationProviderLambdaAuthorizerConfig")
@software.amazon.jsii.Jsii.Proxy(AppsyncGraphqlApiAdditionalAuthenticationProviderLambdaAuthorizerConfig.Jsii$Proxy.class)
public interface AppsyncGraphqlApiAdditionalAuthenticationProviderLambdaAuthorizerConfig extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link AppsyncGraphqlApiAdditionalAuthenticationProviderLambdaAuthorizerConfig}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link AppsyncGraphqlApiAdditionalAuthenticationProviderLambdaAuthorizerConfig}
     */
    public static final class Builder implements software.amazon.jsii.Builder<AppsyncGraphqlApiAdditionalAuthenticationProviderLambdaAuthorizerConfig> {
        java.lang.String authorizerUri;
        java.lang.Number authorizerResultTtlInSeconds;
        java.lang.String identityValidationExpression;

        /**
         * Sets the value of {@link AppsyncGraphqlApiAdditionalAuthenticationProviderLambdaAuthorizerConfig#getAuthorizerUri}
        ...
        /**
         * Sets the value of {@link AppsyncGraphqlApiAdditionalAuthenticationProviderLambdaAuthorizerConfig#getAuthorizerResultTtlInSeconds}
        ...
        /**
         * Sets the value of {@link AppsyncGraphqlApiAdditionalAuthenticationProviderLambdaAuthorizerConfig#getIdentityValidationExpression}
         ...
         * @return a new instance of {@link AppsyncGraphqlApiAdditionalAuthenticationProviderLambdaAuthorizerConfig}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public AppsyncGraphqlApiAdditionalAuthenticationProviderLambdaAuthorizerConfig build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link AppsyncGraphqlApiAdditionalAuthenticationProviderLambdaAuthorizerConfig}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements AppsyncGraphqlApiAdditionalAuthenticationProviderLambdaAuthorizerConfig {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.appsync.AppsyncGraphqlApiAdditionalAuthenticationProviderLambdaAuthorizerConfig"));
        ...
        public final boolean equals(final Object o) {
            ...
            AppsyncGraphqlApiAdditionalAuthenticationProviderLambdaAuthorizerConfig.Jsii$Proxy that = (AppsyncGraphqlApiAdditionalAuthenticationProviderLambdaAuthorizerConfig.Jsii$Proxy) o;
