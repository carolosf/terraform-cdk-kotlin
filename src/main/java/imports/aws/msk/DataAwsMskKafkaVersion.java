...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.msk.DataAwsMskKafkaVersion")
public class DataAwsMskKafkaVersion extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsMskKafkaVersion(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsMskKafkaVersion(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.msk.DataAwsMskKafkaVersion.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     * @param config
     */
    public DataAwsMskKafkaVersion(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.msk.DataAwsMskKafkaVersionConfig config) {
     ...
     * @param id The scoped construct ID. This parameter is required.
     */
    public DataAwsMskKafkaVersion(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
    ...
    /**
     * A fluent builder for {@link imports.aws.msk.DataAwsMskKafkaVersion}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.msk.DataAwsMskKafkaVersion> {
        /**
        ...
        private imports.aws.msk.DataAwsMskKafkaVersionConfig.Builder config;
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/msk_kafka_version#id DataAwsMskKafkaVersion#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param preferredVersions Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/msk_kafka_version#preferred_versions DataAwsMskKafkaVersion#preferred_versions}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param version Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/msk_kafka_version#version DataAwsMskKafkaVersion#version}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.msk.DataAwsMskKafkaVersion}.
         */
        @Override
        public imports.aws.msk.DataAwsMskKafkaVersion build() {
            return new imports.aws.msk.DataAwsMskKafkaVersion(
                this.scope,
                this.id,
        ...
        private imports.aws.msk.DataAwsMskKafkaVersionConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.msk.DataAwsMskKafkaVersionConfig.Builder();
            }
            return this.config;
        }
    }
