...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.msk.MskClusterLoggingInfoBrokerLogsFirehoseOutputReference")
public class MskClusterLoggingInfoBrokerLogsFirehoseOutputReference extends com.hashicorp.cdktf.ComplexObject {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.msk.MskClusterLoggingInfoBrokerLogsFirehose getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.msk.MskClusterLoggingInfoBrokerLogsFirehose.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.msk.MskClusterLoggingInfoBrokerLogsFirehose value) {
