...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.cloudfront.CloudfrontResponseHeadersPolicyCustomHeadersConfig")
...
public interface CloudfrontResponseHeadersPolicyCustomHeadersConfig extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<CloudfrontResponseHeadersPolicyCustomHeadersConfig> {
         ...
         * @return {@code this}
         */
        public Builder items(java.util.List<? extends imports.aws.cloudfront.CloudfrontResponseHeadersPolicyCustomHeadersConfigItems> items) {
            this.items = items;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CloudfrontResponseHeadersPolicyCustomHeadersConfig {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.cloudfront.CloudfrontResponseHeadersPolicyCustomHeadersConfig"));
