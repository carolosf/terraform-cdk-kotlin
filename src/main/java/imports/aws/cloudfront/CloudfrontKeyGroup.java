...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.cloudfront.CloudfrontKeyGroup")
public class CloudfrontKeyGroup extends com.hashicorp.cdktf.TerraformResource {

    protected CloudfrontKeyGroup(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CloudfrontKeyGroup(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.cloudfront.CloudfrontKeyGroup.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public CloudfrontKeyGroup(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.cloudfront.CloudfrontKeyGroupConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.cloudfront.CloudfrontKeyGroup}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.cloudfront.CloudfrontKeyGroup> {
        /**
        ...
        private final imports.aws.cloudfront.CloudfrontKeyGroupConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.cloudfront.CloudfrontKeyGroupConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param items Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/cloudfront_key_group#items CloudfrontKeyGroup#items}. This parameter is required.
         */
        public Builder items(final java.util.List<java.lang.String> items) {
         ...
         * <p>
         * @return {@code this}
         * @param name Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/cloudfront_key_group#name CloudfrontKeyGroup#name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param comment Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/cloudfront_key_group#comment CloudfrontKeyGroup#comment}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/cloudfront_key_group#id CloudfrontKeyGroup#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.cloudfront.CloudfrontKeyGroup}.
         */
        @Override
        public imports.aws.cloudfront.CloudfrontKeyGroup build() {
            return new imports.aws.cloudfront.CloudfrontKeyGroup(
                this.scope,
                this.id,
                this.config.build()
            );
