...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.cloudfront.CloudfrontOriginAccessIdentity")
public class CloudfrontOriginAccessIdentity extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.cloudfront.CloudfrontOriginAccessIdentity.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     * @param config
     */
    public CloudfrontOriginAccessIdentity(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.cloudfront.CloudfrontOriginAccessIdentityConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.cloudfront.CloudfrontOriginAccessIdentity}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.cloudfront.CloudfrontOriginAccessIdentity> {
        /**
        ...
        private imports.aws.cloudfront.CloudfrontOriginAccessIdentityConfig.Builder config;
         ...
         * <p>
         * @return {@code this}
         * @param comment Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/cloudfront_origin_access_identity#comment CloudfrontOriginAccessIdentity#comment}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/cloudfront_origin_access_identity#id CloudfrontOriginAccessIdentity#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.cloudfront.CloudfrontOriginAccessIdentity}.
         */
        @Override
        public imports.aws.cloudfront.CloudfrontOriginAccessIdentity build() {
            return new imports.aws.cloudfront.CloudfrontOriginAccessIdentity(
                this.scope,
                this.id,
        ...
        private imports.aws.cloudfront.CloudfrontOriginAccessIdentityConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.cloudfront.CloudfrontOriginAccessIdentityConfig.Builder();
            }
            return this.config;
        }
    }
