...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.cloudfront.DataAwsCloudfrontOriginRequestPolicyCookiesConfigList")
public class DataAwsCloudfrontOriginRequestPolicyCookiesConfigList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsCloudfrontOriginRequestPolicyCookiesConfigList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsCloudfrontOriginRequestPolicyCookiesConfigList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.cloudfront.DataAwsCloudfrontOriginRequestPolicyCookiesConfigOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.cloudfront.DataAwsCloudfrontOriginRequestPolicyCookiesConfigOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
