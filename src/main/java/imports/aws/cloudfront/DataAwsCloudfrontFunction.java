...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.cloudfront.DataAwsCloudfrontFunction")
public class DataAwsCloudfrontFunction extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsCloudfrontFunction(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsCloudfrontFunction(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.cloudfront.DataAwsCloudfrontFunction.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsCloudfrontFunction(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.cloudfront.DataAwsCloudfrontFunctionConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.cloudfront.DataAwsCloudfrontFunction}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.cloudfront.DataAwsCloudfrontFunction> {
        /**
        ...
        private final imports.aws.cloudfront.DataAwsCloudfrontFunctionConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.cloudfront.DataAwsCloudfrontFunctionConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/cloudfront_function#id DataAwsCloudfrontFunction#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.cloudfront.DataAwsCloudfrontFunction}.
         */
        @Override
        public imports.aws.cloudfront.DataAwsCloudfrontFunction build() {
            return new imports.aws.cloudfront.DataAwsCloudfrontFunction(
                this.scope,
                this.id,
                this.config.build()
            );
