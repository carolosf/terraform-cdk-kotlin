...
public class DataAwsCloudfrontDistribution extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    protected DataAwsCloudfrontDistribution(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsCloudfrontDistribution(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.cloudfront.DataAwsCloudfrontDistribution.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsCloudfrontDistribution(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.cloudfront.DataAwsCloudfrontDistributionConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.cloudfront.DataAwsCloudfrontDistribution}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.cloudfront.DataAwsCloudfrontDistribution> {
        /**
        ...
        private final imports.aws.cloudfront.DataAwsCloudfrontDistributionConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.cloudfront.DataAwsCloudfrontDistributionConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/cloudfront_distribution#tags DataAwsCloudfrontDistribution#tags}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.cloudfront.DataAwsCloudfrontDistribution}.
         */
        @Override
        public imports.aws.cloudfront.DataAwsCloudfrontDistribution build() {
            return new imports.aws.cloudfront.DataAwsCloudfrontDistribution(
                this.scope,
                this.id,
                this.config.build()
            );
