...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.redshift.RedshiftEventSubscriptionTimeoutsOutputReference")
public class RedshiftEventSubscriptionTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected RedshiftEventSubscriptionTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RedshiftEventSubscriptionTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public RedshiftEventSubscriptionTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.redshift.RedshiftEventSubscriptionTimeouts value) {
