...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.redshift.RedshiftSecurityGroupIngressOutputReference")
public class RedshiftSecurityGroupIngressOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected RedshiftSecurityGroupIngressOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RedshiftSecurityGroupIngressOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.redshift.RedshiftSecurityGroupIngress value) {
