...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.appautoscaling.AppautoscalingPolicyStepScalingPolicyConfigurationStepAdjustment")
@software.amazon.jsii.Jsii.Proxy(AppautoscalingPolicyStepScalingPolicyConfigurationStepAdjustment.Jsii$Proxy.class)
public interface AppautoscalingPolicyStepScalingPolicyConfigurationStepAdjustment extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link AppautoscalingPolicyStepScalingPolicyConfigurationStepAdjustment}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link AppautoscalingPolicyStepScalingPolicyConfigurationStepAdjustment}
     */
    public static final class Builder implements software.amazon.jsii.Builder<AppautoscalingPolicyStepScalingPolicyConfigurationStepAdjustment> {
        java.lang.Number scalingAdjustment;
        java.lang.String metricIntervalLowerBound;
        java.lang.String metricIntervalUpperBound;

        /**
         * Sets the value of {@link AppautoscalingPolicyStepScalingPolicyConfigurationStepAdjustment#getScalingAdjustment}
         * @param scalingAdjustment Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/appautoscaling_policy#scaling_adjustment AppautoscalingPolicy#scaling_adjustment}. This parameter is required.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link AppautoscalingPolicyStepScalingPolicyConfigurationStepAdjustment#getMetricIntervalLowerBound}
         * @param metricIntervalLowerBound Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/appautoscaling_policy#metric_interval_lower_bound AppautoscalingPolicy#metric_interval_lower_bound}.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link AppautoscalingPolicyStepScalingPolicyConfigurationStepAdjustment#getMetricIntervalUpperBound}
         * @param metricIntervalUpperBound Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/appautoscaling_policy#metric_interval_upper_bound AppautoscalingPolicy#metric_interval_upper_bound}.
         * @return {@code this}
         */
         ...
         * @return a new instance of {@link AppautoscalingPolicyStepScalingPolicyConfigurationStepAdjustment}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public AppautoscalingPolicyStepScalingPolicyConfigurationStepAdjustment build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link AppautoscalingPolicyStepScalingPolicyConfigurationStepAdjustment}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements AppautoscalingPolicyStepScalingPolicyConfigurationStepAdjustment {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.appautoscaling.AppautoscalingPolicyStepScalingPolicyConfigurationStepAdjustment"));
        ...
        public final boolean equals(final Object o) {
            ...
            AppautoscalingPolicyStepScalingPolicyConfigurationStepAdjustment.Jsii$Proxy that = (AppautoscalingPolicyStepScalingPolicyConfigurationStepAdjustment.Jsii$Proxy) o;
