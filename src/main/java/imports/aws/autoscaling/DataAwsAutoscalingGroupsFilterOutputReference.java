...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.autoscaling.DataAwsAutoscalingGroupsFilterOutputReference")
public class DataAwsAutoscalingGroupsFilterOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsAutoscalingGroupsFilterOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsAutoscalingGroupsFilterOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.autoscaling.DataAwsAutoscalingGroupsFilter value) {
