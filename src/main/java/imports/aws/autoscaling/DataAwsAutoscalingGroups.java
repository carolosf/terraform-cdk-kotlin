...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.autoscaling.DataAwsAutoscalingGroups")
public class DataAwsAutoscalingGroups extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.autoscaling.DataAwsAutoscalingGroups.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     * @param config
     */
    public DataAwsAutoscalingGroups(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.autoscaling.DataAwsAutoscalingGroupsConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.autoscaling.DataAwsAutoscalingGroupsFilterList getFilter() {
        return software.amazon.jsii.Kernel.get(this, "filter", software.amazon.jsii.NativeType.forClass(imports.aws.autoscaling.DataAwsAutoscalingGroupsFilterList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.autoscaling.DataAwsAutoscalingGroups}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.autoscaling.DataAwsAutoscalingGroups> {
        /**
        ...
        private imports.aws.autoscaling.DataAwsAutoscalingGroupsConfig.Builder config;
         ...
         * @param filter filter block. This parameter is required.
         */
        public Builder filter(final java.util.List<? extends imports.aws.autoscaling.DataAwsAutoscalingGroupsFilter> filter) {
            this.config().filter(filter);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/autoscaling_groups#id DataAwsAutoscalingGroups#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.autoscaling.DataAwsAutoscalingGroups}.
         */
        @Override
        public imports.aws.autoscaling.DataAwsAutoscalingGroups build() {
            return new imports.aws.autoscaling.DataAwsAutoscalingGroups(
                this.scope,
                this.id,
        ...
        private imports.aws.autoscaling.DataAwsAutoscalingGroupsConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.autoscaling.DataAwsAutoscalingGroupsConfig.Builder();
            }
            return this.config;
        }
    }
