...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.autoscaling.AutoscalingGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification")
@software.amazon.jsii.Jsii.Proxy(AutoscalingGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification.Jsii$Proxy.class)
public interface AutoscalingGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link AutoscalingGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link AutoscalingGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification}
     */
    public static final class Builder implements software.amazon.jsii.Builder<AutoscalingGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification> {
        java.lang.String launchTemplateId;
        java.lang.String launchTemplateName;
        java.lang.String version;

        /**
         * Sets the value of {@link AutoscalingGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification#getLaunchTemplateId}
        ...
        /**
         * Sets the value of {@link AutoscalingGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification#getLaunchTemplateName}
        ...
        /**
         * Sets the value of {@link AutoscalingGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification#getVersion}
         ...
         * @return a new instance of {@link AutoscalingGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public AutoscalingGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link AutoscalingGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements AutoscalingGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.autoscaling.AutoscalingGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification"));
        ...
        public final boolean equals(final Object o) {
            ...
            AutoscalingGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification.Jsii$Proxy that = (AutoscalingGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification.Jsii$Proxy) o;
