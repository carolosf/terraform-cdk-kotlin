...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.sfn.SfnStateMachineTracingConfigurationOutputReference")
public class SfnStateMachineTracingConfigurationOutputReference extends com.hashicorp.cdktf.ComplexObject {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.sfn.SfnStateMachineTracingConfiguration getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.sfn.SfnStateMachineTracingConfiguration.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.sfn.SfnStateMachineTracingConfiguration value) {
