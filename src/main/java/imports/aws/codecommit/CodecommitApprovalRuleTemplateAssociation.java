...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.codecommit.CodecommitApprovalRuleTemplateAssociation")
public class CodecommitApprovalRuleTemplateAssociation extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.codecommit.CodecommitApprovalRuleTemplateAssociation.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.codecommit.CodecommitApprovalRuleTemplateAssociation}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.codecommit.CodecommitApprovalRuleTemplateAssociation> {
        /**
        ...
        private final imports.aws.codecommit.CodecommitApprovalRuleTemplateAssociationConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.codecommit.CodecommitApprovalRuleTemplateAssociationConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/codecommit_approval_rule_template_association#id CodecommitApprovalRuleTemplateAssociation#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.codecommit.CodecommitApprovalRuleTemplateAssociation}.
         */
        @Override
        public imports.aws.codecommit.CodecommitApprovalRuleTemplateAssociation build() {
            return new imports.aws.codecommit.CodecommitApprovalRuleTemplateAssociation(
                this.scope,
                this.id,
                this.config.build()
            );
