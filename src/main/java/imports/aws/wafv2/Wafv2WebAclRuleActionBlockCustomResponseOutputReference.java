...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.wafv2.Wafv2WebAclRuleActionBlockCustomResponseOutputReference")
public class Wafv2WebAclRuleActionBlockCustomResponseOutputReference extends com.hashicorp.cdktf.ComplexObject {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.wafv2.Wafv2WebAclRuleActionBlockCustomResponseResponseHeaderList getResponseHeader() {
        return software.amazon.jsii.Kernel.get(this, "responseHeader", software.amazon.jsii.NativeType.forClass(imports.aws.wafv2.Wafv2WebAclRuleActionBlockCustomResponseResponseHeaderList.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.wafv2.Wafv2WebAclRuleActionBlockCustomResponse getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.wafv2.Wafv2WebAclRuleActionBlockCustomResponse.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.wafv2.Wafv2WebAclRuleActionBlockCustomResponse value) {
