...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.wafv2.Wafv2RuleGroupRuleActionCountCustomRequestHandlingOutputReference")
public class Wafv2RuleGroupRuleActionCountCustomRequestHandlingOutputReference extends com.hashicorp.cdktf.ComplexObject {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.wafv2.Wafv2RuleGroupRuleActionCountCustomRequestHandlingInsertHeaderList getInsertHeader() {
        return software.amazon.jsii.Kernel.get(this, "insertHeader", software.amazon.jsii.NativeType.forClass(imports.aws.wafv2.Wafv2RuleGroupRuleActionCountCustomRequestHandlingInsertHeaderList.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.wafv2.Wafv2RuleGroupRuleActionCountCustomRequestHandling getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.wafv2.Wafv2RuleGroupRuleActionCountCustomRequestHandling.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.wafv2.Wafv2RuleGroupRuleActionCountCustomRequestHandling value) {
