...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.wafv2.Wafv2WebAclLoggingConfigurationLoggingFilterFilterConditionList")
public class Wafv2WebAclLoggingConfigurationLoggingFilterFilterConditionList extends com.hashicorp.cdktf.ComplexList {

    protected Wafv2WebAclLoggingConfigurationLoggingFilterFilterConditionList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected Wafv2WebAclLoggingConfigurationLoggingFilterFilterConditionList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.wafv2.Wafv2WebAclLoggingConfigurationLoggingFilterFilterConditionOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.wafv2.Wafv2WebAclLoggingConfigurationLoggingFilterFilterConditionOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.aws.wafv2.Wafv2WebAclLoggingConfigurationLoggingFilterFilterCondition> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
