...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.wafv2.Wafv2WebAclRuleStatementSizeConstraintStatement")
@software.amazon.jsii.Jsii.Proxy(Wafv2WebAclRuleStatementSizeConstraintStatement.Jsii$Proxy.class)
public interface Wafv2WebAclRuleStatementSizeConstraintStatement extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.aws.wafv2.Wafv2WebAclRuleStatementSizeConstraintStatementFieldToMatch getFieldToMatch() {
        return null;
    }

    /**
     * @return a {@link Builder} of {@link Wafv2WebAclRuleStatementSizeConstraintStatement}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link Wafv2WebAclRuleStatementSizeConstraintStatement}
     */
    public static final class Builder implements software.amazon.jsii.Builder<Wafv2WebAclRuleStatementSizeConstraintStatement> {
        java.lang.String comparisonOperator;
        java.lang.Number size;
        java.lang.Object textTransformation;
        imports.aws.wafv2.Wafv2WebAclRuleStatementSizeConstraintStatementFieldToMatch fieldToMatch;

        /**
         * Sets the value of {@link Wafv2WebAclRuleStatementSizeConstraintStatement#getComparisonOperator}
        ...
        /**
         * Sets the value of {@link Wafv2WebAclRuleStatementSizeConstraintStatement#getSize}
        ...
        /**
         * Sets the value of {@link Wafv2WebAclRuleStatementSizeConstraintStatement#getTextTransformation}
         ...
         * @return {@code this}
         */
        public Builder textTransformation(java.util.List<? extends imports.aws.wafv2.Wafv2WebAclRuleStatementSizeConstraintStatementTextTransformation> textTransformation) {
            this.textTransformation = textTransformation;
            return this;
        }

        /**
         * Sets the value of {@link Wafv2WebAclRuleStatementSizeConstraintStatement#getFieldToMatch}
         * @param fieldToMatch field_to_match block.
         *                     Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/aws/r/wafv2_web_acl#field_to_match Wafv2WebAcl#field_to_match}
         * @return {@code this}
         */
        public Builder fieldToMatch(imports.aws.wafv2.Wafv2WebAclRuleStatementSizeConstraintStatementFieldToMatch fieldToMatch) {
         ...
         * @return a new instance of {@link Wafv2WebAclRuleStatementSizeConstraintStatement}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public Wafv2WebAclRuleStatementSizeConstraintStatement build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link Wafv2WebAclRuleStatementSizeConstraintStatement}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements Wafv2WebAclRuleStatementSizeConstraintStatement {
        ...
        private final imports.aws.wafv2.Wafv2WebAclRuleStatementSizeConstraintStatementFieldToMatch fieldToMatch;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.fieldToMatch = software.amazon.jsii.Kernel.get(this, "fieldToMatch", software.amazon.jsii.NativeType.forClass(imports.aws.wafv2.Wafv2WebAclRuleStatementSizeConstraintStatementFieldToMatch.class));
        }
        ...
        @Override
        public final imports.aws.wafv2.Wafv2WebAclRuleStatementSizeConstraintStatementFieldToMatch getFieldToMatch() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.wafv2.Wafv2WebAclRuleStatementSizeConstraintStatement"));
        ...
        public final boolean equals(final Object o) {
            ...
            Wafv2WebAclRuleStatementSizeConstraintStatement.Jsii$Proxy that = (Wafv2WebAclRuleStatementSizeConstraintStatement.Jsii$Proxy) o;
