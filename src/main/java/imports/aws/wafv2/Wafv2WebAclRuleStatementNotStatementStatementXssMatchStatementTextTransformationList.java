...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.wafv2.Wafv2WebAclRuleStatementNotStatementStatementXssMatchStatementTextTransformationList")
public class Wafv2WebAclRuleStatementNotStatementStatementXssMatchStatementTextTransformationList extends com.hashicorp.cdktf.ComplexList {

    protected Wafv2WebAclRuleStatementNotStatementStatementXssMatchStatementTextTransformationList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected Wafv2WebAclRuleStatementNotStatementStatementXssMatchStatementTextTransformationList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public Wafv2WebAclRuleStatementNotStatementStatementXssMatchStatementTextTransformationList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.wafv2.Wafv2WebAclRuleStatementNotStatementStatementXssMatchStatementTextTransformationOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.wafv2.Wafv2WebAclRuleStatementNotStatementStatementXssMatchStatementTextTransformationOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.aws.wafv2.Wafv2WebAclRuleStatementNotStatementStatementXssMatchStatementTextTransformation> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
