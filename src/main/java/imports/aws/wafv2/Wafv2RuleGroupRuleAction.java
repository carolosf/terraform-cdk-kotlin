...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.wafv2.Wafv2RuleGroupRuleAction")
...
public interface Wafv2RuleGroupRuleAction extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.aws.wafv2.Wafv2RuleGroupRuleActionAllow getAllow() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.aws.wafv2.Wafv2RuleGroupRuleActionBlock getBlock() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.aws.wafv2.Wafv2RuleGroupRuleActionCount getCount() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<Wafv2RuleGroupRuleAction> {
        imports.aws.wafv2.Wafv2RuleGroupRuleActionAllow allow;
        imports.aws.wafv2.Wafv2RuleGroupRuleActionBlock block;
        imports.aws.wafv2.Wafv2RuleGroupRuleActionCount count;
         ...
         * @return {@code this}
         */
        public Builder allow(imports.aws.wafv2.Wafv2RuleGroupRuleActionAllow allow) {
            this.allow = allow;
            return this;
        }
         ...
         * @return {@code this}
         */
        public Builder block(imports.aws.wafv2.Wafv2RuleGroupRuleActionBlock block) {
            this.block = block;
            return this;
        }
         ...
         * @return {@code this}
         */
        public Builder count(imports.aws.wafv2.Wafv2RuleGroupRuleActionCount count) {
            this.count = count;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements Wafv2RuleGroupRuleAction {
        private final imports.aws.wafv2.Wafv2RuleGroupRuleActionAllow allow;
        private final imports.aws.wafv2.Wafv2RuleGroupRuleActionBlock block;
        private final imports.aws.wafv2.Wafv2RuleGroupRuleActionCount count;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.allow = software.amazon.jsii.Kernel.get(this, "allow", software.amazon.jsii.NativeType.forClass(imports.aws.wafv2.Wafv2RuleGroupRuleActionAllow.class));
            this.block = software.amazon.jsii.Kernel.get(this, "block", software.amazon.jsii.NativeType.forClass(imports.aws.wafv2.Wafv2RuleGroupRuleActionBlock.class));
            this.count = software.amazon.jsii.Kernel.get(this, "count", software.amazon.jsii.NativeType.forClass(imports.aws.wafv2.Wafv2RuleGroupRuleActionCount.class));
        }
        ...
        @Override
        public final imports.aws.wafv2.Wafv2RuleGroupRuleActionAllow getAllow() {
            return this.allow;
        }

        @Override
        public final imports.aws.wafv2.Wafv2RuleGroupRuleActionBlock getBlock() {
            return this.block;
        }

        @Override
        public final imports.aws.wafv2.Wafv2RuleGroupRuleActionCount getCount() {
            return this.count;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.wafv2.Wafv2RuleGroupRuleAction"));
