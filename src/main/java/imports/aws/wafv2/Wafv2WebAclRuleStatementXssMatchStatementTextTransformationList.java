...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.wafv2.Wafv2WebAclRuleStatementXssMatchStatementTextTransformationList")
public class Wafv2WebAclRuleStatementXssMatchStatementTextTransformationList extends com.hashicorp.cdktf.ComplexList {

    protected Wafv2WebAclRuleStatementXssMatchStatementTextTransformationList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected Wafv2WebAclRuleStatementXssMatchStatementTextTransformationList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.wafv2.Wafv2WebAclRuleStatementXssMatchStatementTextTransformationOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.wafv2.Wafv2WebAclRuleStatementXssMatchStatementTextTransformationOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.aws.wafv2.Wafv2WebAclRuleStatementXssMatchStatementTextTransformation> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
