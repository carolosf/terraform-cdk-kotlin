...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.eventbridge.CloudwatchEventConnectionAuthParametersInvocationHttpParametersHeader")
@software.amazon.jsii.Jsii.Proxy(CloudwatchEventConnectionAuthParametersInvocationHttpParametersHeader.Jsii$Proxy.class)
public interface CloudwatchEventConnectionAuthParametersInvocationHttpParametersHeader extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link CloudwatchEventConnectionAuthParametersInvocationHttpParametersHeader}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link CloudwatchEventConnectionAuthParametersInvocationHttpParametersHeader}
     */
    public static final class Builder implements software.amazon.jsii.Builder<CloudwatchEventConnectionAuthParametersInvocationHttpParametersHeader> {
        java.lang.Object isValueSecret;
        java.lang.String key;
        java.lang.String value;

        /**
         * Sets the value of {@link CloudwatchEventConnectionAuthParametersInvocationHttpParametersHeader#getIsValueSecret}
        ...
        /**
         * Sets the value of {@link CloudwatchEventConnectionAuthParametersInvocationHttpParametersHeader#getKey}
        ...
        /**
         * Sets the value of {@link CloudwatchEventConnectionAuthParametersInvocationHttpParametersHeader#getValue}
         ...
         * @return a new instance of {@link CloudwatchEventConnectionAuthParametersInvocationHttpParametersHeader}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public CloudwatchEventConnectionAuthParametersInvocationHttpParametersHeader build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link CloudwatchEventConnectionAuthParametersInvocationHttpParametersHeader}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CloudwatchEventConnectionAuthParametersInvocationHttpParametersHeader {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.eventbridge.CloudwatchEventConnectionAuthParametersInvocationHttpParametersHeader"));
        ...
        public final boolean equals(final Object o) {
            ...
            CloudwatchEventConnectionAuthParametersInvocationHttpParametersHeader.Jsii$Proxy that = (CloudwatchEventConnectionAuthParametersInvocationHttpParametersHeader.Jsii$Proxy) o;
