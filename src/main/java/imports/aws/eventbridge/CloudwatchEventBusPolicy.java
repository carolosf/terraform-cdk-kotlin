...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.eventbridge.CloudwatchEventBusPolicy")
public class CloudwatchEventBusPolicy extends com.hashicorp.cdktf.TerraformResource {

    protected CloudwatchEventBusPolicy(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CloudwatchEventBusPolicy(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.eventbridge.CloudwatchEventBusPolicy.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public CloudwatchEventBusPolicy(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.eventbridge.CloudwatchEventBusPolicyConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.eventbridge.CloudwatchEventBusPolicy}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.eventbridge.CloudwatchEventBusPolicy> {
        /**
        ...
        private final imports.aws.eventbridge.CloudwatchEventBusPolicyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.eventbridge.CloudwatchEventBusPolicyConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param eventBusName Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/cloudwatch_event_bus_policy#event_bus_name CloudwatchEventBusPolicy#event_bus_name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/cloudwatch_event_bus_policy#id CloudwatchEventBusPolicy#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.eventbridge.CloudwatchEventBusPolicy}.
         */
        @Override
        public imports.aws.eventbridge.CloudwatchEventBusPolicy build() {
            return new imports.aws.eventbridge.CloudwatchEventBusPolicy(
                this.scope,
                this.id,
                this.config.build()
            );
