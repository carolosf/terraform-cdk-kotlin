...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.securityhub.SecurityhubInsightFiltersNoteUpdatedBy")
@software.amazon.jsii.Jsii.Proxy(SecurityhubInsightFiltersNoteUpdatedBy.Jsii$Proxy.class)
public interface SecurityhubInsightFiltersNoteUpdatedBy extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link SecurityhubInsightFiltersNoteUpdatedBy}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link SecurityhubInsightFiltersNoteUpdatedBy}
     */
    public static final class Builder implements software.amazon.jsii.Builder<SecurityhubInsightFiltersNoteUpdatedBy> {
        java.lang.String comparison;
        java.lang.String value;

        /**
         * Sets the value of {@link SecurityhubInsightFiltersNoteUpdatedBy#getComparison}
        ...
        /**
         * Sets the value of {@link SecurityhubInsightFiltersNoteUpdatedBy#getValue}
         ...
         * @return a new instance of {@link SecurityhubInsightFiltersNoteUpdatedBy}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public SecurityhubInsightFiltersNoteUpdatedBy build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link SecurityhubInsightFiltersNoteUpdatedBy}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SecurityhubInsightFiltersNoteUpdatedBy {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.securityhub.SecurityhubInsightFiltersNoteUpdatedBy"));
        ...
        public final boolean equals(final Object o) {
            ...
            SecurityhubInsightFiltersNoteUpdatedBy.Jsii$Proxy that = (SecurityhubInsightFiltersNoteUpdatedBy.Jsii$Proxy) o;
