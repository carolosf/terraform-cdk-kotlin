...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.securityhub.SecurityhubInsightFiltersConfidence")
@software.amazon.jsii.Jsii.Proxy(SecurityhubInsightFiltersConfidence.Jsii$Proxy.class)
public interface SecurityhubInsightFiltersConfidence extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link SecurityhubInsightFiltersConfidence}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link SecurityhubInsightFiltersConfidence}
     */
    public static final class Builder implements software.amazon.jsii.Builder<SecurityhubInsightFiltersConfidence> {
        java.lang.String eq;
        java.lang.String gte;
        java.lang.String lte;

        /**
         * Sets the value of {@link SecurityhubInsightFiltersConfidence#getEq}
        ...
        /**
         * Sets the value of {@link SecurityhubInsightFiltersConfidence#getGte}
        ...
        /**
         * Sets the value of {@link SecurityhubInsightFiltersConfidence#getLte}
         ...
         * @return a new instance of {@link SecurityhubInsightFiltersConfidence}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public SecurityhubInsightFiltersConfidence build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link SecurityhubInsightFiltersConfidence}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SecurityhubInsightFiltersConfidence {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.securityhub.SecurityhubInsightFiltersConfidence"));
        ...
        public final boolean equals(final Object o) {
            ...
            SecurityhubInsightFiltersConfidence.Jsii$Proxy that = (SecurityhubInsightFiltersConfidence.Jsii$Proxy) o;
