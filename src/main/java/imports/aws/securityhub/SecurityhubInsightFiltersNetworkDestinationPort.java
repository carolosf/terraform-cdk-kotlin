...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.securityhub.SecurityhubInsightFiltersNetworkDestinationPort")
@software.amazon.jsii.Jsii.Proxy(SecurityhubInsightFiltersNetworkDestinationPort.Jsii$Proxy.class)
public interface SecurityhubInsightFiltersNetworkDestinationPort extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link SecurityhubInsightFiltersNetworkDestinationPort}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link SecurityhubInsightFiltersNetworkDestinationPort}
     */
    public static final class Builder implements software.amazon.jsii.Builder<SecurityhubInsightFiltersNetworkDestinationPort> {
        java.lang.String eq;
        java.lang.String gte;
        java.lang.String lte;

        /**
         * Sets the value of {@link SecurityhubInsightFiltersNetworkDestinationPort#getEq}
        ...
        /**
         * Sets the value of {@link SecurityhubInsightFiltersNetworkDestinationPort#getGte}
        ...
        /**
         * Sets the value of {@link SecurityhubInsightFiltersNetworkDestinationPort#getLte}
         ...
         * @return a new instance of {@link SecurityhubInsightFiltersNetworkDestinationPort}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public SecurityhubInsightFiltersNetworkDestinationPort build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link SecurityhubInsightFiltersNetworkDestinationPort}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SecurityhubInsightFiltersNetworkDestinationPort {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.securityhub.SecurityhubInsightFiltersNetworkDestinationPort"));
        ...
        public final boolean equals(final Object o) {
            ...
            SecurityhubInsightFiltersNetworkDestinationPort.Jsii$Proxy that = (SecurityhubInsightFiltersNetworkDestinationPort.Jsii$Proxy) o;
