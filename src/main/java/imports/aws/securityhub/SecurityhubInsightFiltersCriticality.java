...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.securityhub.SecurityhubInsightFiltersCriticality")
@software.amazon.jsii.Jsii.Proxy(SecurityhubInsightFiltersCriticality.Jsii$Proxy.class)
public interface SecurityhubInsightFiltersCriticality extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link SecurityhubInsightFiltersCriticality}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link SecurityhubInsightFiltersCriticality}
     */
    public static final class Builder implements software.amazon.jsii.Builder<SecurityhubInsightFiltersCriticality> {
        java.lang.String eq;
        java.lang.String gte;
        java.lang.String lte;

        /**
         * Sets the value of {@link SecurityhubInsightFiltersCriticality#getEq}
        ...
        /**
         * Sets the value of {@link SecurityhubInsightFiltersCriticality#getGte}
        ...
        /**
         * Sets the value of {@link SecurityhubInsightFiltersCriticality#getLte}
         ...
         * @return a new instance of {@link SecurityhubInsightFiltersCriticality}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public SecurityhubInsightFiltersCriticality build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link SecurityhubInsightFiltersCriticality}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SecurityhubInsightFiltersCriticality {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.securityhub.SecurityhubInsightFiltersCriticality"));
        ...
        public final boolean equals(final Object o) {
            ...
            SecurityhubInsightFiltersCriticality.Jsii$Proxy that = (SecurityhubInsightFiltersCriticality.Jsii$Proxy) o;
