...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.securityhub.SecurityhubInsightFiltersNetworkProtocol")
@software.amazon.jsii.Jsii.Proxy(SecurityhubInsightFiltersNetworkProtocol.Jsii$Proxy.class)
public interface SecurityhubInsightFiltersNetworkProtocol extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link SecurityhubInsightFiltersNetworkProtocol}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link SecurityhubInsightFiltersNetworkProtocol}
     */
    public static final class Builder implements software.amazon.jsii.Builder<SecurityhubInsightFiltersNetworkProtocol> {
        java.lang.String comparison;
        java.lang.String value;

        /**
         * Sets the value of {@link SecurityhubInsightFiltersNetworkProtocol#getComparison}
        ...
        /**
         * Sets the value of {@link SecurityhubInsightFiltersNetworkProtocol#getValue}
         ...
         * @return a new instance of {@link SecurityhubInsightFiltersNetworkProtocol}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public SecurityhubInsightFiltersNetworkProtocol build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link SecurityhubInsightFiltersNetworkProtocol}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SecurityhubInsightFiltersNetworkProtocol {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.securityhub.SecurityhubInsightFiltersNetworkProtocol"));
        ...
        public final boolean equals(final Object o) {
            ...
            SecurityhubInsightFiltersNetworkProtocol.Jsii$Proxy that = (SecurityhubInsightFiltersNetworkProtocol.Jsii$Proxy) o;
