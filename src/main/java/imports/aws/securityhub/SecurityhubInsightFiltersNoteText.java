...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.securityhub.SecurityhubInsightFiltersNoteText")
@software.amazon.jsii.Jsii.Proxy(SecurityhubInsightFiltersNoteText.Jsii$Proxy.class)
public interface SecurityhubInsightFiltersNoteText extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link SecurityhubInsightFiltersNoteText}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link SecurityhubInsightFiltersNoteText}
     */
    public static final class Builder implements software.amazon.jsii.Builder<SecurityhubInsightFiltersNoteText> {
        java.lang.String comparison;
        java.lang.String value;

        /**
         * Sets the value of {@link SecurityhubInsightFiltersNoteText#getComparison}
        ...
        /**
         * Sets the value of {@link SecurityhubInsightFiltersNoteText#getValue}
         ...
         * @return a new instance of {@link SecurityhubInsightFiltersNoteText}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public SecurityhubInsightFiltersNoteText build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link SecurityhubInsightFiltersNoteText}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SecurityhubInsightFiltersNoteText {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.securityhub.SecurityhubInsightFiltersNoteText"));
        ...
        public final boolean equals(final Object o) {
            ...
            SecurityhubInsightFiltersNoteText.Jsii$Proxy that = (SecurityhubInsightFiltersNoteText.Jsii$Proxy) o;
