...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.securityhub.SecurityhubInsightFiltersResourceAwsIamAccessKeyCreatedAtOutputReference")
public class SecurityhubInsightFiltersResourceAwsIamAccessKeyCreatedAtOutputReference extends com.hashicorp.cdktf.ComplexObject {
    ...
    public void putDateRange(final @org.jetbrains.annotations.NotNull imports.aws.securityhub.SecurityhubInsightFiltersResourceAwsIamAccessKeyCreatedAtDateRange value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.securityhub.SecurityhubInsightFiltersResourceAwsIamAccessKeyCreatedAtDateRangeOutputReference getDateRange() {
        return software.amazon.jsii.Kernel.get(this, "dateRange", software.amazon.jsii.NativeType.forClass(imports.aws.securityhub.SecurityhubInsightFiltersResourceAwsIamAccessKeyCreatedAtDateRangeOutputReference.class));
    }

    public @org.jetbrains.annotations.Nullable imports.aws.securityhub.SecurityhubInsightFiltersResourceAwsIamAccessKeyCreatedAtDateRange getDateRangeInput() {
        return software.amazon.jsii.Kernel.get(this, "dateRangeInput", software.amazon.jsii.NativeType.forClass(imports.aws.securityhub.SecurityhubInsightFiltersResourceAwsIamAccessKeyCreatedAtDateRange.class));
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.securityhub.SecurityhubInsightFiltersResourceAwsIamAccessKeyCreatedAt value) {
