...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.securityhub.SecurityhubInsightFiltersThreatIntelIndicatorType")
@software.amazon.jsii.Jsii.Proxy(SecurityhubInsightFiltersThreatIntelIndicatorType.Jsii$Proxy.class)
public interface SecurityhubInsightFiltersThreatIntelIndicatorType extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link SecurityhubInsightFiltersThreatIntelIndicatorType}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link SecurityhubInsightFiltersThreatIntelIndicatorType}
     */
    public static final class Builder implements software.amazon.jsii.Builder<SecurityhubInsightFiltersThreatIntelIndicatorType> {
        ...
        /**
         * Sets the value of {@link SecurityhubInsightFiltersThreatIntelIndicatorType#getComparison}
        ...
        /**
         * Sets the value of {@link SecurityhubInsightFiltersThreatIntelIndicatorType#getValue}
         ...
         * @return a new instance of {@link SecurityhubInsightFiltersThreatIntelIndicatorType}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public SecurityhubInsightFiltersThreatIntelIndicatorType build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link SecurityhubInsightFiltersThreatIntelIndicatorType}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SecurityhubInsightFiltersThreatIntelIndicatorType {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.securityhub.SecurityhubInsightFiltersThreatIntelIndicatorType"));
        ...
        public final boolean equals(final Object o) {
            ...
            SecurityhubInsightFiltersThreatIntelIndicatorType.Jsii$Proxy that = (SecurityhubInsightFiltersThreatIntelIndicatorType.Jsii$Proxy) o;
