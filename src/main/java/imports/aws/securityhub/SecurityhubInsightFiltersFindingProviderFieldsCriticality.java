...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.securityhub.SecurityhubInsightFiltersFindingProviderFieldsCriticality")
@software.amazon.jsii.Jsii.Proxy(SecurityhubInsightFiltersFindingProviderFieldsCriticality.Jsii$Proxy.class)
public interface SecurityhubInsightFiltersFindingProviderFieldsCriticality extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link SecurityhubInsightFiltersFindingProviderFieldsCriticality}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link SecurityhubInsightFiltersFindingProviderFieldsCriticality}
     */
    public static final class Builder implements software.amazon.jsii.Builder<SecurityhubInsightFiltersFindingProviderFieldsCriticality> {
        java.lang.String eq;
        java.lang.String gte;
        java.lang.String lte;

        /**
         * Sets the value of {@link SecurityhubInsightFiltersFindingProviderFieldsCriticality#getEq}
        ...
        /**
         * Sets the value of {@link SecurityhubInsightFiltersFindingProviderFieldsCriticality#getGte}
        ...
        /**
         * Sets the value of {@link SecurityhubInsightFiltersFindingProviderFieldsCriticality#getLte}
         ...
         * @return a new instance of {@link SecurityhubInsightFiltersFindingProviderFieldsCriticality}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public SecurityhubInsightFiltersFindingProviderFieldsCriticality build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link SecurityhubInsightFiltersFindingProviderFieldsCriticality}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SecurityhubInsightFiltersFindingProviderFieldsCriticality {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.securityhub.SecurityhubInsightFiltersFindingProviderFieldsCriticality"));
        ...
        public final boolean equals(final Object o) {
            ...
            SecurityhubInsightFiltersFindingProviderFieldsCriticality.Jsii$Proxy that = (SecurityhubInsightFiltersFindingProviderFieldsCriticality.Jsii$Proxy) o;
