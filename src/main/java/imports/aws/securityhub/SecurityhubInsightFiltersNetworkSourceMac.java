...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.securityhub.SecurityhubInsightFiltersNetworkSourceMac")
@software.amazon.jsii.Jsii.Proxy(SecurityhubInsightFiltersNetworkSourceMac.Jsii$Proxy.class)
public interface SecurityhubInsightFiltersNetworkSourceMac extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link SecurityhubInsightFiltersNetworkSourceMac}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link SecurityhubInsightFiltersNetworkSourceMac}
     */
    public static final class Builder implements software.amazon.jsii.Builder<SecurityhubInsightFiltersNetworkSourceMac> {
        java.lang.String comparison;
        java.lang.String value;

        /**
         * Sets the value of {@link SecurityhubInsightFiltersNetworkSourceMac#getComparison}
        ...
        /**
         * Sets the value of {@link SecurityhubInsightFiltersNetworkSourceMac#getValue}
         ...
         * @return a new instance of {@link SecurityhubInsightFiltersNetworkSourceMac}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public SecurityhubInsightFiltersNetworkSourceMac build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link SecurityhubInsightFiltersNetworkSourceMac}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SecurityhubInsightFiltersNetworkSourceMac {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.securityhub.SecurityhubInsightFiltersNetworkSourceMac"));
        ...
        public final boolean equals(final Object o) {
            ...
            SecurityhubInsightFiltersNetworkSourceMac.Jsii$Proxy that = (SecurityhubInsightFiltersNetworkSourceMac.Jsii$Proxy) o;
