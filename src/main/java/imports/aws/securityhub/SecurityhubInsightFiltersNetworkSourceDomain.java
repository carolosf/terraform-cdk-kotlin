...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.securityhub.SecurityhubInsightFiltersNetworkSourceDomain")
@software.amazon.jsii.Jsii.Proxy(SecurityhubInsightFiltersNetworkSourceDomain.Jsii$Proxy.class)
public interface SecurityhubInsightFiltersNetworkSourceDomain extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link SecurityhubInsightFiltersNetworkSourceDomain}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link SecurityhubInsightFiltersNetworkSourceDomain}
     */
    public static final class Builder implements software.amazon.jsii.Builder<SecurityhubInsightFiltersNetworkSourceDomain> {
        java.lang.String comparison;
        java.lang.String value;

        /**
         * Sets the value of {@link SecurityhubInsightFiltersNetworkSourceDomain#getComparison}
        ...
        /**
         * Sets the value of {@link SecurityhubInsightFiltersNetworkSourceDomain#getValue}
         ...
         * @return a new instance of {@link SecurityhubInsightFiltersNetworkSourceDomain}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public SecurityhubInsightFiltersNetworkSourceDomain build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link SecurityhubInsightFiltersNetworkSourceDomain}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SecurityhubInsightFiltersNetworkSourceDomain {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.securityhub.SecurityhubInsightFiltersNetworkSourceDomain"));
        ...
        public final boolean equals(final Object o) {
            ...
            SecurityhubInsightFiltersNetworkSourceDomain.Jsii$Proxy that = (SecurityhubInsightFiltersNetworkSourceDomain.Jsii$Proxy) o;
