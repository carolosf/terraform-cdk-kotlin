...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.securityhub.SecurityhubInsightFiltersUpdatedAt")
...
public interface SecurityhubInsightFiltersUpdatedAt extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.aws.securityhub.SecurityhubInsightFiltersUpdatedAtDateRange getDateRange() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<SecurityhubInsightFiltersUpdatedAt> {
        imports.aws.securityhub.SecurityhubInsightFiltersUpdatedAtDateRange dateRange;
         ...
         * @return {@code this}
         */
        public Builder dateRange(imports.aws.securityhub.SecurityhubInsightFiltersUpdatedAtDateRange dateRange) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SecurityhubInsightFiltersUpdatedAt {
        private final imports.aws.securityhub.SecurityhubInsightFiltersUpdatedAtDateRange dateRange;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.dateRange = software.amazon.jsii.Kernel.get(this, "dateRange", software.amazon.jsii.NativeType.forClass(imports.aws.securityhub.SecurityhubInsightFiltersUpdatedAtDateRange.class));
        ...
        @Override
        public final imports.aws.securityhub.SecurityhubInsightFiltersUpdatedAtDateRange getDateRange() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.securityhub.SecurityhubInsightFiltersUpdatedAt"));
