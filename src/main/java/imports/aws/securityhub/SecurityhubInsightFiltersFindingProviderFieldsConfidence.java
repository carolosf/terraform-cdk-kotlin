...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.securityhub.SecurityhubInsightFiltersFindingProviderFieldsConfidence")
@software.amazon.jsii.Jsii.Proxy(SecurityhubInsightFiltersFindingProviderFieldsConfidence.Jsii$Proxy.class)
public interface SecurityhubInsightFiltersFindingProviderFieldsConfidence extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link SecurityhubInsightFiltersFindingProviderFieldsConfidence}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link SecurityhubInsightFiltersFindingProviderFieldsConfidence}
     */
    public static final class Builder implements software.amazon.jsii.Builder<SecurityhubInsightFiltersFindingProviderFieldsConfidence> {
        java.lang.String eq;
        java.lang.String gte;
        java.lang.String lte;

        /**
         * Sets the value of {@link SecurityhubInsightFiltersFindingProviderFieldsConfidence#getEq}
        ...
        /**
         * Sets the value of {@link SecurityhubInsightFiltersFindingProviderFieldsConfidence#getGte}
        ...
        /**
         * Sets the value of {@link SecurityhubInsightFiltersFindingProviderFieldsConfidence#getLte}
         ...
         * @return a new instance of {@link SecurityhubInsightFiltersFindingProviderFieldsConfidence}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public SecurityhubInsightFiltersFindingProviderFieldsConfidence build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link SecurityhubInsightFiltersFindingProviderFieldsConfidence}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SecurityhubInsightFiltersFindingProviderFieldsConfidence {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.securityhub.SecurityhubInsightFiltersFindingProviderFieldsConfidence"));
        ...
        public final boolean equals(final Object o) {
            ...
            SecurityhubInsightFiltersFindingProviderFieldsConfidence.Jsii$Proxy that = (SecurityhubInsightFiltersFindingProviderFieldsConfidence.Jsii$Proxy) o;
