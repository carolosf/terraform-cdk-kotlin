 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:19.335Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.codepipeline.CodepipelineWebhook")
public class CodepipelineWebhook extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.codepipeline.CodepipelineWebhook.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public CodepipelineWebhook(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.codepipeline.CodepipelineWebhookConfig config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public void putAuthenticationConfiguration(final @org.jetbrains.annotations.NotNull imports.aws.codepipeline.CodepipelineWebhookAuthenticationConfiguration value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.codepipeline.CodepipelineWebhookAuthenticationConfigurationOutputReference getAuthenticationConfiguration() {
        return software.amazon.jsii.Kernel.get(this, "authenticationConfiguration", software.amazon.jsii.NativeType.forClass(imports.aws.codepipeline.CodepipelineWebhookAuthenticationConfigurationOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull imports.aws.codepipeline.CodepipelineWebhookFilterList getFilter() {
        return software.amazon.jsii.Kernel.get(this, "filter", software.amazon.jsii.NativeType.forClass(imports.aws.codepipeline.CodepipelineWebhookFilterList.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.codepipeline.CodepipelineWebhookAuthenticationConfiguration getAuthenticationConfigurationInput() {
        return software.amazon.jsii.Kernel.get(this, "authenticationConfigurationInput", software.amazon.jsii.NativeType.forClass(imports.aws.codepipeline.CodepipelineWebhookAuthenticationConfiguration.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable java.lang.String getTargetActionInput() {
    ...
    public @org.jetbrains.annotations.Nullable java.lang.String getTargetPipelineInput() {
    ...
    /**
     * A fluent builder for {@link imports.aws.codepipeline.CodepipelineWebhook}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.codepipeline.CodepipelineWebhook> {
        /**
        ...
        private final imports.aws.codepipeline.CodepipelineWebhookConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.codepipeline.CodepipelineWebhookConfig.Builder();
        }
         ...
         * @param filter filter block. This parameter is required.
         */
        public Builder filter(final java.util.List<? extends imports.aws.codepipeline.CodepipelineWebhookFilter> filter) {
            this.config.filter(filter);
            return this;
        }
         ...
         */
        public Builder authenticationConfiguration(final imports.aws.codepipeline.CodepipelineWebhookAuthenticationConfiguration authenticationConfiguration) {
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/codepipeline_webhook#id CodepipelineWebhook#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/codepipeline_webhook#tags CodepipelineWebhook#tags}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tagsAll Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/codepipeline_webhook#tags_all CodepipelineWebhook#tags_all}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.codepipeline.CodepipelineWebhook}.
         */
        @Override
        public imports.aws.codepipeline.CodepipelineWebhook build() {
            return new imports.aws.codepipeline.CodepipelineWebhook(
                this.scope,
                this.id,
                this.config.build()
            );
