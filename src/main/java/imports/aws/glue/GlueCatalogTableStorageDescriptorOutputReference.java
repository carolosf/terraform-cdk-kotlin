...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:19.727Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.glue.GlueCatalogTableStorageDescriptorOutputReference")
public class GlueCatalogTableStorageDescriptorOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected GlueCatalogTableStorageDescriptorOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected GlueCatalogTableStorageDescriptorOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public GlueCatalogTableStorageDescriptorOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void putSchemaReference(final @org.jetbrains.annotations.NotNull imports.aws.glue.GlueCatalogTableStorageDescriptorSchemaReference value) {
        software.amazon.jsii.Kernel.call(this, "putSchemaReference", software.amazon.jsii.NativeType.VOID, new Object[] { java.util.Objects.requireNonNull(value, "value is required") });
    }

    public void putSerDeInfo(final @org.jetbrains.annotations.NotNull imports.aws.glue.GlueCatalogTableStorageDescriptorSerDeInfo value) {
    ...
    public void putSkewedInfo(final @org.jetbrains.annotations.NotNull imports.aws.glue.GlueCatalogTableStorageDescriptorSkewedInfo value) {
    ...
    public void resetSchemaReference() {
        software.amazon.jsii.Kernel.call(this, "resetSchemaReference", software.amazon.jsii.NativeType.VOID);
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.glue.GlueCatalogTableStorageDescriptorColumnsList getColumns() {
        return software.amazon.jsii.Kernel.get(this, "columns", software.amazon.jsii.NativeType.forClass(imports.aws.glue.GlueCatalogTableStorageDescriptorColumnsList.class));
    }

    public @org.jetbrains.annotations.NotNull imports.aws.glue.GlueCatalogTableStorageDescriptorSchemaReferenceOutputReference getSchemaReference() {
        return software.amazon.jsii.Kernel.get(this, "schemaReference", software.amazon.jsii.NativeType.forClass(imports.aws.glue.GlueCatalogTableStorageDescriptorSchemaReferenceOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull imports.aws.glue.GlueCatalogTableStorageDescriptorSerDeInfoOutputReference getSerDeInfo() {
        return software.amazon.jsii.Kernel.get(this, "serDeInfo", software.amazon.jsii.NativeType.forClass(imports.aws.glue.GlueCatalogTableStorageDescriptorSerDeInfoOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull imports.aws.glue.GlueCatalogTableStorageDescriptorSkewedInfoOutputReference getSkewedInfo() {
        return software.amazon.jsii.Kernel.get(this, "skewedInfo", software.amazon.jsii.NativeType.forClass(imports.aws.glue.GlueCatalogTableStorageDescriptorSkewedInfoOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull imports.aws.glue.GlueCatalogTableStorageDescriptorSortColumnsList getSortColumns() {
        return software.amazon.jsii.Kernel.get(this, "sortColumns", software.amazon.jsii.NativeType.forClass(imports.aws.glue.GlueCatalogTableStorageDescriptorSortColumnsList.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.glue.GlueCatalogTableStorageDescriptorSchemaReference getSchemaReferenceInput() {
        return software.amazon.jsii.Kernel.get(this, "schemaReferenceInput", software.amazon.jsii.NativeType.forClass(imports.aws.glue.GlueCatalogTableStorageDescriptorSchemaReference.class));
    }

    public @org.jetbrains.annotations.Nullable imports.aws.glue.GlueCatalogTableStorageDescriptorSerDeInfo getSerDeInfoInput() {
        return software.amazon.jsii.Kernel.get(this, "serDeInfoInput", software.amazon.jsii.NativeType.forClass(imports.aws.glue.GlueCatalogTableStorageDescriptorSerDeInfo.class));
    }

    public @org.jetbrains.annotations.Nullable imports.aws.glue.GlueCatalogTableStorageDescriptorSkewedInfo getSkewedInfoInput() {
        return software.amazon.jsii.Kernel.get(this, "skewedInfoInput", software.amazon.jsii.NativeType.forClass(imports.aws.glue.GlueCatalogTableStorageDescriptorSkewedInfo.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.glue.GlueCatalogTableStorageDescriptor getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.glue.GlueCatalogTableStorageDescriptor.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.glue.GlueCatalogTableStorageDescriptor value) {
