 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:19.728Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.glue.GlueConnection")
public class GlueConnection extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.glue.GlueConnection.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public GlueConnection(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.glue.GlueConnectionConfig config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public void putPhysicalConnectionRequirements(final @org.jetbrains.annotations.NotNull imports.aws.glue.GlueConnectionPhysicalConnectionRequirements value) {
        software.amazon.jsii.Kernel.call(this, "putPhysicalConnectionRequirements", software.amazon.jsii.NativeType.VOID, new Object[] { java.util.Objects.requireNonNull(value, "value is required") });
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.glue.GlueConnectionPhysicalConnectionRequirementsOutputReference getPhysicalConnectionRequirements() {
        return software.amazon.jsii.Kernel.get(this, "physicalConnectionRequirements", software.amazon.jsii.NativeType.forClass(imports.aws.glue.GlueConnectionPhysicalConnectionRequirementsOutputReference.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable java.util.Map<java.lang.String, java.lang.String> getConnectionPropertiesInput() {
        return java.util.Optional.ofNullable((java.util.Map<java.lang.String, java.lang.String>)(software.amazon.jsii.Kernel.get(this, "connectionPropertiesInput", software.amazon.jsii.NativeType.mapOf(software.amazon.jsii.NativeType.forClass(java.lang.String.class))))).map(java.util.Collections::unmodifiableMap).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.glue.GlueConnectionPhysicalConnectionRequirements getPhysicalConnectionRequirementsInput() {
        return software.amazon.jsii.Kernel.get(this, "physicalConnectionRequirementsInput", software.amazon.jsii.NativeType.forClass(imports.aws.glue.GlueConnectionPhysicalConnectionRequirements.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.glue.GlueConnection}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.glue.GlueConnection> {
        /**
        ...
        private final imports.aws.glue.GlueConnectionConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.glue.GlueConnectionConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param catalogId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/glue_connection#catalog_id GlueConnection#catalog_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param connectionProperties Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/glue_connection#connection_properties GlueConnection#connection_properties}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param connectionType Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/glue_connection#connection_type GlueConnection#connection_type}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param description Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/glue_connection#description GlueConnection#description}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/glue_connection#id GlueConnection#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param matchCriteria Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/glue_connection#match_criteria GlueConnection#match_criteria}. This parameter is required.
         */
         ...
         */
        public Builder physicalConnectionRequirements(final imports.aws.glue.GlueConnectionPhysicalConnectionRequirements physicalConnectionRequirements) {
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/glue_connection#tags GlueConnection#tags}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tagsAll Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/glue_connection#tags_all GlueConnection#tags_all}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.glue.GlueConnection}.
         */
        @Override
        public imports.aws.glue.GlueConnection build() {
            return new imports.aws.glue.GlueConnection(
                this.scope,
                this.id,
                this.config.build()
            );
