...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.glue.GlueMlTransformInputRecordTablesOutputReference")
public class GlueMlTransformInputRecordTablesOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected GlueMlTransformInputRecordTablesOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected GlueMlTransformInputRecordTablesOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.glue.GlueMlTransformInputRecordTables value) {
