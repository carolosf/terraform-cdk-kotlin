...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ses.SesActiveReceiptRuleSet")
public class SesActiveReceiptRuleSet extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.ses.SesActiveReceiptRuleSet.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public SesActiveReceiptRuleSet(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.ses.SesActiveReceiptRuleSetConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.ses.SesActiveReceiptRuleSet}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ses.SesActiveReceiptRuleSet> {
        /**
        ...
        private final imports.aws.ses.SesActiveReceiptRuleSetConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.ses.SesActiveReceiptRuleSetConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/ses_active_receipt_rule_set#id SesActiveReceiptRuleSet#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.ses.SesActiveReceiptRuleSet}.
         */
        @Override
        public imports.aws.ses.SesActiveReceiptRuleSet build() {
            return new imports.aws.ses.SesActiveReceiptRuleSet(
                this.scope,
                this.id,
                this.config.build()
            );
