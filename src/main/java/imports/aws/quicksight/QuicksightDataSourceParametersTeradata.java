...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.quicksight.QuicksightDataSourceParametersTeradata")
@software.amazon.jsii.Jsii.Proxy(QuicksightDataSourceParametersTeradata.Jsii$Proxy.class)
public interface QuicksightDataSourceParametersTeradata extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link QuicksightDataSourceParametersTeradata}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link QuicksightDataSourceParametersTeradata}
     */
    public static final class Builder implements software.amazon.jsii.Builder<QuicksightDataSourceParametersTeradata> {
        java.lang.String database;
        java.lang.String host;
        java.lang.Number port;

        /**
         * Sets the value of {@link QuicksightDataSourceParametersTeradata#getDatabase}
        ...
        /**
         * Sets the value of {@link QuicksightDataSourceParametersTeradata#getHost}
        ...
        /**
         * Sets the value of {@link QuicksightDataSourceParametersTeradata#getPort}
         ...
         * @return a new instance of {@link QuicksightDataSourceParametersTeradata}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public QuicksightDataSourceParametersTeradata build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link QuicksightDataSourceParametersTeradata}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements QuicksightDataSourceParametersTeradata {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.quicksight.QuicksightDataSourceParametersTeradata"));
        ...
        public final boolean equals(final Object o) {
            ...
            QuicksightDataSourceParametersTeradata.Jsii$Proxy that = (QuicksightDataSourceParametersTeradata.Jsii$Proxy) o;
