...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.quicksight.QuicksightDataSourceParametersOracle")
@software.amazon.jsii.Jsii.Proxy(QuicksightDataSourceParametersOracle.Jsii$Proxy.class)
public interface QuicksightDataSourceParametersOracle extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link QuicksightDataSourceParametersOracle}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link QuicksightDataSourceParametersOracle}
     */
    public static final class Builder implements software.amazon.jsii.Builder<QuicksightDataSourceParametersOracle> {
        java.lang.String database;
        java.lang.String host;
        java.lang.Number port;

        /**
         * Sets the value of {@link QuicksightDataSourceParametersOracle#getDatabase}
        ...
        /**
         * Sets the value of {@link QuicksightDataSourceParametersOracle#getHost}
        ...
        /**
         * Sets the value of {@link QuicksightDataSourceParametersOracle#getPort}
         ...
         * @return a new instance of {@link QuicksightDataSourceParametersOracle}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public QuicksightDataSourceParametersOracle build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link QuicksightDataSourceParametersOracle}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements QuicksightDataSourceParametersOracle {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.quicksight.QuicksightDataSourceParametersOracle"));
        ...
        public final boolean equals(final Object o) {
            ...
            QuicksightDataSourceParametersOracle.Jsii$Proxy that = (QuicksightDataSourceParametersOracle.Jsii$Proxy) o;
