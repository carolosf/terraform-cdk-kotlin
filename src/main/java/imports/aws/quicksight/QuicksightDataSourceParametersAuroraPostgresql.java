...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.quicksight.QuicksightDataSourceParametersAuroraPostgresql")
@software.amazon.jsii.Jsii.Proxy(QuicksightDataSourceParametersAuroraPostgresql.Jsii$Proxy.class)
public interface QuicksightDataSourceParametersAuroraPostgresql extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link QuicksightDataSourceParametersAuroraPostgresql}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link QuicksightDataSourceParametersAuroraPostgresql}
     */
    public static final class Builder implements software.amazon.jsii.Builder<QuicksightDataSourceParametersAuroraPostgresql> {
        java.lang.String database;
        java.lang.String host;
        java.lang.Number port;

        /**
         * Sets the value of {@link QuicksightDataSourceParametersAuroraPostgresql#getDatabase}
        ...
        /**
         * Sets the value of {@link QuicksightDataSourceParametersAuroraPostgresql#getHost}
        ...
        /**
         * Sets the value of {@link QuicksightDataSourceParametersAuroraPostgresql#getPort}
         ...
         * @return a new instance of {@link QuicksightDataSourceParametersAuroraPostgresql}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public QuicksightDataSourceParametersAuroraPostgresql build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link QuicksightDataSourceParametersAuroraPostgresql}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements QuicksightDataSourceParametersAuroraPostgresql {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.quicksight.QuicksightDataSourceParametersAuroraPostgresql"));
        ...
        public final boolean equals(final Object o) {
            ...
            QuicksightDataSourceParametersAuroraPostgresql.Jsii$Proxy that = (QuicksightDataSourceParametersAuroraPostgresql.Jsii$Proxy) o;
