...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.quicksight.QuicksightGroupMembership")
public class QuicksightGroupMembership extends com.hashicorp.cdktf.TerraformResource {

    protected QuicksightGroupMembership(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected QuicksightGroupMembership(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.quicksight.QuicksightGroupMembership.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public QuicksightGroupMembership(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.quicksight.QuicksightGroupMembershipConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable java.lang.String getMemberNameInput() {
        return software.amazon.jsii.Kernel.get(this, "memberNameInput", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
    ...
    public void setMemberName(final @org.jetbrains.annotations.NotNull java.lang.String value) {
        software.amazon.jsii.Kernel.set(this, "memberName", java.util.Objects.requireNonNull(value, "memberName is required"));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.quicksight.QuicksightGroupMembership}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.quicksight.QuicksightGroupMembership> {
        /**
        ...
        private final imports.aws.quicksight.QuicksightGroupMembershipConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.quicksight.QuicksightGroupMembershipConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param groupName Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/quicksight_group_membership#group_name QuicksightGroupMembership#group_name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param memberName Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/quicksight_group_membership#member_name QuicksightGroupMembership#member_name}. This parameter is required.
         */
        public Builder memberName(final java.lang.String memberName) {
            this.config.memberName(memberName);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param awsAccountId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/quicksight_group_membership#aws_account_id QuicksightGroupMembership#aws_account_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/quicksight_group_membership#id QuicksightGroupMembership#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param namespace Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/quicksight_group_membership#namespace QuicksightGroupMembership#namespace}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.quicksight.QuicksightGroupMembership}.
         */
        @Override
        public imports.aws.quicksight.QuicksightGroupMembership build() {
            return new imports.aws.quicksight.QuicksightGroupMembership(
                this.scope,
                this.id,
                this.config.build()
            );
