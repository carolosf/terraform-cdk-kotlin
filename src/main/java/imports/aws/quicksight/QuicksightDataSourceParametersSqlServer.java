...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.quicksight.QuicksightDataSourceParametersSqlServer")
@software.amazon.jsii.Jsii.Proxy(QuicksightDataSourceParametersSqlServer.Jsii$Proxy.class)
public interface QuicksightDataSourceParametersSqlServer extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link QuicksightDataSourceParametersSqlServer}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link QuicksightDataSourceParametersSqlServer}
     */
    public static final class Builder implements software.amazon.jsii.Builder<QuicksightDataSourceParametersSqlServer> {
        java.lang.String database;
        java.lang.String host;
        java.lang.Number port;

        /**
         * Sets the value of {@link QuicksightDataSourceParametersSqlServer#getDatabase}
        ...
        /**
         * Sets the value of {@link QuicksightDataSourceParametersSqlServer#getHost}
        ...
        /**
         * Sets the value of {@link QuicksightDataSourceParametersSqlServer#getPort}
         ...
         * @return a new instance of {@link QuicksightDataSourceParametersSqlServer}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public QuicksightDataSourceParametersSqlServer build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link QuicksightDataSourceParametersSqlServer}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements QuicksightDataSourceParametersSqlServer {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.quicksight.QuicksightDataSourceParametersSqlServer"));
        ...
        public final boolean equals(final Object o) {
            ...
            QuicksightDataSourceParametersSqlServer.Jsii$Proxy that = (QuicksightDataSourceParametersSqlServer.Jsii$Proxy) o;
