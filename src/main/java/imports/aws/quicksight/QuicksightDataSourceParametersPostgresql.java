...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:19.980Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.quicksight.QuicksightDataSourceParametersPostgresql")
@software.amazon.jsii.Jsii.Proxy(QuicksightDataSourceParametersPostgresql.Jsii$Proxy.class)
public interface QuicksightDataSourceParametersPostgresql extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link QuicksightDataSourceParametersPostgresql}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link QuicksightDataSourceParametersPostgresql}
     */
    public static final class Builder implements software.amazon.jsii.Builder<QuicksightDataSourceParametersPostgresql> {
        java.lang.String database;
        java.lang.String host;
        java.lang.Number port;

        /**
         * Sets the value of {@link QuicksightDataSourceParametersPostgresql#getDatabase}
        ...
        /**
         * Sets the value of {@link QuicksightDataSourceParametersPostgresql#getHost}
        ...
        /**
         * Sets the value of {@link QuicksightDataSourceParametersPostgresql#getPort}
         ...
         * @return a new instance of {@link QuicksightDataSourceParametersPostgresql}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public QuicksightDataSourceParametersPostgresql build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link QuicksightDataSourceParametersPostgresql}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements QuicksightDataSourceParametersPostgresql {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.quicksight.QuicksightDataSourceParametersPostgresql"));
        ...
        public final boolean equals(final Object o) {
            ...
            QuicksightDataSourceParametersPostgresql.Jsii$Proxy that = (QuicksightDataSourceParametersPostgresql.Jsii$Proxy) o;
