...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.quicksight.QuicksightDataSourceParametersMariaDb")
@software.amazon.jsii.Jsii.Proxy(QuicksightDataSourceParametersMariaDb.Jsii$Proxy.class)
public interface QuicksightDataSourceParametersMariaDb extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link QuicksightDataSourceParametersMariaDb}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link QuicksightDataSourceParametersMariaDb}
     */
    public static final class Builder implements software.amazon.jsii.Builder<QuicksightDataSourceParametersMariaDb> {
        java.lang.String database;
        java.lang.String host;
        java.lang.Number port;

        /**
         * Sets the value of {@link QuicksightDataSourceParametersMariaDb#getDatabase}
        ...
        /**
         * Sets the value of {@link QuicksightDataSourceParametersMariaDb#getHost}
        ...
        /**
         * Sets the value of {@link QuicksightDataSourceParametersMariaDb#getPort}
         ...
         * @return a new instance of {@link QuicksightDataSourceParametersMariaDb}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public QuicksightDataSourceParametersMariaDb build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link QuicksightDataSourceParametersMariaDb}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements QuicksightDataSourceParametersMariaDb {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.quicksight.QuicksightDataSourceParametersMariaDb"));
        ...
        public final boolean equals(final Object o) {
            ...
            QuicksightDataSourceParametersMariaDb.Jsii$Proxy that = (QuicksightDataSourceParametersMariaDb.Jsii$Proxy) o;
