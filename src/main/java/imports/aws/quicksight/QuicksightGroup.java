...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.quicksight.QuicksightGroup")
public class QuicksightGroup extends com.hashicorp.cdktf.TerraformResource {

    protected QuicksightGroup(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected QuicksightGroup(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.quicksight.QuicksightGroup.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public QuicksightGroup(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.quicksight.QuicksightGroupConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.quicksight.QuicksightGroup}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.quicksight.QuicksightGroup> {
        /**
        ...
        private final imports.aws.quicksight.QuicksightGroupConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.quicksight.QuicksightGroupConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param groupName Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/quicksight_group#group_name QuicksightGroup#group_name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param awsAccountId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/quicksight_group#aws_account_id QuicksightGroup#aws_account_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param description Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/quicksight_group#description QuicksightGroup#description}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/quicksight_group#id QuicksightGroup#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param namespace Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/quicksight_group#namespace QuicksightGroup#namespace}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.quicksight.QuicksightGroup}.
         */
        @Override
        public imports.aws.quicksight.QuicksightGroup build() {
            return new imports.aws.quicksight.QuicksightGroup(
                this.scope,
                this.id,
                this.config.build()
            );
