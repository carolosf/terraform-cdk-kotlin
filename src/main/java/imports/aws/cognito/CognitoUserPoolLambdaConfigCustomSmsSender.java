...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:19.350Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.cognito.CognitoUserPoolLambdaConfigCustomSmsSender")
@software.amazon.jsii.Jsii.Proxy(CognitoUserPoolLambdaConfigCustomSmsSender.Jsii$Proxy.class)
public interface CognitoUserPoolLambdaConfigCustomSmsSender extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link CognitoUserPoolLambdaConfigCustomSmsSender}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link CognitoUserPoolLambdaConfigCustomSmsSender}
     */
    public static final class Builder implements software.amazon.jsii.Builder<CognitoUserPoolLambdaConfigCustomSmsSender> {
        java.lang.String lambdaArn;
        java.lang.String lambdaVersion;

        /**
         * Sets the value of {@link CognitoUserPoolLambdaConfigCustomSmsSender#getLambdaArn}
        ...
        /**
         * Sets the value of {@link CognitoUserPoolLambdaConfigCustomSmsSender#getLambdaVersion}
         ...
         * @return a new instance of {@link CognitoUserPoolLambdaConfigCustomSmsSender}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public CognitoUserPoolLambdaConfigCustomSmsSender build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link CognitoUserPoolLambdaConfigCustomSmsSender}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CognitoUserPoolLambdaConfigCustomSmsSender {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.cognito.CognitoUserPoolLambdaConfigCustomSmsSender"));
        ...
        public final boolean equals(final Object o) {
            ...
            CognitoUserPoolLambdaConfigCustomSmsSender.Jsii$Proxy that = (CognitoUserPoolLambdaConfigCustomSmsSender.Jsii$Proxy) o;
