...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.cognito.DataAwsCognitoUserPoolClientAnalyticsConfigurationList")
public class DataAwsCognitoUserPoolClientAnalyticsConfigurationList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsCognitoUserPoolClientAnalyticsConfigurationList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsCognitoUserPoolClientAnalyticsConfigurationList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.cognito.DataAwsCognitoUserPoolClientAnalyticsConfigurationOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.cognito.DataAwsCognitoUserPoolClientAnalyticsConfigurationOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
