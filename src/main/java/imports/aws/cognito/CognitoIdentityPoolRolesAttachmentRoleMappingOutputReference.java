...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.cognito.CognitoIdentityPoolRolesAttachmentRoleMappingOutputReference")
public class CognitoIdentityPoolRolesAttachmentRoleMappingOutputReference extends com.hashicorp.cdktf.ComplexObject {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.cognito.CognitoIdentityPoolRolesAttachmentRoleMappingMappingRuleList getMappingRule() {
        return software.amazon.jsii.Kernel.get(this, "mappingRule", software.amazon.jsii.NativeType.forClass(imports.aws.cognito.CognitoIdentityPoolRolesAttachmentRoleMappingMappingRuleList.class));
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.cognito.CognitoIdentityPoolRolesAttachmentRoleMapping value) {
