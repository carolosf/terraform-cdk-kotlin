...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.cloudhsm.DataAwsCloudhsmV2ClusterClusterCertificatesList")
public class DataAwsCloudhsmV2ClusterClusterCertificatesList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsCloudhsmV2ClusterClusterCertificatesList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsCloudhsmV2ClusterClusterCertificatesList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public DataAwsCloudhsmV2ClusterClusterCertificatesList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.cloudhsm.DataAwsCloudhsmV2ClusterClusterCertificatesOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.cloudhsm.DataAwsCloudhsmV2ClusterClusterCertificatesOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
