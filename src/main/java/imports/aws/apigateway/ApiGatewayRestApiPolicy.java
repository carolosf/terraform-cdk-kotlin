...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.apigateway.ApiGatewayRestApiPolicy")
public class ApiGatewayRestApiPolicy extends com.hashicorp.cdktf.TerraformResource {

    protected ApiGatewayRestApiPolicy(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected ApiGatewayRestApiPolicy(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.apigateway.ApiGatewayRestApiPolicy.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public ApiGatewayRestApiPolicy(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.apigateway.ApiGatewayRestApiPolicyConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.apigateway.ApiGatewayRestApiPolicy}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.apigateway.ApiGatewayRestApiPolicy> {
        /**
        ...
        private final imports.aws.apigateway.ApiGatewayRestApiPolicyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.apigateway.ApiGatewayRestApiPolicyConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/api_gateway_rest_api_policy#id ApiGatewayRestApiPolicy#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.apigateway.ApiGatewayRestApiPolicy}.
         */
        @Override
        public imports.aws.apigateway.ApiGatewayRestApiPolicy build() {
            return new imports.aws.apigateway.ApiGatewayRestApiPolicy(
                this.scope,
                this.id,
                this.config.build()
            );
