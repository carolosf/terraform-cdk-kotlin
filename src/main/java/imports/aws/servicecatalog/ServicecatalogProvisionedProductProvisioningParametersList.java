...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.servicecatalog.ServicecatalogProvisionedProductProvisioningParametersList")
public class ServicecatalogProvisionedProductProvisioningParametersList extends com.hashicorp.cdktf.ComplexList {

    protected ServicecatalogProvisionedProductProvisioningParametersList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected ServicecatalogProvisionedProductProvisioningParametersList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public ServicecatalogProvisionedProductProvisioningParametersList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.servicecatalog.ServicecatalogProvisionedProductProvisioningParametersOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.servicecatalog.ServicecatalogProvisionedProductProvisioningParametersOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.aws.servicecatalog.ServicecatalogProvisionedProductProvisioningParameters> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
