...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.servicecatalog.ServicecatalogPrincipalPortfolioAssociation")
public class ServicecatalogPrincipalPortfolioAssociation extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.servicecatalog.ServicecatalogPrincipalPortfolioAssociation.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public ServicecatalogPrincipalPortfolioAssociation(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.servicecatalog.ServicecatalogPrincipalPortfolioAssociationConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.servicecatalog.ServicecatalogPrincipalPortfolioAssociation}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.servicecatalog.ServicecatalogPrincipalPortfolioAssociation> {
        /**
        ...
        private final imports.aws.servicecatalog.ServicecatalogPrincipalPortfolioAssociationConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.servicecatalog.ServicecatalogPrincipalPortfolioAssociationConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param acceptLanguage Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/servicecatalog_principal_portfolio_association#accept_language ServicecatalogPrincipalPortfolioAssociation#accept_language}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/servicecatalog_principal_portfolio_association#id ServicecatalogPrincipalPortfolioAssociation#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param principalType Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/servicecatalog_principal_portfolio_association#principal_type ServicecatalogPrincipalPortfolioAssociation#principal_type}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.servicecatalog.ServicecatalogPrincipalPortfolioAssociation}.
         */
        @Override
        public imports.aws.servicecatalog.ServicecatalogPrincipalPortfolioAssociation build() {
            return new imports.aws.servicecatalog.ServicecatalogPrincipalPortfolioAssociation(
                this.scope,
                this.id,
                this.config.build()
            );
