...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.servicecatalog.DataAwsServicecatalogConstraint")
public class DataAwsServicecatalogConstraint extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsServicecatalogConstraint(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsServicecatalogConstraint(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.servicecatalog.DataAwsServicecatalogConstraint.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsServicecatalogConstraint(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.servicecatalog.DataAwsServicecatalogConstraintConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.servicecatalog.DataAwsServicecatalogConstraint}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.servicecatalog.DataAwsServicecatalogConstraint> {
        /**
        ...
        private final imports.aws.servicecatalog.DataAwsServicecatalogConstraintConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.servicecatalog.DataAwsServicecatalogConstraintConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param acceptLanguage Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/servicecatalog_constraint#accept_language DataAwsServicecatalogConstraint#accept_language}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param description Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/servicecatalog_constraint#description DataAwsServicecatalogConstraint#description}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.servicecatalog.DataAwsServicecatalogConstraint}.
         */
        @Override
        public imports.aws.servicecatalog.DataAwsServicecatalogConstraint build() {
            return new imports.aws.servicecatalog.DataAwsServicecatalogConstraint(
                this.scope,
                this.id,
                this.config.build()
            );
