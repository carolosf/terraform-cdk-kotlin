...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.servicecatalog.DataAwsServicecatalogLaunchPathsSummariesConstraintSummariesList")
public class DataAwsServicecatalogLaunchPathsSummariesConstraintSummariesList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsServicecatalogLaunchPathsSummariesConstraintSummariesList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsServicecatalogLaunchPathsSummariesConstraintSummariesList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.servicecatalog.DataAwsServicecatalogLaunchPathsSummariesConstraintSummariesOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.servicecatalog.DataAwsServicecatalogLaunchPathsSummariesConstraintSummariesOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
