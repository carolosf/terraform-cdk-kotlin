...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.servicecatalog.DataAwsServicecatalogProduct")
public class DataAwsServicecatalogProduct extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsServicecatalogProduct(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsServicecatalogProduct(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.servicecatalog.DataAwsServicecatalogProduct.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsServicecatalogProduct(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.servicecatalog.DataAwsServicecatalogProductConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.servicecatalog.DataAwsServicecatalogProduct}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.servicecatalog.DataAwsServicecatalogProduct> {
        /**
        ...
        private final imports.aws.servicecatalog.DataAwsServicecatalogProductConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.servicecatalog.DataAwsServicecatalogProductConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param acceptLanguage Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/servicecatalog_product#accept_language DataAwsServicecatalogProduct#accept_language}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/servicecatalog_product#tags DataAwsServicecatalogProduct#tags}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.servicecatalog.DataAwsServicecatalogProduct}.
         */
        @Override
        public imports.aws.servicecatalog.DataAwsServicecatalogProduct build() {
            return new imports.aws.servicecatalog.DataAwsServicecatalogProduct(
                this.scope,
                this.id,
                this.config.build()
            );
