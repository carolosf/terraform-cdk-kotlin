...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.codeartifact.CodeartifactDomain")
public class CodeartifactDomain extends com.hashicorp.cdktf.TerraformResource {

    protected CodeartifactDomain(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CodeartifactDomain(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.codeartifact.CodeartifactDomain.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public CodeartifactDomain(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.codeartifact.CodeartifactDomainConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.Number getAssetSizeBytes() {
        return software.amazon.jsii.Kernel.get(this, "assetSizeBytes", software.amazon.jsii.NativeType.forClass(java.lang.Number.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull java.lang.Number getRepositoryCount() {
        return software.amazon.jsii.Kernel.get(this, "repositoryCount", software.amazon.jsii.NativeType.forClass(java.lang.Number.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.codeartifact.CodeartifactDomain}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.codeartifact.CodeartifactDomain> {
        /**
        ...
        private final imports.aws.codeartifact.CodeartifactDomainConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.codeartifact.CodeartifactDomainConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param domain Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/codeartifact_domain#domain CodeartifactDomain#domain}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param encryptionKey Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/codeartifact_domain#encryption_key CodeartifactDomain#encryption_key}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/codeartifact_domain#id CodeartifactDomain#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/codeartifact_domain#tags CodeartifactDomain#tags}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tagsAll Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/codeartifact_domain#tags_all CodeartifactDomain#tags_all}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.codeartifact.CodeartifactDomain}.
         */
        @Override
        public imports.aws.codeartifact.CodeartifactDomain build() {
            return new imports.aws.codeartifact.CodeartifactDomain(
                this.scope,
                this.id,
                this.config.build()
            );
