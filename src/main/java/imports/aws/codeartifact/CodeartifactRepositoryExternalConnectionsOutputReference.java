...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.codeartifact.CodeartifactRepositoryExternalConnectionsOutputReference")
public class CodeartifactRepositoryExternalConnectionsOutputReference extends com.hashicorp.cdktf.ComplexObject {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.codeartifact.CodeartifactRepositoryExternalConnections getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.codeartifact.CodeartifactRepositoryExternalConnections.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.codeartifact.CodeartifactRepositoryExternalConnections value) {
