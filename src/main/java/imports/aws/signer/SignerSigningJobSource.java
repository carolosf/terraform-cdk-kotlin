...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.signer.SignerSigningJobSource")
...
public interface SignerSigningJobSource extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull imports.aws.signer.SignerSigningJobSourceS3 getS3();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<SignerSigningJobSource> {
        imports.aws.signer.SignerSigningJobSourceS3 s3;
         ...
         * @return {@code this}
         */
        public Builder s3(imports.aws.signer.SignerSigningJobSourceS3 s3) {
            this.s3 = s3;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SignerSigningJobSource {
        private final imports.aws.signer.SignerSigningJobSourceS3 s3;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.s3 = software.amazon.jsii.Kernel.get(this, "s3", software.amazon.jsii.NativeType.forClass(imports.aws.signer.SignerSigningJobSourceS3.class));
        }
        ...
        @Override
        public final imports.aws.signer.SignerSigningJobSourceS3 getS3() {
            return this.s3;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.signer.SignerSigningJobSource"));
