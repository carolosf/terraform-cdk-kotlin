...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.sagemaker.SagemakerFeatureGroupOnlineStoreConfigSecurityConfigOutputReference")
public class SagemakerFeatureGroupOnlineStoreConfigSecurityConfigOutputReference extends com.hashicorp.cdktf.ComplexObject {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.sagemaker.SagemakerFeatureGroupOnlineStoreConfigSecurityConfig getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.sagemaker.SagemakerFeatureGroupOnlineStoreConfigSecurityConfig.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.sagemaker.SagemakerFeatureGroupOnlineStoreConfigSecurityConfig value) {
