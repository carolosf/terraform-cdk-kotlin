...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.sagemaker.SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsCustomImage")
@software.amazon.jsii.Jsii.Proxy(SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsCustomImage.Jsii$Proxy.class)
public interface SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsCustomImage extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsCustomImage}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsCustomImage}
     */
    public static final class Builder implements software.amazon.jsii.Builder<SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsCustomImage> {
        java.lang.String appImageConfigName;
        java.lang.String imageName;
        java.lang.Number imageVersionNumber;

        /**
         * Sets the value of {@link SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsCustomImage#getAppImageConfigName}
         * @param appImageConfigName Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/sagemaker_domain#app_image_config_name SagemakerDomain#app_image_config_name}. This parameter is required.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsCustomImage#getImageName}
         * @param imageName Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/sagemaker_domain#image_name SagemakerDomain#image_name}. This parameter is required.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsCustomImage#getImageVersionNumber}
         * @param imageVersionNumber Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/sagemaker_domain#image_version_number SagemakerDomain#image_version_number}.
         * @return {@code this}
         */
         ...
         * @return a new instance of {@link SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsCustomImage}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsCustomImage build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsCustomImage}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsCustomImage {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.sagemaker.SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsCustomImage"));
        ...
        public final boolean equals(final Object o) {
            ...
            SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsCustomImage.Jsii$Proxy that = (SagemakerDomainDefaultUserSettingsKernelGatewayAppSettingsCustomImage.Jsii$Proxy) o;
