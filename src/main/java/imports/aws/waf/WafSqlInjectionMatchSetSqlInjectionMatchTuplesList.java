...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.waf.WafSqlInjectionMatchSetSqlInjectionMatchTuplesList")
public class WafSqlInjectionMatchSetSqlInjectionMatchTuplesList extends com.hashicorp.cdktf.ComplexList {

    protected WafSqlInjectionMatchSetSqlInjectionMatchTuplesList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected WafSqlInjectionMatchSetSqlInjectionMatchTuplesList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public WafSqlInjectionMatchSetSqlInjectionMatchTuplesList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.waf.WafSqlInjectionMatchSetSqlInjectionMatchTuplesOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.waf.WafSqlInjectionMatchSetSqlInjectionMatchTuplesOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.aws.waf.WafSqlInjectionMatchSetSqlInjectionMatchTuples> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
