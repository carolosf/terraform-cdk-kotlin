...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.waf.WafRegexPatternSet")
public class WafRegexPatternSet extends com.hashicorp.cdktf.TerraformResource {

    protected WafRegexPatternSet(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected WafRegexPatternSet(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.waf.WafRegexPatternSet.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public WafRegexPatternSet(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.waf.WafRegexPatternSetConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.waf.WafRegexPatternSet}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.waf.WafRegexPatternSet> {
        /**
        ...
        private final imports.aws.waf.WafRegexPatternSetConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.waf.WafRegexPatternSetConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/waf_regex_pattern_set#id WafRegexPatternSet#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param regexPatternStrings Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/waf_regex_pattern_set#regex_pattern_strings WafRegexPatternSet#regex_pattern_strings}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.waf.WafRegexPatternSet}.
         */
        @Override
        public imports.aws.waf.WafRegexPatternSet build() {
            return new imports.aws.waf.WafRegexPatternSet(
                this.scope,
                this.id,
                this.config.build()
            );
