...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.elastictranscoder.ElastictranscoderPipelineContentConfigPermissions")
@software.amazon.jsii.Jsii.Proxy(ElastictranscoderPipelineContentConfigPermissions.Jsii$Proxy.class)
public interface ElastictranscoderPipelineContentConfigPermissions extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link ElastictranscoderPipelineContentConfigPermissions}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ElastictranscoderPipelineContentConfigPermissions}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ElastictranscoderPipelineContentConfigPermissions> {
        java.util.List<java.lang.String> access;
        java.lang.String grantee;
        java.lang.String granteeType;

        /**
         * Sets the value of {@link ElastictranscoderPipelineContentConfigPermissions#getAccess}
        ...
        /**
         * Sets the value of {@link ElastictranscoderPipelineContentConfigPermissions#getGrantee}
        ...
        /**
         * Sets the value of {@link ElastictranscoderPipelineContentConfigPermissions#getGranteeType}
         ...
         * @return a new instance of {@link ElastictranscoderPipelineContentConfigPermissions}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ElastictranscoderPipelineContentConfigPermissions build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ElastictranscoderPipelineContentConfigPermissions}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ElastictranscoderPipelineContentConfigPermissions {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.elastictranscoder.ElastictranscoderPipelineContentConfigPermissions"));
        ...
        public final boolean equals(final Object o) {
            ...
            ElastictranscoderPipelineContentConfigPermissions.Jsii$Proxy that = (ElastictranscoderPipelineContentConfigPermissions.Jsii$Proxy) o;
