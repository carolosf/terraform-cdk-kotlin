...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.backup.BackupVaultNotifications")
public class BackupVaultNotifications extends com.hashicorp.cdktf.TerraformResource {

    protected BackupVaultNotifications(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected BackupVaultNotifications(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.backup.BackupVaultNotifications.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public BackupVaultNotifications(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.backup.BackupVaultNotificationsConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable java.util.List<java.lang.String> getBackupVaultEventsInput() {
        return java.util.Optional.ofNullable((java.util.List<java.lang.String>)(software.amazon.jsii.Kernel.get(this, "backupVaultEventsInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(java.lang.String.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<java.lang.String> getBackupVaultEvents() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "backupVaultEvents", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(java.lang.String.class))));
    }

    public void setBackupVaultEvents(final @org.jetbrains.annotations.NotNull java.util.List<java.lang.String> value) {
        software.amazon.jsii.Kernel.set(this, "backupVaultEvents", java.util.Objects.requireNonNull(value, "backupVaultEvents is required"));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.backup.BackupVaultNotifications}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.backup.BackupVaultNotifications> {
        /**
        ...
        private final imports.aws.backup.BackupVaultNotificationsConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.backup.BackupVaultNotificationsConfig.Builder();
        }
         ...
         */
        public Builder backupVaultEvents(final java.util.List<java.lang.String> backupVaultEvents) {
            this.config.backupVaultEvents(backupVaultEvents);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/backup_vault_notifications#id BackupVaultNotifications#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.backup.BackupVaultNotifications}.
         */
        @Override
        public imports.aws.backup.BackupVaultNotifications build() {
            return new imports.aws.backup.BackupVaultNotifications(
                this.scope,
                this.id,
                this.config.build()
            );
