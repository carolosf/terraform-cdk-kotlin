...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.backup.BackupVaultPolicy")
public class BackupVaultPolicy extends com.hashicorp.cdktf.TerraformResource {

    protected BackupVaultPolicy(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected BackupVaultPolicy(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.backup.BackupVaultPolicy.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public BackupVaultPolicy(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.backup.BackupVaultPolicyConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.backup.BackupVaultPolicy}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.backup.BackupVaultPolicy> {
        /**
        ...
        private final imports.aws.backup.BackupVaultPolicyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.backup.BackupVaultPolicyConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/backup_vault_policy#id BackupVaultPolicy#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.backup.BackupVaultPolicy}.
         */
        @Override
        public imports.aws.backup.BackupVaultPolicy build() {
            return new imports.aws.backup.BackupVaultPolicy(
                this.scope,
                this.id,
                this.config.build()
            );
