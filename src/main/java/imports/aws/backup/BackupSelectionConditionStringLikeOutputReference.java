...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.backup.BackupSelectionConditionStringLikeOutputReference")
public class BackupSelectionConditionStringLikeOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected BackupSelectionConditionStringLikeOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected BackupSelectionConditionStringLikeOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.backup.BackupSelectionConditionStringLike value) {
