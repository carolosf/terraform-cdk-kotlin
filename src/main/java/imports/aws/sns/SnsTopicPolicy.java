...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.sns.SnsTopicPolicy")
public class SnsTopicPolicy extends com.hashicorp.cdktf.TerraformResource {

    protected SnsTopicPolicy(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected SnsTopicPolicy(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.sns.SnsTopicPolicy.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public SnsTopicPolicy(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.sns.SnsTopicPolicyConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.sns.SnsTopicPolicy}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.sns.SnsTopicPolicy> {
        /**
        ...
        private final imports.aws.sns.SnsTopicPolicyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.sns.SnsTopicPolicyConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/sns_topic_policy#id SnsTopicPolicy#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.sns.SnsTopicPolicy}.
         */
        @Override
        public imports.aws.sns.SnsTopicPolicy build() {
            return new imports.aws.sns.SnsTopicPolicy(
                this.scope,
                this.id,
                this.config.build()
            );
