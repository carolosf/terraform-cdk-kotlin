...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.organizations.DataAwsOrganizationsDelegatedServicesDelegatedServicesList")
public class DataAwsOrganizationsDelegatedServicesDelegatedServicesList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsOrganizationsDelegatedServicesDelegatedServicesList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsOrganizationsDelegatedServicesDelegatedServicesList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.organizations.DataAwsOrganizationsDelegatedServicesDelegatedServicesOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.organizations.DataAwsOrganizationsDelegatedServicesDelegatedServicesOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
