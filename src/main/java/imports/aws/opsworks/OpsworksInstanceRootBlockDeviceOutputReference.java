...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.opsworks.OpsworksInstanceRootBlockDeviceOutputReference")
public class OpsworksInstanceRootBlockDeviceOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected OpsworksInstanceRootBlockDeviceOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected OpsworksInstanceRootBlockDeviceOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.opsworks.OpsworksInstanceRootBlockDevice value) {
