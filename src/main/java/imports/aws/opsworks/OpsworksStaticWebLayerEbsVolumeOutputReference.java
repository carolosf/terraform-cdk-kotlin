...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.opsworks.OpsworksStaticWebLayerEbsVolumeOutputReference")
public class OpsworksStaticWebLayerEbsVolumeOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected OpsworksStaticWebLayerEbsVolumeOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected OpsworksStaticWebLayerEbsVolumeOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.opsworks.OpsworksStaticWebLayerEbsVolume value) {
