...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.opsworks.OpsworksNodejsAppLayerEbsVolumeOutputReference")
public class OpsworksNodejsAppLayerEbsVolumeOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected OpsworksNodejsAppLayerEbsVolumeOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected OpsworksNodejsAppLayerEbsVolumeOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.opsworks.OpsworksNodejsAppLayerEbsVolume value) {
