...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.opsworks.OpsworksGangliaLayerEbsVolumeOutputReference")
public class OpsworksGangliaLayerEbsVolumeOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected OpsworksGangliaLayerEbsVolumeOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected OpsworksGangliaLayerEbsVolumeOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.opsworks.OpsworksGangliaLayerEbsVolume value) {
