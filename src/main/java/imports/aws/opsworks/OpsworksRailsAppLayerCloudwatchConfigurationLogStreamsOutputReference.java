...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.opsworks.OpsworksRailsAppLayerCloudwatchConfigurationLogStreamsOutputReference")
public class OpsworksRailsAppLayerCloudwatchConfigurationLogStreamsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected OpsworksRailsAppLayerCloudwatchConfigurationLogStreamsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected OpsworksRailsAppLayerCloudwatchConfigurationLogStreamsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.opsworks.OpsworksRailsAppLayerCloudwatchConfigurationLogStreams value) {
