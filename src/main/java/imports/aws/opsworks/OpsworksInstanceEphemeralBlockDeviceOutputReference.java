...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.opsworks.OpsworksInstanceEphemeralBlockDeviceOutputReference")
public class OpsworksInstanceEphemeralBlockDeviceOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected OpsworksInstanceEphemeralBlockDeviceOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected OpsworksInstanceEphemeralBlockDeviceOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.opsworks.OpsworksInstanceEphemeralBlockDevice value) {
