...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.codebuild.CodebuildProjectSecondarySourceVersionOutputReference")
public class CodebuildProjectSecondarySourceVersionOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected CodebuildProjectSecondarySourceVersionOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CodebuildProjectSecondarySourceVersionOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.codebuild.CodebuildProjectSecondarySourceVersion value) {
