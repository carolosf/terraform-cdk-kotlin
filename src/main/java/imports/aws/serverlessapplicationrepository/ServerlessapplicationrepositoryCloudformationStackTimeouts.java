...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.serverlessapplicationrepository.ServerlessapplicationrepositoryCloudformationStackTimeouts")
@software.amazon.jsii.Jsii.Proxy(ServerlessapplicationrepositoryCloudformationStackTimeouts.Jsii$Proxy.class)
public interface ServerlessapplicationrepositoryCloudformationStackTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link ServerlessapplicationrepositoryCloudformationStackTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ServerlessapplicationrepositoryCloudformationStackTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ServerlessapplicationrepositoryCloudformationStackTimeouts> {
        java.lang.String create;
        java.lang.String delete;
        java.lang.String update;

        /**
         * Sets the value of {@link ServerlessapplicationrepositoryCloudformationStackTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link ServerlessapplicationrepositoryCloudformationStackTimeouts#getDelete}
        ...
        /**
         * Sets the value of {@link ServerlessapplicationrepositoryCloudformationStackTimeouts#getUpdate}
         ...
         * @return a new instance of {@link ServerlessapplicationrepositoryCloudformationStackTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ServerlessapplicationrepositoryCloudformationStackTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ServerlessapplicationrepositoryCloudformationStackTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ServerlessapplicationrepositoryCloudformationStackTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.serverlessapplicationrepository.ServerlessapplicationrepositoryCloudformationStackTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            ServerlessapplicationrepositoryCloudformationStackTimeouts.Jsii$Proxy that = (ServerlessapplicationrepositoryCloudformationStackTimeouts.Jsii$Proxy) o;
