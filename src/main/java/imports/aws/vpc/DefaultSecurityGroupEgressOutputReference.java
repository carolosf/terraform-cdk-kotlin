...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.DefaultSecurityGroupEgressOutputReference")
public class DefaultSecurityGroupEgressOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DefaultSecurityGroupEgressOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DefaultSecurityGroupEgressOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.vpc.DefaultSecurityGroupEgress value) {
