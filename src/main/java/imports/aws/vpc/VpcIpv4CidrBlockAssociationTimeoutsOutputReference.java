...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.VpcIpv4CidrBlockAssociationTimeoutsOutputReference")
public class VpcIpv4CidrBlockAssociationTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected VpcIpv4CidrBlockAssociationTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected VpcIpv4CidrBlockAssociationTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public VpcIpv4CidrBlockAssociationTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.vpc.VpcIpv4CidrBlockAssociationTimeouts value) {
