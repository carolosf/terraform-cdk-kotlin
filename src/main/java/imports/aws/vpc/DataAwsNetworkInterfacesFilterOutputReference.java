...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.DataAwsNetworkInterfacesFilterOutputReference")
public class DataAwsNetworkInterfacesFilterOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsNetworkInterfacesFilterOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsNetworkInterfacesFilterOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.vpc.DataAwsNetworkInterfacesFilter value) {
