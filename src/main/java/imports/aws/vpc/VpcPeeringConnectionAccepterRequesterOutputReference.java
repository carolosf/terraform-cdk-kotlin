...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.VpcPeeringConnectionAccepterRequesterOutputReference")
public class VpcPeeringConnectionAccepterRequesterOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected VpcPeeringConnectionAccepterRequesterOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected VpcPeeringConnectionAccepterRequesterOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public VpcPeeringConnectionAccepterRequesterOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.vpc.VpcPeeringConnectionAccepterRequester getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.vpc.VpcPeeringConnectionAccepterRequester.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.vpc.VpcPeeringConnectionAccepterRequester value) {
