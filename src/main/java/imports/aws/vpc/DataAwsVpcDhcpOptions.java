...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.DataAwsVpcDhcpOptions")
public class DataAwsVpcDhcpOptions extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsVpcDhcpOptions(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsVpcDhcpOptions(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.vpc.DataAwsVpcDhcpOptions.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     * @param config
     */
    public DataAwsVpcDhcpOptions(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.vpc.DataAwsVpcDhcpOptionsConfig config) {
     ...
     * @param id The scoped construct ID. This parameter is required.
     */
    public DataAwsVpcDhcpOptions(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.vpc.DataAwsVpcDhcpOptionsFilterList getFilter() {
        return software.amazon.jsii.Kernel.get(this, "filter", software.amazon.jsii.NativeType.forClass(imports.aws.vpc.DataAwsVpcDhcpOptionsFilterList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.vpc.DataAwsVpcDhcpOptions}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.vpc.DataAwsVpcDhcpOptions> {
        /**
        ...
        private imports.aws.vpc.DataAwsVpcDhcpOptionsConfig.Builder config;
         ...
         * <p>
         * @return {@code this}
         * @param dhcpOptionsId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/vpc_dhcp_options#dhcp_options_id DataAwsVpcDhcpOptions#dhcp_options_id}. This parameter is required.
         */
         ...
         * @param filter filter block. This parameter is required.
         */
        public Builder filter(final java.util.List<? extends imports.aws.vpc.DataAwsVpcDhcpOptionsFilter> filter) {
            this.config().filter(filter);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/vpc_dhcp_options#id DataAwsVpcDhcpOptions#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/vpc_dhcp_options#tags DataAwsVpcDhcpOptions#tags}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.vpc.DataAwsVpcDhcpOptions}.
         */
        @Override
        public imports.aws.vpc.DataAwsVpcDhcpOptions build() {
            return new imports.aws.vpc.DataAwsVpcDhcpOptions(
                this.scope,
                this.id,
        ...
        private imports.aws.vpc.DataAwsVpcDhcpOptionsConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.vpc.DataAwsVpcDhcpOptionsConfig.Builder();
            }
            return this.config;
        }
    }
