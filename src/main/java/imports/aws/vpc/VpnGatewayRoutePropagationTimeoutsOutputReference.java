...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.VpnGatewayRoutePropagationTimeoutsOutputReference")
public class VpnGatewayRoutePropagationTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected VpnGatewayRoutePropagationTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected VpnGatewayRoutePropagationTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public VpnGatewayRoutePropagationTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.vpc.VpnGatewayRoutePropagationTimeouts value) {
