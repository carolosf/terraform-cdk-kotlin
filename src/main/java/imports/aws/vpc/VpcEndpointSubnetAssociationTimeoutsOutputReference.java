...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.VpcEndpointSubnetAssociationTimeoutsOutputReference")
public class VpcEndpointSubnetAssociationTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected VpcEndpointSubnetAssociationTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected VpcEndpointSubnetAssociationTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public VpcEndpointSubnetAssociationTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.vpc.VpcEndpointSubnetAssociationTimeouts value) {
