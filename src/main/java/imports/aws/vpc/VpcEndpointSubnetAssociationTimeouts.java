...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.VpcEndpointSubnetAssociationTimeouts")
@software.amazon.jsii.Jsii.Proxy(VpcEndpointSubnetAssociationTimeouts.Jsii$Proxy.class)
public interface VpcEndpointSubnetAssociationTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link VpcEndpointSubnetAssociationTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link VpcEndpointSubnetAssociationTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<VpcEndpointSubnetAssociationTimeouts> {
        java.lang.String create;
        java.lang.String delete;

        /**
         * Sets the value of {@link VpcEndpointSubnetAssociationTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link VpcEndpointSubnetAssociationTimeouts#getDelete}
         ...
         * @return a new instance of {@link VpcEndpointSubnetAssociationTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public VpcEndpointSubnetAssociationTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link VpcEndpointSubnetAssociationTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements VpcEndpointSubnetAssociationTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.vpc.VpcEndpointSubnetAssociationTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            VpcEndpointSubnetAssociationTimeouts.Jsii$Proxy that = (VpcEndpointSubnetAssociationTimeouts.Jsii$Proxy) o;
