...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.DataAwsVpcIpamPreviewNextCidr")
public class DataAwsVpcIpamPreviewNextCidr extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsVpcIpamPreviewNextCidr(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsVpcIpamPreviewNextCidr(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.vpc.DataAwsVpcIpamPreviewNextCidr.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsVpcIpamPreviewNextCidr(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.vpc.DataAwsVpcIpamPreviewNextCidrConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.vpc.DataAwsVpcIpamPreviewNextCidr}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.vpc.DataAwsVpcIpamPreviewNextCidr> {
        /**
        ...
        private final imports.aws.vpc.DataAwsVpcIpamPreviewNextCidrConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.vpc.DataAwsVpcIpamPreviewNextCidrConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param disallowedCidrs Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/vpc_ipam_preview_next_cidr#disallowed_cidrs DataAwsVpcIpamPreviewNextCidr#disallowed_cidrs}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/vpc_ipam_preview_next_cidr#id DataAwsVpcIpamPreviewNextCidr#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param netmaskLength Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/vpc_ipam_preview_next_cidr#netmask_length DataAwsVpcIpamPreviewNextCidr#netmask_length}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.vpc.DataAwsVpcIpamPreviewNextCidr}.
         */
        @Override
        public imports.aws.vpc.DataAwsVpcIpamPreviewNextCidr build() {
            return new imports.aws.vpc.DataAwsVpcIpamPreviewNextCidr(
                this.scope,
                this.id,
                this.config.build()
            );
