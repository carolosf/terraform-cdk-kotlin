...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.DataAwsVpcEndpointFilterOutputReference")
public class DataAwsVpcEndpointFilterOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsVpcEndpointFilterOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsVpcEndpointFilterOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.vpc.DataAwsVpcEndpointFilter value) {
