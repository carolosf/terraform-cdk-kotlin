...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.DataAwsSubnetsFilterOutputReference")
public class DataAwsSubnetsFilterOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsSubnetsFilterOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsSubnetsFilterOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.vpc.DataAwsSubnetsFilter value) {
