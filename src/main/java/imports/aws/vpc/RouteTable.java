...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.RouteTable")
public class RouteTable extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.vpc.RouteTable.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public RouteTable(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.vpc.RouteTableConfig config) {
    ...
    public void putTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.vpc.RouteTableTimeouts value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.vpc.RouteTableRouteList getRoute() {
        return software.amazon.jsii.Kernel.get(this, "route", software.amazon.jsii.NativeType.forClass(imports.aws.vpc.RouteTableRouteList.class));
    }

    public @org.jetbrains.annotations.NotNull imports.aws.vpc.RouteTableTimeoutsOutputReference getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.vpc.RouteTableTimeoutsOutputReference.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.vpc.RouteTable}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.vpc.RouteTable> {
        /**
        ...
        private final imports.aws.vpc.RouteTableConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.vpc.RouteTableConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/route_table#id RouteTable#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param propagatingVgws Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/route_table#propagating_vgws RouteTable#propagating_vgws}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param route Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/route_table#route RouteTable#route}. This parameter is required.
         */
         ...
         * @param route Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/route_table#route RouteTable#route}. This parameter is required.
         */
        public Builder route(final java.util.List<? extends imports.aws.vpc.RouteTableRoute> route) {
            this.config.route(route);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/route_table#tags RouteTable#tags}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tagsAll Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/route_table#tags_all RouteTable#tags_all}. This parameter is required.
         */
         ...
         */
        public Builder timeouts(final imports.aws.vpc.RouteTableTimeouts timeouts) {
            this.config.timeouts(timeouts);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.vpc.RouteTable}.
         */
        @Override
        public imports.aws.vpc.RouteTable build() {
            return new imports.aws.vpc.RouteTable(
                this.scope,
                this.id,
                this.config.build()
            );
