...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.NetworkInterfaceSgAttachment")
public class NetworkInterfaceSgAttachment extends com.hashicorp.cdktf.TerraformResource {

    protected NetworkInterfaceSgAttachment(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected NetworkInterfaceSgAttachment(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.vpc.NetworkInterfaceSgAttachment.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public NetworkInterfaceSgAttachment(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.vpc.NetworkInterfaceSgAttachmentConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.vpc.NetworkInterfaceSgAttachment}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.vpc.NetworkInterfaceSgAttachment> {
        /**
        ...
        private final imports.aws.vpc.NetworkInterfaceSgAttachmentConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.vpc.NetworkInterfaceSgAttachmentConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/network_interface_sg_attachment#id NetworkInterfaceSgAttachment#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.vpc.NetworkInterfaceSgAttachment}.
         */
        @Override
        public imports.aws.vpc.NetworkInterfaceSgAttachment build() {
            return new imports.aws.vpc.NetworkInterfaceSgAttachment(
                this.scope,
                this.id,
                this.config.build()
            );
