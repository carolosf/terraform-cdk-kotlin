...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.NatGateway")
public class NatGateway extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.vpc.NatGateway.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public NatGateway(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.vpc.NatGatewayConfig config) {
    ...
    public void resetConnectivityType() {
        software.amazon.jsii.Kernel.call(this, "resetConnectivityType", software.amazon.jsii.NativeType.VOID);
    }
    ...
    public @org.jetbrains.annotations.Nullable java.lang.String getConnectivityTypeInput() {
        return software.amazon.jsii.Kernel.get(this, "connectivityTypeInput", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getConnectivityType() {
    ...
    public void setConnectivityType(final @org.jetbrains.annotations.NotNull java.lang.String value) {
        software.amazon.jsii.Kernel.set(this, "connectivityType", java.util.Objects.requireNonNull(value, "connectivityType is required"));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.vpc.NatGateway}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.vpc.NatGateway> {
        /**
        ...
        private final imports.aws.vpc.NatGatewayConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.vpc.NatGatewayConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param subnetId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/nat_gateway#subnet_id NatGateway#subnet_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param allocationId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/nat_gateway#allocation_id NatGateway#allocation_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param connectivityType Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/nat_gateway#connectivity_type NatGateway#connectivity_type}. This parameter is required.
         */
        public Builder connectivityType(final java.lang.String connectivityType) {
            this.config.connectivityType(connectivityType);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/nat_gateway#id NatGateway#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/nat_gateway#tags NatGateway#tags}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tagsAll Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/nat_gateway#tags_all NatGateway#tags_all}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.vpc.NatGateway}.
         */
        @Override
        public imports.aws.vpc.NatGateway build() {
            return new imports.aws.vpc.NatGateway(
                this.scope,
                this.id,
                this.config.build()
            );
