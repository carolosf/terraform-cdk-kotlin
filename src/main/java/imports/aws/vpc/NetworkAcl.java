 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:20.263Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.NetworkAcl")
public class NetworkAcl extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.vpc.NetworkAcl.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public NetworkAcl(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.vpc.NetworkAclConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.vpc.NetworkAclEgressList getEgress() {
        return software.amazon.jsii.Kernel.get(this, "egress", software.amazon.jsii.NativeType.forClass(imports.aws.vpc.NetworkAclEgressList.class));
    }

    public @org.jetbrains.annotations.NotNull imports.aws.vpc.NetworkAclIngressList getIngress() {
        return software.amazon.jsii.Kernel.get(this, "ingress", software.amazon.jsii.NativeType.forClass(imports.aws.vpc.NetworkAclIngressList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.vpc.NetworkAcl}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.vpc.NetworkAcl> {
        /**
        ...
        private final imports.aws.vpc.NetworkAclConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.vpc.NetworkAclConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param vpcId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/network_acl#vpc_id NetworkAcl#vpc_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param egress Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/network_acl#egress NetworkAcl#egress}. This parameter is required.
         */
         ...
         * @param egress Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/network_acl#egress NetworkAcl#egress}. This parameter is required.
         */
        public Builder egress(final java.util.List<? extends imports.aws.vpc.NetworkAclEgress> egress) {
            this.config.egress(egress);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/network_acl#id NetworkAcl#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param ingress Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/network_acl#ingress NetworkAcl#ingress}. This parameter is required.
         */
         ...
         * @param ingress Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/network_acl#ingress NetworkAcl#ingress}. This parameter is required.
         */
        public Builder ingress(final java.util.List<? extends imports.aws.vpc.NetworkAclIngress> ingress) {
            this.config.ingress(ingress);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param subnetIds Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/network_acl#subnet_ids NetworkAcl#subnet_ids}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/network_acl#tags NetworkAcl#tags}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tagsAll Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/network_acl#tags_all NetworkAcl#tags_all}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.vpc.NetworkAcl}.
         */
        @Override
        public imports.aws.vpc.NetworkAcl build() {
            return new imports.aws.vpc.NetworkAcl(
                this.scope,
                this.id,
                this.config.build()
            );
