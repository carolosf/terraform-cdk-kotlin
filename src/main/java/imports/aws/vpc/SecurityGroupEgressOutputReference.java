...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.SecurityGroupEgressOutputReference")
public class SecurityGroupEgressOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected SecurityGroupEgressOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected SecurityGroupEgressOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.vpc.SecurityGroupEgress value) {
