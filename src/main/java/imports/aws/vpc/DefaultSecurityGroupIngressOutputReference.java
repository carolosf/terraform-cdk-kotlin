...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.DefaultSecurityGroupIngressOutputReference")
public class DefaultSecurityGroupIngressOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DefaultSecurityGroupIngressOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DefaultSecurityGroupIngressOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.vpc.DefaultSecurityGroupIngress value) {
