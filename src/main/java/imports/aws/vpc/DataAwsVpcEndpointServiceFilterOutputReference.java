...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.DataAwsVpcEndpointServiceFilterOutputReference")
public class DataAwsVpcEndpointServiceFilterOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsVpcEndpointServiceFilterOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsVpcEndpointServiceFilterOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.vpc.DataAwsVpcEndpointServiceFilter value) {
