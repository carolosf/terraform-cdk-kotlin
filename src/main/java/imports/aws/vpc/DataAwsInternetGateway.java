...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.DataAwsInternetGateway")
public class DataAwsInternetGateway extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.vpc.DataAwsInternetGateway.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     * @param config
     */
    public DataAwsInternetGateway(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.vpc.DataAwsInternetGatewayConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.vpc.DataAwsInternetGatewayAttachmentsList getAttachments() {
        return software.amazon.jsii.Kernel.get(this, "attachments", software.amazon.jsii.NativeType.forClass(imports.aws.vpc.DataAwsInternetGatewayAttachmentsList.class));
    }

    public @org.jetbrains.annotations.NotNull imports.aws.vpc.DataAwsInternetGatewayFilterList getFilter() {
        return software.amazon.jsii.Kernel.get(this, "filter", software.amazon.jsii.NativeType.forClass(imports.aws.vpc.DataAwsInternetGatewayFilterList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.vpc.DataAwsInternetGateway}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.vpc.DataAwsInternetGateway> {
        /**
        ...
        private imports.aws.vpc.DataAwsInternetGatewayConfig.Builder config;
         ...
         * @param filter filter block. This parameter is required.
         */
        public Builder filter(final java.util.List<? extends imports.aws.vpc.DataAwsInternetGatewayFilter> filter) {
            this.config().filter(filter);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/internet_gateway#id DataAwsInternetGateway#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param internetGatewayId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/internet_gateway#internet_gateway_id DataAwsInternetGateway#internet_gateway_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/internet_gateway#tags DataAwsInternetGateway#tags}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.vpc.DataAwsInternetGateway}.
         */
        @Override
        public imports.aws.vpc.DataAwsInternetGateway build() {
            return new imports.aws.vpc.DataAwsInternetGateway(
                this.scope,
                this.id,
        ...
        private imports.aws.vpc.DataAwsInternetGatewayConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.vpc.DataAwsInternetGatewayConfig.Builder();
            }
            return this.config;
        }
    }
