...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.VpnGatewayRoutePropagationTimeouts")
@software.amazon.jsii.Jsii.Proxy(VpnGatewayRoutePropagationTimeouts.Jsii$Proxy.class)
public interface VpnGatewayRoutePropagationTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link VpnGatewayRoutePropagationTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link VpnGatewayRoutePropagationTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<VpnGatewayRoutePropagationTimeouts> {
        java.lang.String create;
        java.lang.String delete;

        /**
         * Sets the value of {@link VpnGatewayRoutePropagationTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link VpnGatewayRoutePropagationTimeouts#getDelete}
         ...
         * @return a new instance of {@link VpnGatewayRoutePropagationTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public VpnGatewayRoutePropagationTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link VpnGatewayRoutePropagationTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements VpnGatewayRoutePropagationTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.vpc.VpnGatewayRoutePropagationTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            VpnGatewayRoutePropagationTimeouts.Jsii$Proxy that = (VpnGatewayRoutePropagationTimeouts.Jsii$Proxy) o;
