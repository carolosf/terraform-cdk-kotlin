...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.VpcPeeringConnectionOptionsAccepter")
@software.amazon.jsii.Jsii.Proxy(VpcPeeringConnectionOptionsAccepter.Jsii$Proxy.class)
public interface VpcPeeringConnectionOptionsAccepter extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link VpcPeeringConnectionOptionsAccepter}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link VpcPeeringConnectionOptionsAccepter}
     */
    public static final class Builder implements software.amazon.jsii.Builder<VpcPeeringConnectionOptionsAccepter> {
        ...
        /**
         * Sets the value of {@link VpcPeeringConnectionOptionsAccepter#getAllowClassicLinkToRemoteVpc}
         * @param allowClassicLinkToRemoteVpc Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/vpc_peering_connection_options#allow_classic_link_to_remote_vpc VpcPeeringConnectionOptions#allow_classic_link_to_remote_vpc}.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link VpcPeeringConnectionOptionsAccepter#getAllowRemoteVpcDnsResolution}
         * @param allowRemoteVpcDnsResolution Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/vpc_peering_connection_options#allow_remote_vpc_dns_resolution VpcPeeringConnectionOptions#allow_remote_vpc_dns_resolution}.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link VpcPeeringConnectionOptionsAccepter#getAllowVpcToRemoteClassicLink}
         * @param allowVpcToRemoteClassicLink Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/vpc_peering_connection_options#allow_vpc_to_remote_classic_link VpcPeeringConnectionOptions#allow_vpc_to_remote_classic_link}.
         * @return {@code this}
         */
         ...
         * @return a new instance of {@link VpcPeeringConnectionOptionsAccepter}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public VpcPeeringConnectionOptionsAccepter build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link VpcPeeringConnectionOptionsAccepter}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements VpcPeeringConnectionOptionsAccepter {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.vpc.VpcPeeringConnectionOptionsAccepter"));
        ...
        public final boolean equals(final Object o) {
            ...
            VpcPeeringConnectionOptionsAccepter.Jsii$Proxy that = (VpcPeeringConnectionOptionsAccepter.Jsii$Proxy) o;
