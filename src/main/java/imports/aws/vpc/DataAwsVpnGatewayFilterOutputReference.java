...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.DataAwsVpnGatewayFilterOutputReference")
public class DataAwsVpnGatewayFilterOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsVpnGatewayFilterOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsVpnGatewayFilterOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.vpc.DataAwsVpnGatewayFilter value) {
