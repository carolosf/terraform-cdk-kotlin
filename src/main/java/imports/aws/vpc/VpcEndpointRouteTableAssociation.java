...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.VpcEndpointRouteTableAssociation")
public class VpcEndpointRouteTableAssociation extends com.hashicorp.cdktf.TerraformResource {

    protected VpcEndpointRouteTableAssociation(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected VpcEndpointRouteTableAssociation(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.vpc.VpcEndpointRouteTableAssociation.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public VpcEndpointRouteTableAssociation(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.vpc.VpcEndpointRouteTableAssociationConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.vpc.VpcEndpointRouteTableAssociation}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.vpc.VpcEndpointRouteTableAssociation> {
        /**
        ...
        private final imports.aws.vpc.VpcEndpointRouteTableAssociationConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.vpc.VpcEndpointRouteTableAssociationConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/vpc_endpoint_route_table_association#id VpcEndpointRouteTableAssociation#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.vpc.VpcEndpointRouteTableAssociation}.
         */
        @Override
        public imports.aws.vpc.VpcEndpointRouteTableAssociation build() {
            return new imports.aws.vpc.VpcEndpointRouteTableAssociation(
                this.scope,
                this.id,
                this.config.build()
            );
