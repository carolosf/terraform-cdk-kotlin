...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.DataAwsVpcPeeringConnectionFilterOutputReference")
public class DataAwsVpcPeeringConnectionFilterOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsVpcPeeringConnectionFilterOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsVpcPeeringConnectionFilterOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.vpc.DataAwsVpcPeeringConnectionFilter value) {
