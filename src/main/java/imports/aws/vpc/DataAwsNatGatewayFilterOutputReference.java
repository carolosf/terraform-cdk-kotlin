...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.DataAwsNatGatewayFilterOutputReference")
public class DataAwsNatGatewayFilterOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsNatGatewayFilterOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsNatGatewayFilterOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.vpc.DataAwsNatGatewayFilter value) {
