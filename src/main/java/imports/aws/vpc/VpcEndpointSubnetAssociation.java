...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.vpc.VpcEndpointSubnetAssociation")
public class VpcEndpointSubnetAssociation extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.vpc.VpcEndpointSubnetAssociation.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public VpcEndpointSubnetAssociation(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.vpc.VpcEndpointSubnetAssociationConfig config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public void putTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.vpc.VpcEndpointSubnetAssociationTimeouts value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.vpc.VpcEndpointSubnetAssociationTimeoutsOutputReference getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.vpc.VpcEndpointSubnetAssociationTimeoutsOutputReference.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.vpc.VpcEndpointSubnetAssociation}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.vpc.VpcEndpointSubnetAssociation> {
        /**
        ...
        private final imports.aws.vpc.VpcEndpointSubnetAssociationConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.vpc.VpcEndpointSubnetAssociationConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/vpc_endpoint_subnet_association#id VpcEndpointSubnetAssociation#id}. This parameter is required.
         */
         ...
         */
        public Builder timeouts(final imports.aws.vpc.VpcEndpointSubnetAssociationTimeouts timeouts) {
            this.config.timeouts(timeouts);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.vpc.VpcEndpointSubnetAssociation}.
         */
        @Override
        public imports.aws.vpc.VpcEndpointSubnetAssociation build() {
            return new imports.aws.vpc.VpcEndpointSubnetAssociation(
                this.scope,
                this.id,
                this.config.build()
            );
