...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directconnect.DxTransitVirtualInterfaceTimeouts")
@software.amazon.jsii.Jsii.Proxy(DxTransitVirtualInterfaceTimeouts.Jsii$Proxy.class)
public interface DxTransitVirtualInterfaceTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DxTransitVirtualInterfaceTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DxTransitVirtualInterfaceTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DxTransitVirtualInterfaceTimeouts> {
        java.lang.String create;
        java.lang.String delete;
        java.lang.String update;

        /**
         * Sets the value of {@link DxTransitVirtualInterfaceTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link DxTransitVirtualInterfaceTimeouts#getDelete}
        ...
        /**
         * Sets the value of {@link DxTransitVirtualInterfaceTimeouts#getUpdate}
         ...
         * @return a new instance of {@link DxTransitVirtualInterfaceTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DxTransitVirtualInterfaceTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DxTransitVirtualInterfaceTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DxTransitVirtualInterfaceTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.directconnect.DxTransitVirtualInterfaceTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            DxTransitVirtualInterfaceTimeouts.Jsii$Proxy that = (DxTransitVirtualInterfaceTimeouts.Jsii$Proxy) o;
