...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directconnect.DxHostedTransitVirtualInterfaceAccepterTimeouts")
@software.amazon.jsii.Jsii.Proxy(DxHostedTransitVirtualInterfaceAccepterTimeouts.Jsii$Proxy.class)
public interface DxHostedTransitVirtualInterfaceAccepterTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DxHostedTransitVirtualInterfaceAccepterTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DxHostedTransitVirtualInterfaceAccepterTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DxHostedTransitVirtualInterfaceAccepterTimeouts> {
        java.lang.String create;
        java.lang.String delete;

        /**
         * Sets the value of {@link DxHostedTransitVirtualInterfaceAccepterTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link DxHostedTransitVirtualInterfaceAccepterTimeouts#getDelete}
         ...
         * @return a new instance of {@link DxHostedTransitVirtualInterfaceAccepterTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DxHostedTransitVirtualInterfaceAccepterTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DxHostedTransitVirtualInterfaceAccepterTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DxHostedTransitVirtualInterfaceAccepterTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.directconnect.DxHostedTransitVirtualInterfaceAccepterTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            DxHostedTransitVirtualInterfaceAccepterTimeouts.Jsii$Proxy that = (DxHostedTransitVirtualInterfaceAccepterTimeouts.Jsii$Proxy) o;
