 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:19.457Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directconnect.DxHostedTransitVirtualInterface")
public class DxHostedTransitVirtualInterface extends com.hashicorp.cdktf.TerraformResource {

    protected DxHostedTransitVirtualInterface(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DxHostedTransitVirtualInterface(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.directconnect.DxHostedTransitVirtualInterface.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DxHostedTransitVirtualInterface(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.directconnect.DxHostedTransitVirtualInterfaceConfig config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public void putTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.directconnect.DxHostedTransitVirtualInterfaceTimeouts value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.directconnect.DxHostedTransitVirtualInterfaceTimeoutsOutputReference getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.directconnect.DxHostedTransitVirtualInterfaceTimeoutsOutputReference.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.directconnect.DxHostedTransitVirtualInterface}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.directconnect.DxHostedTransitVirtualInterface> {
        /**
        ...
        private final imports.aws.directconnect.DxHostedTransitVirtualInterfaceConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.directconnect.DxHostedTransitVirtualInterfaceConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param amazonAddress Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_hosted_transit_virtual_interface#amazon_address DxHostedTransitVirtualInterface#amazon_address}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param bgpAuthKey Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_hosted_transit_virtual_interface#bgp_auth_key DxHostedTransitVirtualInterface#bgp_auth_key}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param customerAddress Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_hosted_transit_virtual_interface#customer_address DxHostedTransitVirtualInterface#customer_address}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_hosted_transit_virtual_interface#id DxHostedTransitVirtualInterface#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param mtu Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_hosted_transit_virtual_interface#mtu DxHostedTransitVirtualInterface#mtu}. This parameter is required.
         */
         ...
         */
        public Builder timeouts(final imports.aws.directconnect.DxHostedTransitVirtualInterfaceTimeouts timeouts) {
            this.config.timeouts(timeouts);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.directconnect.DxHostedTransitVirtualInterface}.
         */
        @Override
        public imports.aws.directconnect.DxHostedTransitVirtualInterface build() {
            return new imports.aws.directconnect.DxHostedTransitVirtualInterface(
                this.scope,
                this.id,
                this.config.build()
            );
