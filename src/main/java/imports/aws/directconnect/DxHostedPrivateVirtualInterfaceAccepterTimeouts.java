...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directconnect.DxHostedPrivateVirtualInterfaceAccepterTimeouts")
@software.amazon.jsii.Jsii.Proxy(DxHostedPrivateVirtualInterfaceAccepterTimeouts.Jsii$Proxy.class)
public interface DxHostedPrivateVirtualInterfaceAccepterTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DxHostedPrivateVirtualInterfaceAccepterTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DxHostedPrivateVirtualInterfaceAccepterTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DxHostedPrivateVirtualInterfaceAccepterTimeouts> {
        java.lang.String create;
        java.lang.String delete;

        /**
         * Sets the value of {@link DxHostedPrivateVirtualInterfaceAccepterTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link DxHostedPrivateVirtualInterfaceAccepterTimeouts#getDelete}
         ...
         * @return a new instance of {@link DxHostedPrivateVirtualInterfaceAccepterTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DxHostedPrivateVirtualInterfaceAccepterTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DxHostedPrivateVirtualInterfaceAccepterTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DxHostedPrivateVirtualInterfaceAccepterTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.directconnect.DxHostedPrivateVirtualInterfaceAccepterTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            DxHostedPrivateVirtualInterfaceAccepterTimeouts.Jsii$Proxy that = (DxHostedPrivateVirtualInterfaceAccepterTimeouts.Jsii$Proxy) o;
