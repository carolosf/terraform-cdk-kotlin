...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directconnect.DxHostedTransitVirtualInterfaceAccepterTimeoutsOutputReference")
public class DxHostedTransitVirtualInterfaceAccepterTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DxHostedTransitVirtualInterfaceAccepterTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DxHostedTransitVirtualInterfaceAccepterTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public DxHostedTransitVirtualInterfaceAccepterTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.directconnect.DxHostedTransitVirtualInterfaceAccepterTimeouts value) {
