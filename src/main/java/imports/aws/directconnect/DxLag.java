...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directconnect.DxLag")
public class DxLag extends com.hashicorp.cdktf.TerraformResource {

    protected DxLag(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DxLag(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.directconnect.DxLag.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DxLag(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.directconnect.DxLagConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable java.lang.String getConnectionsBandwidthInput() {
        return software.amazon.jsii.Kernel.get(this, "connectionsBandwidthInput", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getConnectionsBandwidth() {
        return software.amazon.jsii.Kernel.get(this, "connectionsBandwidth", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }

    public void setConnectionsBandwidth(final @org.jetbrains.annotations.NotNull java.lang.String value) {
        software.amazon.jsii.Kernel.set(this, "connectionsBandwidth", java.util.Objects.requireNonNull(value, "connectionsBandwidth is required"));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.directconnect.DxLag}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.directconnect.DxLag> {
        /**
        ...
        private final imports.aws.directconnect.DxLagConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.directconnect.DxLagConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param connectionsBandwidth Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_lag#connections_bandwidth DxLag#connections_bandwidth}. This parameter is required.
         */
        public Builder connectionsBandwidth(final java.lang.String connectionsBandwidth) {
            this.config.connectionsBandwidth(connectionsBandwidth);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param location Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_lag#location DxLag#location}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param name Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_lag#name DxLag#name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param connectionId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_lag#connection_id DxLag#connection_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param forceDestroy Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_lag#force_destroy DxLag#force_destroy}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_lag#id DxLag#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param providerName Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_lag#provider_name DxLag#provider_name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_lag#tags DxLag#tags}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tagsAll Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_lag#tags_all DxLag#tags_all}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.directconnect.DxLag}.
         */
        @Override
        public imports.aws.directconnect.DxLag build() {
            return new imports.aws.directconnect.DxLag(
                this.scope,
                this.id,
                this.config.build()
            );
