...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directconnect.DxHostedPrivateVirtualInterfaceAccepterTimeoutsOutputReference")
public class DxHostedPrivateVirtualInterfaceAccepterTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DxHostedPrivateVirtualInterfaceAccepterTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DxHostedPrivateVirtualInterfaceAccepterTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public DxHostedPrivateVirtualInterfaceAccepterTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.directconnect.DxHostedPrivateVirtualInterfaceAccepterTimeouts value) {
