 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:19.455Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directconnect.DxHostedPrivateVirtualInterfaceAccepter")
public class DxHostedPrivateVirtualInterfaceAccepter extends com.hashicorp.cdktf.TerraformResource {

    protected DxHostedPrivateVirtualInterfaceAccepter(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DxHostedPrivateVirtualInterfaceAccepter(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.directconnect.DxHostedPrivateVirtualInterfaceAccepter.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DxHostedPrivateVirtualInterfaceAccepter(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.directconnect.DxHostedPrivateVirtualInterfaceAccepterConfig config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public void putTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.directconnect.DxHostedPrivateVirtualInterfaceAccepterTimeouts value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.directconnect.DxHostedPrivateVirtualInterfaceAccepterTimeoutsOutputReference getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.directconnect.DxHostedPrivateVirtualInterfaceAccepterTimeoutsOutputReference.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.directconnect.DxHostedPrivateVirtualInterfaceAccepter}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.directconnect.DxHostedPrivateVirtualInterfaceAccepter> {
        /**
        ...
        private final imports.aws.directconnect.DxHostedPrivateVirtualInterfaceAccepterConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.directconnect.DxHostedPrivateVirtualInterfaceAccepterConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param dxGatewayId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_hosted_private_virtual_interface_accepter#dx_gateway_id DxHostedPrivateVirtualInterfaceAccepter#dx_gateway_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_hosted_private_virtual_interface_accepter#id DxHostedPrivateVirtualInterfaceAccepter#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_hosted_private_virtual_interface_accepter#tags DxHostedPrivateVirtualInterfaceAccepter#tags}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tagsAll Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_hosted_private_virtual_interface_accepter#tags_all DxHostedPrivateVirtualInterfaceAccepter#tags_all}. This parameter is required.
         */
         ...
         */
        public Builder timeouts(final imports.aws.directconnect.DxHostedPrivateVirtualInterfaceAccepterTimeouts timeouts) {
         ...
         * <p>
         * @return {@code this}
         * @param vpnGatewayId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_hosted_private_virtual_interface_accepter#vpn_gateway_id DxHostedPrivateVirtualInterfaceAccepter#vpn_gateway_id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.directconnect.DxHostedPrivateVirtualInterfaceAccepter}.
         */
        @Override
        public imports.aws.directconnect.DxHostedPrivateVirtualInterfaceAccepter build() {
            return new imports.aws.directconnect.DxHostedPrivateVirtualInterfaceAccepter(
                this.scope,
                this.id,
                this.config.build()
            );
