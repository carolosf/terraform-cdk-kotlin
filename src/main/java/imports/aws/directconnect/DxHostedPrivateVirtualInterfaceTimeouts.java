...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directconnect.DxHostedPrivateVirtualInterfaceTimeouts")
@software.amazon.jsii.Jsii.Proxy(DxHostedPrivateVirtualInterfaceTimeouts.Jsii$Proxy.class)
public interface DxHostedPrivateVirtualInterfaceTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DxHostedPrivateVirtualInterfaceTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DxHostedPrivateVirtualInterfaceTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DxHostedPrivateVirtualInterfaceTimeouts> {
        java.lang.String create;
        java.lang.String delete;

        /**
         * Sets the value of {@link DxHostedPrivateVirtualInterfaceTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link DxHostedPrivateVirtualInterfaceTimeouts#getDelete}
         ...
         * @return a new instance of {@link DxHostedPrivateVirtualInterfaceTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DxHostedPrivateVirtualInterfaceTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DxHostedPrivateVirtualInterfaceTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DxHostedPrivateVirtualInterfaceTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.directconnect.DxHostedPrivateVirtualInterfaceTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            DxHostedPrivateVirtualInterfaceTimeouts.Jsii$Proxy that = (DxHostedPrivateVirtualInterfaceTimeouts.Jsii$Proxy) o;
