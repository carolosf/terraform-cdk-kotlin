...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directconnect.DxHostedTransitVirtualInterfaceTimeouts")
@software.amazon.jsii.Jsii.Proxy(DxHostedTransitVirtualInterfaceTimeouts.Jsii$Proxy.class)
public interface DxHostedTransitVirtualInterfaceTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DxHostedTransitVirtualInterfaceTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DxHostedTransitVirtualInterfaceTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DxHostedTransitVirtualInterfaceTimeouts> {
        java.lang.String create;
        java.lang.String delete;

        /**
         * Sets the value of {@link DxHostedTransitVirtualInterfaceTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link DxHostedTransitVirtualInterfaceTimeouts#getDelete}
         ...
         * @return a new instance of {@link DxHostedTransitVirtualInterfaceTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DxHostedTransitVirtualInterfaceTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DxHostedTransitVirtualInterfaceTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DxHostedTransitVirtualInterfaceTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.directconnect.DxHostedTransitVirtualInterfaceTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            DxHostedTransitVirtualInterfaceTimeouts.Jsii$Proxy that = (DxHostedTransitVirtualInterfaceTimeouts.Jsii$Proxy) o;
