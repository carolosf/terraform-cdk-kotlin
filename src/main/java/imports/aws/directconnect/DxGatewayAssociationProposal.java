...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directconnect.DxGatewayAssociationProposal")
public class DxGatewayAssociationProposal extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.directconnect.DxGatewayAssociationProposal.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DxGatewayAssociationProposal(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.directconnect.DxGatewayAssociationProposalConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.directconnect.DxGatewayAssociationProposal}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.directconnect.DxGatewayAssociationProposal> {
        /**
        ...
        private final imports.aws.directconnect.DxGatewayAssociationProposalConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.directconnect.DxGatewayAssociationProposalConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param allowedPrefixes Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_gateway_association_proposal#allowed_prefixes DxGatewayAssociationProposal#allowed_prefixes}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_gateway_association_proposal#id DxGatewayAssociationProposal#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.directconnect.DxGatewayAssociationProposal}.
         */
        @Override
        public imports.aws.directconnect.DxGatewayAssociationProposal build() {
            return new imports.aws.directconnect.DxGatewayAssociationProposal(
                this.scope,
                this.id,
                this.config.build()
            );
