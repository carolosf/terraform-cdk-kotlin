...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directconnect.DxHostedPrivateVirtualInterfaceTimeoutsOutputReference")
public class DxHostedPrivateVirtualInterfaceTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DxHostedPrivateVirtualInterfaceTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DxHostedPrivateVirtualInterfaceTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public DxHostedPrivateVirtualInterfaceTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.directconnect.DxHostedPrivateVirtualInterfaceTimeouts value) {
