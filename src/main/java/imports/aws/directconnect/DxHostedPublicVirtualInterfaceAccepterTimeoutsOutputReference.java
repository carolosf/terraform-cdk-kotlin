...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directconnect.DxHostedPublicVirtualInterfaceAccepterTimeoutsOutputReference")
public class DxHostedPublicVirtualInterfaceAccepterTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DxHostedPublicVirtualInterfaceAccepterTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DxHostedPublicVirtualInterfaceAccepterTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public DxHostedPublicVirtualInterfaceAccepterTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.directconnect.DxHostedPublicVirtualInterfaceAccepterTimeouts value) {
