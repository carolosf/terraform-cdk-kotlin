...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directconnect.DxPrivateVirtualInterfaceTimeouts")
@software.amazon.jsii.Jsii.Proxy(DxPrivateVirtualInterfaceTimeouts.Jsii$Proxy.class)
public interface DxPrivateVirtualInterfaceTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DxPrivateVirtualInterfaceTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DxPrivateVirtualInterfaceTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DxPrivateVirtualInterfaceTimeouts> {
        java.lang.String create;
        java.lang.String delete;
        java.lang.String update;

        /**
         * Sets the value of {@link DxPrivateVirtualInterfaceTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link DxPrivateVirtualInterfaceTimeouts#getDelete}
        ...
        /**
         * Sets the value of {@link DxPrivateVirtualInterfaceTimeouts#getUpdate}
         ...
         * @return a new instance of {@link DxPrivateVirtualInterfaceTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DxPrivateVirtualInterfaceTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DxPrivateVirtualInterfaceTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DxPrivateVirtualInterfaceTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.directconnect.DxPrivateVirtualInterfaceTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            DxPrivateVirtualInterfaceTimeouts.Jsii$Proxy that = (DxPrivateVirtualInterfaceTimeouts.Jsii$Proxy) o;
