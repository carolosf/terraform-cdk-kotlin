...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directconnect.DxHostedPublicVirtualInterface")
public class DxHostedPublicVirtualInterface extends com.hashicorp.cdktf.TerraformResource {

    protected DxHostedPublicVirtualInterface(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DxHostedPublicVirtualInterface(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.directconnect.DxHostedPublicVirtualInterface.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DxHostedPublicVirtualInterface(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.directconnect.DxHostedPublicVirtualInterfaceConfig config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public void putTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.directconnect.DxHostedPublicVirtualInterfaceTimeouts value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.directconnect.DxHostedPublicVirtualInterfaceTimeoutsOutputReference getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.directconnect.DxHostedPublicVirtualInterfaceTimeoutsOutputReference.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.directconnect.DxHostedPublicVirtualInterface}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.directconnect.DxHostedPublicVirtualInterface> {
        /**
        ...
        private final imports.aws.directconnect.DxHostedPublicVirtualInterfaceConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.directconnect.DxHostedPublicVirtualInterfaceConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param amazonAddress Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_hosted_public_virtual_interface#amazon_address DxHostedPublicVirtualInterface#amazon_address}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param bgpAuthKey Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_hosted_public_virtual_interface#bgp_auth_key DxHostedPublicVirtualInterface#bgp_auth_key}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param customerAddress Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_hosted_public_virtual_interface#customer_address DxHostedPublicVirtualInterface#customer_address}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dx_hosted_public_virtual_interface#id DxHostedPublicVirtualInterface#id}. This parameter is required.
         */
         ...
         */
        public Builder timeouts(final imports.aws.directconnect.DxHostedPublicVirtualInterfaceTimeouts timeouts) {
            this.config.timeouts(timeouts);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.directconnect.DxHostedPublicVirtualInterface}.
         */
        @Override
        public imports.aws.directconnect.DxHostedPublicVirtualInterface build() {
            return new imports.aws.directconnect.DxHostedPublicVirtualInterface(
                this.scope,
                this.id,
                this.config.build()
            );
