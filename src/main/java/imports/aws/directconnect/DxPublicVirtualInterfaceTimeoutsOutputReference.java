...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directconnect.DxPublicVirtualInterfaceTimeoutsOutputReference")
public class DxPublicVirtualInterfaceTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DxPublicVirtualInterfaceTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DxPublicVirtualInterfaceTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public DxPublicVirtualInterfaceTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.directconnect.DxPublicVirtualInterfaceTimeouts value) {
