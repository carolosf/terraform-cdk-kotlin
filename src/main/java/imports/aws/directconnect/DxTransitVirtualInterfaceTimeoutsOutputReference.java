...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directconnect.DxTransitVirtualInterfaceTimeoutsOutputReference")
public class DxTransitVirtualInterfaceTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DxTransitVirtualInterfaceTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DxTransitVirtualInterfaceTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public DxTransitVirtualInterfaceTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.directconnect.DxTransitVirtualInterfaceTimeouts value) {
