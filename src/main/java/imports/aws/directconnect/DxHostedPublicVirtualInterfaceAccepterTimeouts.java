...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directconnect.DxHostedPublicVirtualInterfaceAccepterTimeouts")
@software.amazon.jsii.Jsii.Proxy(DxHostedPublicVirtualInterfaceAccepterTimeouts.Jsii$Proxy.class)
public interface DxHostedPublicVirtualInterfaceAccepterTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DxHostedPublicVirtualInterfaceAccepterTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DxHostedPublicVirtualInterfaceAccepterTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DxHostedPublicVirtualInterfaceAccepterTimeouts> {
        java.lang.String create;
        java.lang.String delete;

        /**
         * Sets the value of {@link DxHostedPublicVirtualInterfaceAccepterTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link DxHostedPublicVirtualInterfaceAccepterTimeouts#getDelete}
         ...
         * @return a new instance of {@link DxHostedPublicVirtualInterfaceAccepterTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DxHostedPublicVirtualInterfaceAccepterTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DxHostedPublicVirtualInterfaceAccepterTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DxHostedPublicVirtualInterfaceAccepterTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.directconnect.DxHostedPublicVirtualInterfaceAccepterTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            DxHostedPublicVirtualInterfaceAccepterTimeouts.Jsii$Proxy that = (DxHostedPublicVirtualInterfaceAccepterTimeouts.Jsii$Proxy) o;
