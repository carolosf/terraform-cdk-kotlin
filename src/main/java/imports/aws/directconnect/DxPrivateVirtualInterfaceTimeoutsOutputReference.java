...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directconnect.DxPrivateVirtualInterfaceTimeoutsOutputReference")
public class DxPrivateVirtualInterfaceTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DxPrivateVirtualInterfaceTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DxPrivateVirtualInterfaceTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public DxPrivateVirtualInterfaceTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.directconnect.DxPrivateVirtualInterfaceTimeouts value) {
