...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directconnect.DxHostedTransitVirtualInterfaceTimeoutsOutputReference")
public class DxHostedTransitVirtualInterfaceTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DxHostedTransitVirtualInterfaceTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DxHostedTransitVirtualInterfaceTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public DxHostedTransitVirtualInterfaceTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.directconnect.DxHostedTransitVirtualInterfaceTimeouts value) {
