...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directconnect.DxHostedPublicVirtualInterfaceTimeouts")
@software.amazon.jsii.Jsii.Proxy(DxHostedPublicVirtualInterfaceTimeouts.Jsii$Proxy.class)
public interface DxHostedPublicVirtualInterfaceTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DxHostedPublicVirtualInterfaceTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DxHostedPublicVirtualInterfaceTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DxHostedPublicVirtualInterfaceTimeouts> {
        java.lang.String create;
        java.lang.String delete;

        /**
         * Sets the value of {@link DxHostedPublicVirtualInterfaceTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link DxHostedPublicVirtualInterfaceTimeouts#getDelete}
         ...
         * @return a new instance of {@link DxHostedPublicVirtualInterfaceTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DxHostedPublicVirtualInterfaceTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DxHostedPublicVirtualInterfaceTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DxHostedPublicVirtualInterfaceTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.directconnect.DxHostedPublicVirtualInterfaceTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            DxHostedPublicVirtualInterfaceTimeouts.Jsii$Proxy that = (DxHostedPublicVirtualInterfaceTimeouts.Jsii$Proxy) o;
