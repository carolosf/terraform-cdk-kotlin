...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.elasticsearch.DataAwsElasticsearchDomainVpcOptionsOutputReference")
public class DataAwsElasticsearchDomainVpcOptionsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsElasticsearchDomainVpcOptionsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsElasticsearchDomainVpcOptionsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.elasticsearch.DataAwsElasticsearchDomainVpcOptions getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.elasticsearch.DataAwsElasticsearchDomainVpcOptions.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.elasticsearch.DataAwsElasticsearchDomainVpcOptions value) {
