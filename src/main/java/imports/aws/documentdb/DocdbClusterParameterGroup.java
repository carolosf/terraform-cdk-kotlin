...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.documentdb.DocdbClusterParameterGroup")
public class DocdbClusterParameterGroup extends com.hashicorp.cdktf.TerraformResource {

    protected DocdbClusterParameterGroup(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DocdbClusterParameterGroup(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.documentdb.DocdbClusterParameterGroup.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DocdbClusterParameterGroup(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.documentdb.DocdbClusterParameterGroupConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.documentdb.DocdbClusterParameterGroupParameterList getParameter() {
        return software.amazon.jsii.Kernel.get(this, "parameter", software.amazon.jsii.NativeType.forClass(imports.aws.documentdb.DocdbClusterParameterGroupParameterList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.documentdb.DocdbClusterParameterGroup}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.documentdb.DocdbClusterParameterGroup> {
        /**
        ...
        private final imports.aws.documentdb.DocdbClusterParameterGroupConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.documentdb.DocdbClusterParameterGroupConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param family Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/docdb_cluster_parameter_group#family DocdbClusterParameterGroup#family}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param description Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/docdb_cluster_parameter_group#description DocdbClusterParameterGroup#description}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/docdb_cluster_parameter_group#id DocdbClusterParameterGroup#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param namePrefix Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/docdb_cluster_parameter_group#name_prefix DocdbClusterParameterGroup#name_prefix}. This parameter is required.
         */
         ...
         * @param parameter parameter block. This parameter is required.
         */
        public Builder parameter(final java.util.List<? extends imports.aws.documentdb.DocdbClusterParameterGroupParameter> parameter) {
            this.config.parameter(parameter);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/docdb_cluster_parameter_group#tags DocdbClusterParameterGroup#tags}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tagsAll Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/docdb_cluster_parameter_group#tags_all DocdbClusterParameterGroup#tags_all}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.documentdb.DocdbClusterParameterGroup}.
         */
        @Override
        public imports.aws.documentdb.DocdbClusterParameterGroup build() {
            return new imports.aws.documentdb.DocdbClusterParameterGroup(
                this.scope,
                this.id,
                this.config.build()
            );
