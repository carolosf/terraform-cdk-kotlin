...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.documentdb.DocdbGlobalCluster")
public class DocdbGlobalCluster extends com.hashicorp.cdktf.TerraformResource {

    protected DocdbGlobalCluster(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DocdbGlobalCluster(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.documentdb.DocdbGlobalCluster.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DocdbGlobalCluster(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.documentdb.DocdbGlobalClusterConfig config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public void putTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.documentdb.DocdbGlobalClusterTimeouts value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.documentdb.DocdbGlobalClusterGlobalClusterMembersList getGlobalClusterMembers() {
        return software.amazon.jsii.Kernel.get(this, "globalClusterMembers", software.amazon.jsii.NativeType.forClass(imports.aws.documentdb.DocdbGlobalClusterGlobalClusterMembersList.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.documentdb.DocdbGlobalClusterTimeoutsOutputReference getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.documentdb.DocdbGlobalClusterTimeoutsOutputReference.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.documentdb.DocdbGlobalCluster}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.documentdb.DocdbGlobalCluster> {
        /**
        ...
        private final imports.aws.documentdb.DocdbGlobalClusterConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.documentdb.DocdbGlobalClusterConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param databaseName Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/docdb_global_cluster#database_name DocdbGlobalCluster#database_name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param deletionProtection Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/docdb_global_cluster#deletion_protection DocdbGlobalCluster#deletion_protection}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param engine Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/docdb_global_cluster#engine DocdbGlobalCluster#engine}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param engineVersion Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/docdb_global_cluster#engine_version DocdbGlobalCluster#engine_version}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/docdb_global_cluster#id DocdbGlobalCluster#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param sourceDbClusterIdentifier Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/docdb_global_cluster#source_db_cluster_identifier DocdbGlobalCluster#source_db_cluster_identifier}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param storageEncrypted Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/docdb_global_cluster#storage_encrypted DocdbGlobalCluster#storage_encrypted}. This parameter is required.
         */
         ...
         */
        public Builder timeouts(final imports.aws.documentdb.DocdbGlobalClusterTimeouts timeouts) {
            this.config.timeouts(timeouts);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.documentdb.DocdbGlobalCluster}.
         */
        @Override
        public imports.aws.documentdb.DocdbGlobalCluster build() {
            return new imports.aws.documentdb.DocdbGlobalCluster(
                this.scope,
                this.id,
                this.config.build()
            );
