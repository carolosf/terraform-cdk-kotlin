...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.documentdb.DocdbClusterSnapshot")
public class DocdbClusterSnapshot extends com.hashicorp.cdktf.TerraformResource {

    protected DocdbClusterSnapshot(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DocdbClusterSnapshot(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.documentdb.DocdbClusterSnapshot.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DocdbClusterSnapshot(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.documentdb.DocdbClusterSnapshotConfig config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public void putTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.documentdb.DocdbClusterSnapshotTimeouts value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.documentdb.DocdbClusterSnapshotTimeoutsOutputReference getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.documentdb.DocdbClusterSnapshotTimeoutsOutputReference.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.documentdb.DocdbClusterSnapshot}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.documentdb.DocdbClusterSnapshot> {
        /**
        ...
        private final imports.aws.documentdb.DocdbClusterSnapshotConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.documentdb.DocdbClusterSnapshotConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/docdb_cluster_snapshot#id DocdbClusterSnapshot#id}. This parameter is required.
         */
         ...
         */
        public Builder timeouts(final imports.aws.documentdb.DocdbClusterSnapshotTimeouts timeouts) {
            this.config.timeouts(timeouts);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.documentdb.DocdbClusterSnapshot}.
         */
        @Override
        public imports.aws.documentdb.DocdbClusterSnapshot build() {
            return new imports.aws.documentdb.DocdbClusterSnapshot(
                this.scope,
                this.id,
                this.config.build()
            );
