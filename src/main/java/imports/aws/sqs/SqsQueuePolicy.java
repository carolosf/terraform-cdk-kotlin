...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.sqs.SqsQueuePolicy")
public class SqsQueuePolicy extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.sqs.SqsQueuePolicy.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public SqsQueuePolicy(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.sqs.SqsQueuePolicyConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.sqs.SqsQueuePolicy}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.sqs.SqsQueuePolicy> {
        /**
        ...
        private final imports.aws.sqs.SqsQueuePolicyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.sqs.SqsQueuePolicyConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/sqs_queue_policy#id SqsQueuePolicy#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.sqs.SqsQueuePolicy}.
         */
        @Override
        public imports.aws.sqs.SqsQueuePolicy build() {
            return new imports.aws.sqs.SqsQueuePolicy(
                this.scope,
                this.id,
                this.config.build()
            );
