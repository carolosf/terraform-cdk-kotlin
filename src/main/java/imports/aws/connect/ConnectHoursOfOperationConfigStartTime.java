...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.connect.ConnectHoursOfOperationConfigStartTime")
@software.amazon.jsii.Jsii.Proxy(ConnectHoursOfOperationConfigStartTime.Jsii$Proxy.class)
public interface ConnectHoursOfOperationConfigStartTime extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link ConnectHoursOfOperationConfigStartTime}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ConnectHoursOfOperationConfigStartTime}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ConnectHoursOfOperationConfigStartTime> {
        ...
        /**
         * Sets the value of {@link ConnectHoursOfOperationConfigStartTime#getHours}
        ...
        /**
         * Sets the value of {@link ConnectHoursOfOperationConfigStartTime#getMinutes}
         ...
         * @return a new instance of {@link ConnectHoursOfOperationConfigStartTime}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ConnectHoursOfOperationConfigStartTime build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ConnectHoursOfOperationConfigStartTime}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ConnectHoursOfOperationConfigStartTime {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.connect.ConnectHoursOfOperationConfigStartTime"));
        ...
        public final boolean equals(final Object o) {
            ...
            ConnectHoursOfOperationConfigStartTime.Jsii$Proxy that = (ConnectHoursOfOperationConfigStartTime.Jsii$Proxy) o;
