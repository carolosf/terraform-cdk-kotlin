...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.MemorydbClusterShardsNodesList")
public class MemorydbClusterShardsNodesList extends com.hashicorp.cdktf.ComplexList {

    protected MemorydbClusterShardsNodesList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected MemorydbClusterShardsNodesList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public MemorydbClusterShardsNodesList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.MemorydbClusterShardsNodesOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.MemorydbClusterShardsNodesOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
