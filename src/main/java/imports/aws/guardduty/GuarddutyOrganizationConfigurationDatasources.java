...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.guardduty.GuarddutyOrganizationConfigurationDatasources")
...
public interface GuarddutyOrganizationConfigurationDatasources extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.aws.guardduty.GuarddutyOrganizationConfigurationDatasourcesS3Logs getS3Logs() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<GuarddutyOrganizationConfigurationDatasources> {
        imports.aws.guardduty.GuarddutyOrganizationConfigurationDatasourcesS3Logs s3Logs;
         ...
         * @return {@code this}
         */
        public Builder s3Logs(imports.aws.guardduty.GuarddutyOrganizationConfigurationDatasourcesS3Logs s3Logs) {
            this.s3Logs = s3Logs;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements GuarddutyOrganizationConfigurationDatasources {
        private final imports.aws.guardduty.GuarddutyOrganizationConfigurationDatasourcesS3Logs s3Logs;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.s3Logs = software.amazon.jsii.Kernel.get(this, "s3Logs", software.amazon.jsii.NativeType.forClass(imports.aws.guardduty.GuarddutyOrganizationConfigurationDatasourcesS3Logs.class));
        }
        ...
        @Override
        public final imports.aws.guardduty.GuarddutyOrganizationConfigurationDatasourcesS3Logs getS3Logs() {
            return this.s3Logs;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.guardduty.GuarddutyOrganizationConfigurationDatasources"));
