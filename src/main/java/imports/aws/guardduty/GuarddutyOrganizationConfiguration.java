 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:19.748Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.guardduty.GuarddutyOrganizationConfiguration")
public class GuarddutyOrganizationConfiguration extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.guardduty.GuarddutyOrganizationConfiguration.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public GuarddutyOrganizationConfiguration(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.guardduty.GuarddutyOrganizationConfigurationConfig config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public void putDatasources(final @org.jetbrains.annotations.NotNull imports.aws.guardduty.GuarddutyOrganizationConfigurationDatasources value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.guardduty.GuarddutyOrganizationConfigurationDatasourcesOutputReference getDatasources() {
        return software.amazon.jsii.Kernel.get(this, "datasources", software.amazon.jsii.NativeType.forClass(imports.aws.guardduty.GuarddutyOrganizationConfigurationDatasourcesOutputReference.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.guardduty.GuarddutyOrganizationConfigurationDatasources getDatasourcesInput() {
        return software.amazon.jsii.Kernel.get(this, "datasourcesInput", software.amazon.jsii.NativeType.forClass(imports.aws.guardduty.GuarddutyOrganizationConfigurationDatasources.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.guardduty.GuarddutyOrganizationConfiguration}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.guardduty.GuarddutyOrganizationConfiguration> {
        /**
        ...
        private final imports.aws.guardduty.GuarddutyOrganizationConfigurationConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.guardduty.GuarddutyOrganizationConfigurationConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param detectorId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/guardduty_organization_configuration#detector_id GuarddutyOrganizationConfiguration#detector_id}. This parameter is required.
         */
         ...
         */
        public Builder datasources(final imports.aws.guardduty.GuarddutyOrganizationConfigurationDatasources datasources) {
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/guardduty_organization_configuration#id GuarddutyOrganizationConfiguration#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.guardduty.GuarddutyOrganizationConfiguration}.
         */
        @Override
        public imports.aws.guardduty.GuarddutyOrganizationConfiguration build() {
            return new imports.aws.guardduty.GuarddutyOrganizationConfiguration(
                this.scope,
                this.id,
                this.config.build()
            );
