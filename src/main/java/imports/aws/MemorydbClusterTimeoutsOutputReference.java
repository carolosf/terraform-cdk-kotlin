...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.MemorydbClusterTimeoutsOutputReference")
public class MemorydbClusterTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected MemorydbClusterTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected MemorydbClusterTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public MemorydbClusterTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.MemorydbClusterTimeouts value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
