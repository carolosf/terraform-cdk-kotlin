...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.cloudformation.DataAwsCloudformationStack")
public class DataAwsCloudformationStack extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsCloudformationStack(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsCloudformationStack(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.cloudformation.DataAwsCloudformationStack.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsCloudformationStack(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.cloudformation.DataAwsCloudformationStackConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IResolvable getDisableRollback() {
        return software.amazon.jsii.Kernel.get(this, "disableRollback", software.amazon.jsii.NativeType.forClass(com.hashicorp.cdktf.IResolvable.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.cloudformation.DataAwsCloudformationStack}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.cloudformation.DataAwsCloudformationStack> {
        /**
        ...
        private final imports.aws.cloudformation.DataAwsCloudformationStackConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.cloudformation.DataAwsCloudformationStackConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param name Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/cloudformation_stack#name DataAwsCloudformationStack#name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/cloudformation_stack#id DataAwsCloudformationStack#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/cloudformation_stack#tags DataAwsCloudformationStack#tags}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.cloudformation.DataAwsCloudformationStack}.
         */
        @Override
        public imports.aws.cloudformation.DataAwsCloudformationStack build() {
            return new imports.aws.cloudformation.DataAwsCloudformationStack(
                this.scope,
                this.id,
                this.config.build()
            );
