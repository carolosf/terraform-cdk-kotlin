 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:19.830Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.kms.DataAwsKmsPublicKey")
public class DataAwsKmsPublicKey extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsKmsPublicKey(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsKmsPublicKey(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.kms.DataAwsKmsPublicKey.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsKmsPublicKey(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.kms.DataAwsKmsPublicKeyConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<java.lang.String> getEncryptionAlgorithms() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "encryptionAlgorithms", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(java.lang.String.class))));
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<java.lang.String> getSigningAlgorithms() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "signingAlgorithms", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(java.lang.String.class))));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.kms.DataAwsKmsPublicKey}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.kms.DataAwsKmsPublicKey> {
        /**
        ...
        private final imports.aws.kms.DataAwsKmsPublicKeyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.kms.DataAwsKmsPublicKeyConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param keyId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/kms_public_key#key_id DataAwsKmsPublicKey#key_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param grantTokens Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/kms_public_key#grant_tokens DataAwsKmsPublicKey#grant_tokens}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/kms_public_key#id DataAwsKmsPublicKey#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.kms.DataAwsKmsPublicKey}.
         */
        @Override
        public imports.aws.kms.DataAwsKmsPublicKey build() {
            return new imports.aws.kms.DataAwsKmsPublicKey(
                this.scope,
                this.id,
                this.config.build()
            );
