...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.kms.KmsCiphertext")
public class KmsCiphertext extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.kms.KmsCiphertext.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public KmsCiphertext(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.kms.KmsCiphertextConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.kms.KmsCiphertext}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.kms.KmsCiphertext> {
        /**
        ...
        private final imports.aws.kms.KmsCiphertextConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.kms.KmsCiphertextConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param context Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/kms_ciphertext#context KmsCiphertext#context}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/kms_ciphertext#id KmsCiphertext#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.kms.KmsCiphertext}.
         */
        @Override
        public imports.aws.kms.KmsCiphertext build() {
            return new imports.aws.kms.KmsCiphertext(
                this.scope,
                this.id,
                this.config.build()
            );
