...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.kms.DataAwsKmsSecretSecretOutputReference")
public class DataAwsKmsSecretSecretOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsKmsSecretSecretOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsKmsSecretSecretOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.kms.DataAwsKmsSecretSecret value) {
