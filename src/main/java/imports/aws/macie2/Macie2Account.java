...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.macie2.Macie2Account")
public class Macie2Account extends com.hashicorp.cdktf.TerraformResource {

    protected Macie2Account(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected Macie2Account(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.macie2.Macie2Account.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     * @param config
     */
    public Macie2Account(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.macie2.Macie2AccountConfig config) {
     ...
     * @param id The scoped construct ID. This parameter is required.
     */
    public Macie2Account(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
    ...
    /**
     * A fluent builder for {@link imports.aws.macie2.Macie2Account}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.macie2.Macie2Account> {
        /**
        ...
        private imports.aws.macie2.Macie2AccountConfig.Builder config;
         ...
         * <p>
         * @return {@code this}
         * @param findingPublishingFrequency Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/macie2_account#finding_publishing_frequency Macie2Account#finding_publishing_frequency}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/macie2_account#id Macie2Account#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param status Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/macie2_account#status Macie2Account#status}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.macie2.Macie2Account}.
         */
        @Override
        public imports.aws.macie2.Macie2Account build() {
            return new imports.aws.macie2.Macie2Account(
                this.scope,
                this.id,
        ...
        private imports.aws.macie2.Macie2AccountConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.macie2.Macie2AccountConfig.Builder();
            }
            return this.config;
        }
    }
