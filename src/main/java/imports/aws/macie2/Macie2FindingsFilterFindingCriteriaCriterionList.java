...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.macie2.Macie2FindingsFilterFindingCriteriaCriterionList")
public class Macie2FindingsFilterFindingCriteriaCriterionList extends com.hashicorp.cdktf.ComplexList {

    protected Macie2FindingsFilterFindingCriteriaCriterionList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected Macie2FindingsFilterFindingCriteriaCriterionList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public Macie2FindingsFilterFindingCriteriaCriterionList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.macie2.Macie2FindingsFilterFindingCriteriaCriterionOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.macie2.Macie2FindingsFilterFindingCriteriaCriterionOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.aws.macie2.Macie2FindingsFilterFindingCriteriaCriterion> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
