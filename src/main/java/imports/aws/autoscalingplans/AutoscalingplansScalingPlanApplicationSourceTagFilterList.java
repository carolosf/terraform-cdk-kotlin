...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.autoscalingplans.AutoscalingplansScalingPlanApplicationSourceTagFilterList")
public class AutoscalingplansScalingPlanApplicationSourceTagFilterList extends com.hashicorp.cdktf.ComplexList {

    protected AutoscalingplansScalingPlanApplicationSourceTagFilterList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected AutoscalingplansScalingPlanApplicationSourceTagFilterList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.autoscalingplans.AutoscalingplansScalingPlanApplicationSourceTagFilterOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.autoscalingplans.AutoscalingplansScalingPlanApplicationSourceTagFilterOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.aws.autoscalingplans.AutoscalingplansScalingPlanApplicationSourceTagFilter> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
