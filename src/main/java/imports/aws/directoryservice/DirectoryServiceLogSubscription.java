...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directoryservice.DirectoryServiceLogSubscription")
public class DirectoryServiceLogSubscription extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.directoryservice.DirectoryServiceLogSubscription.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DirectoryServiceLogSubscription(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.directoryservice.DirectoryServiceLogSubscriptionConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.directoryservice.DirectoryServiceLogSubscription}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.directoryservice.DirectoryServiceLogSubscription> {
        /**
        ...
        private final imports.aws.directoryservice.DirectoryServiceLogSubscriptionConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.directoryservice.DirectoryServiceLogSubscriptionConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/directory_service_log_subscription#id DirectoryServiceLogSubscription#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.directoryservice.DirectoryServiceLogSubscription}.
         */
        @Override
        public imports.aws.directoryservice.DirectoryServiceLogSubscription build() {
            return new imports.aws.directoryservice.DirectoryServiceLogSubscription(
                this.scope,
                this.id,
                this.config.build()
            );
