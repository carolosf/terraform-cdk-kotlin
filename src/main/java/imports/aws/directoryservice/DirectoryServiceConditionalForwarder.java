...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.directoryservice.DirectoryServiceConditionalForwarder")
public class DirectoryServiceConditionalForwarder extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.directoryservice.DirectoryServiceConditionalForwarder.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DirectoryServiceConditionalForwarder(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.directoryservice.DirectoryServiceConditionalForwarderConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.directoryservice.DirectoryServiceConditionalForwarder}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.directoryservice.DirectoryServiceConditionalForwarder> {
        /**
        ...
        private final imports.aws.directoryservice.DirectoryServiceConditionalForwarderConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.directoryservice.DirectoryServiceConditionalForwarderConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/directory_service_conditional_forwarder#id DirectoryServiceConditionalForwarder#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.directoryservice.DirectoryServiceConditionalForwarder}.
         */
        @Override
        public imports.aws.directoryservice.DirectoryServiceConditionalForwarder build() {
            return new imports.aws.directoryservice.DirectoryServiceConditionalForwarder(
                this.scope,
                this.id,
                this.config.build()
            );
