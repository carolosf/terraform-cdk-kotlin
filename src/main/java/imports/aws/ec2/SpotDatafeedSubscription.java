...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.SpotDatafeedSubscription")
public class SpotDatafeedSubscription extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.ec2.SpotDatafeedSubscription.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public SpotDatafeedSubscription(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.ec2.SpotDatafeedSubscriptionConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.ec2.SpotDatafeedSubscription}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ec2.SpotDatafeedSubscription> {
        /**
        ...
        private final imports.aws.ec2.SpotDatafeedSubscriptionConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.ec2.SpotDatafeedSubscriptionConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/spot_datafeed_subscription#id SpotDatafeedSubscription#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param prefix Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/spot_datafeed_subscription#prefix SpotDatafeedSubscription#prefix}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.ec2.SpotDatafeedSubscription}.
         */
        @Override
        public imports.aws.ec2.SpotDatafeedSubscription build() {
            return new imports.aws.ec2.SpotDatafeedSubscription(
                this.scope,
                this.id,
                this.config.build()
            );
