...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.AmiEbsBlockDeviceOutputReference")
public class AmiEbsBlockDeviceOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected AmiEbsBlockDeviceOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected AmiEbsBlockDeviceOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.ec2.AmiEbsBlockDevice value) {
