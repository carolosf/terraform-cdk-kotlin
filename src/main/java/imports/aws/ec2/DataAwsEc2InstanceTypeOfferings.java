 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:19.509Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.DataAwsEc2InstanceTypeOfferings")
public class DataAwsEc2InstanceTypeOfferings extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.ec2.DataAwsEc2InstanceTypeOfferings.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     * @param config
     */
    public DataAwsEc2InstanceTypeOfferings(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.ec2.DataAwsEc2InstanceTypeOfferingsConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.ec2.DataAwsEc2InstanceTypeOfferingsFilterList getFilter() {
        return software.amazon.jsii.Kernel.get(this, "filter", software.amazon.jsii.NativeType.forClass(imports.aws.ec2.DataAwsEc2InstanceTypeOfferingsFilterList.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<java.lang.String> getLocationTypes() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "locationTypes", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(java.lang.String.class))));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.ec2.DataAwsEc2InstanceTypeOfferings}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ec2.DataAwsEc2InstanceTypeOfferings> {
        /**
        ...
        private imports.aws.ec2.DataAwsEc2InstanceTypeOfferingsConfig.Builder config;
         ...
         * @param filter filter block. This parameter is required.
         */
        public Builder filter(final java.util.List<? extends imports.aws.ec2.DataAwsEc2InstanceTypeOfferingsFilter> filter) {
            this.config().filter(filter);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ec2_instance_type_offerings#id DataAwsEc2InstanceTypeOfferings#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param locationType Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ec2_instance_type_offerings#location_type DataAwsEc2InstanceTypeOfferings#location_type}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.ec2.DataAwsEc2InstanceTypeOfferings}.
         */
        @Override
        public imports.aws.ec2.DataAwsEc2InstanceTypeOfferings build() {
            return new imports.aws.ec2.DataAwsEc2InstanceTypeOfferings(
                this.scope,
                this.id,
        ...
        private imports.aws.ec2.DataAwsEc2InstanceTypeOfferingsConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.ec2.DataAwsEc2InstanceTypeOfferingsConfig.Builder();
            }
            return this.config;
        }
    }
