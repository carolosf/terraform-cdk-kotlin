...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.DataAwsKeyPairFilterOutputReference")
public class DataAwsKeyPairFilterOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsKeyPairFilterOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsKeyPairFilterOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.ec2.DataAwsKeyPairFilter value) {
