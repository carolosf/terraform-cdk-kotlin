...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.DataAwsEc2TransitGatewayVpnAttachment")
public class DataAwsEc2TransitGatewayVpnAttachment extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.ec2.DataAwsEc2TransitGatewayVpnAttachment.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     * @param config
     */
    public DataAwsEc2TransitGatewayVpnAttachment(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.ec2.DataAwsEc2TransitGatewayVpnAttachmentConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.ec2.DataAwsEc2TransitGatewayVpnAttachmentFilterList getFilter() {
        return software.amazon.jsii.Kernel.get(this, "filter", software.amazon.jsii.NativeType.forClass(imports.aws.ec2.DataAwsEc2TransitGatewayVpnAttachmentFilterList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.ec2.DataAwsEc2TransitGatewayVpnAttachment}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ec2.DataAwsEc2TransitGatewayVpnAttachment> {
        /**
        ...
        private imports.aws.ec2.DataAwsEc2TransitGatewayVpnAttachmentConfig.Builder config;
         ...
         * @param filter filter block. This parameter is required.
         */
        public Builder filter(final java.util.List<? extends imports.aws.ec2.DataAwsEc2TransitGatewayVpnAttachmentFilter> filter) {
            this.config().filter(filter);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ec2_transit_gateway_vpn_attachment#id DataAwsEc2TransitGatewayVpnAttachment#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ec2_transit_gateway_vpn_attachment#tags DataAwsEc2TransitGatewayVpnAttachment#tags}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param transitGatewayId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ec2_transit_gateway_vpn_attachment#transit_gateway_id DataAwsEc2TransitGatewayVpnAttachment#transit_gateway_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param vpnConnectionId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ec2_transit_gateway_vpn_attachment#vpn_connection_id DataAwsEc2TransitGatewayVpnAttachment#vpn_connection_id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.ec2.DataAwsEc2TransitGatewayVpnAttachment}.
         */
        @Override
        public imports.aws.ec2.DataAwsEc2TransitGatewayVpnAttachment build() {
            return new imports.aws.ec2.DataAwsEc2TransitGatewayVpnAttachment(
                this.scope,
                this.id,
        ...
        private imports.aws.ec2.DataAwsEc2TransitGatewayVpnAttachmentConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.ec2.DataAwsEc2TransitGatewayVpnAttachmentConfig.Builder();
            }
            return this.config;
        }
    }
