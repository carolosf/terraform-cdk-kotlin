...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.DataAwsEc2TransitGatewayRouteTableFilterOutputReference")
public class DataAwsEc2TransitGatewayRouteTableFilterOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsEc2TransitGatewayRouteTableFilterOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsEc2TransitGatewayRouteTableFilterOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.ec2.DataAwsEc2TransitGatewayRouteTableFilter value) {
