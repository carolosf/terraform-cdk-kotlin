...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.DataAwsEc2TransitGatewayRouteTableFilterList")
public class DataAwsEc2TransitGatewayRouteTableFilterList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsEc2TransitGatewayRouteTableFilterList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsEc2TransitGatewayRouteTableFilterList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public DataAwsEc2TransitGatewayRouteTableFilterList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.ec2.DataAwsEc2TransitGatewayRouteTableFilterOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.ec2.DataAwsEc2TransitGatewayRouteTableFilterOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.aws.ec2.DataAwsEc2TransitGatewayRouteTableFilter> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
