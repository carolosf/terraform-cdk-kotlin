...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.Ec2LocalGatewayRoute")
public class Ec2LocalGatewayRoute extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.ec2.Ec2LocalGatewayRoute.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public Ec2LocalGatewayRoute(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.ec2.Ec2LocalGatewayRouteConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable java.lang.String getLocalGatewayVirtualInterfaceGroupIdInput() {
    ...
    /**
     * A fluent builder for {@link imports.aws.ec2.Ec2LocalGatewayRoute}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ec2.Ec2LocalGatewayRoute> {
        /**
        ...
        private final imports.aws.ec2.Ec2LocalGatewayRouteConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.ec2.Ec2LocalGatewayRouteConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param destinationCidrBlock Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/ec2_local_gateway_route#destination_cidr_block Ec2LocalGatewayRoute#destination_cidr_block}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param localGatewayRouteTableId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/ec2_local_gateway_route#local_gateway_route_table_id Ec2LocalGatewayRoute#local_gateway_route_table_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param localGatewayVirtualInterfaceGroupId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/ec2_local_gateway_route#local_gateway_virtual_interface_group_id Ec2LocalGatewayRoute#local_gateway_virtual_interface_group_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/ec2_local_gateway_route#id Ec2LocalGatewayRoute#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.ec2.Ec2LocalGatewayRoute}.
         */
        @Override
        public imports.aws.ec2.Ec2LocalGatewayRoute build() {
            return new imports.aws.ec2.Ec2LocalGatewayRoute(
                this.scope,
                this.id,
                this.config.build()
            );
