...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.SnapshotCreateVolumePermission")
public class SnapshotCreateVolumePermission extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.ec2.SnapshotCreateVolumePermission.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public SnapshotCreateVolumePermission(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.ec2.SnapshotCreateVolumePermissionConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.ec2.SnapshotCreateVolumePermission}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ec2.SnapshotCreateVolumePermission> {
        /**
        ...
        private final imports.aws.ec2.SnapshotCreateVolumePermissionConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.ec2.SnapshotCreateVolumePermissionConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/snapshot_create_volume_permission#id SnapshotCreateVolumePermission#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.ec2.SnapshotCreateVolumePermission}.
         */
        @Override
        public imports.aws.ec2.SnapshotCreateVolumePermission build() {
            return new imports.aws.ec2.SnapshotCreateVolumePermission(
                this.scope,
                this.id,
                this.config.build()
            );
