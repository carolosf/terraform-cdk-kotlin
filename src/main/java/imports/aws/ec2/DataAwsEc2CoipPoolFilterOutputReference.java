...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.DataAwsEc2CoipPoolFilterOutputReference")
public class DataAwsEc2CoipPoolFilterOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsEc2CoipPoolFilterOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsEc2CoipPoolFilterOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.ec2.DataAwsEc2CoipPoolFilter value) {
