...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.AmiEphemeralBlockDeviceOutputReference")
public class AmiEphemeralBlockDeviceOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected AmiEphemeralBlockDeviceOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected AmiEphemeralBlockDeviceOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.ec2.AmiEphemeralBlockDevice value) {
