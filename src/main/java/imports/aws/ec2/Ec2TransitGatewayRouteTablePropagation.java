...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.Ec2TransitGatewayRouteTablePropagation")
public class Ec2TransitGatewayRouteTablePropagation extends com.hashicorp.cdktf.TerraformResource {

    protected Ec2TransitGatewayRouteTablePropagation(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected Ec2TransitGatewayRouteTablePropagation(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.ec2.Ec2TransitGatewayRouteTablePropagation.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public Ec2TransitGatewayRouteTablePropagation(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.ec2.Ec2TransitGatewayRouteTablePropagationConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.ec2.Ec2TransitGatewayRouteTablePropagation}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ec2.Ec2TransitGatewayRouteTablePropagation> {
        /**
        ...
        private final imports.aws.ec2.Ec2TransitGatewayRouteTablePropagationConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.ec2.Ec2TransitGatewayRouteTablePropagationConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param transitGatewayAttachmentId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/ec2_transit_gateway_route_table_propagation#transit_gateway_attachment_id Ec2TransitGatewayRouteTablePropagation#transit_gateway_attachment_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param transitGatewayRouteTableId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/ec2_transit_gateway_route_table_propagation#transit_gateway_route_table_id Ec2TransitGatewayRouteTablePropagation#transit_gateway_route_table_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/ec2_transit_gateway_route_table_propagation#id Ec2TransitGatewayRouteTablePropagation#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.ec2.Ec2TransitGatewayRouteTablePropagation}.
         */
        @Override
        public imports.aws.ec2.Ec2TransitGatewayRouteTablePropagation build() {
            return new imports.aws.ec2.Ec2TransitGatewayRouteTablePropagation(
                this.scope,
                this.id,
                this.config.build()
            );
