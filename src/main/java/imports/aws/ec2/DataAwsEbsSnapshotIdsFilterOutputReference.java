...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.DataAwsEbsSnapshotIdsFilterOutputReference")
public class DataAwsEbsSnapshotIdsFilterOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsEbsSnapshotIdsFilterOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsEbsSnapshotIdsFilterOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.ec2.DataAwsEbsSnapshotIdsFilter value) {
