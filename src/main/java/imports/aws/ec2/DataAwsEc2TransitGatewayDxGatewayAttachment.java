 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:19.520Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.DataAwsEc2TransitGatewayDxGatewayAttachment")
public class DataAwsEc2TransitGatewayDxGatewayAttachment extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsEc2TransitGatewayDxGatewayAttachment(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsEc2TransitGatewayDxGatewayAttachment(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.ec2.DataAwsEc2TransitGatewayDxGatewayAttachment.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     * @param config
     */
    public DataAwsEc2TransitGatewayDxGatewayAttachment(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.ec2.DataAwsEc2TransitGatewayDxGatewayAttachmentConfig config) {
     ...
     * @param id The scoped construct ID. This parameter is required.
     */
    public DataAwsEc2TransitGatewayDxGatewayAttachment(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.ec2.DataAwsEc2TransitGatewayDxGatewayAttachmentFilterList getFilter() {
        return software.amazon.jsii.Kernel.get(this, "filter", software.amazon.jsii.NativeType.forClass(imports.aws.ec2.DataAwsEc2TransitGatewayDxGatewayAttachmentFilterList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.ec2.DataAwsEc2TransitGatewayDxGatewayAttachment}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ec2.DataAwsEc2TransitGatewayDxGatewayAttachment> {
        /**
        ...
        private imports.aws.ec2.DataAwsEc2TransitGatewayDxGatewayAttachmentConfig.Builder config;
         ...
         * <p>
         * @return {@code this}
         * @param dxGatewayId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ec2_transit_gateway_dx_gateway_attachment#dx_gateway_id DataAwsEc2TransitGatewayDxGatewayAttachment#dx_gateway_id}. This parameter is required.
         */
         ...
         * @param filter filter block. This parameter is required.
         */
        public Builder filter(final java.util.List<? extends imports.aws.ec2.DataAwsEc2TransitGatewayDxGatewayAttachmentFilter> filter) {
            this.config().filter(filter);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ec2_transit_gateway_dx_gateway_attachment#id DataAwsEc2TransitGatewayDxGatewayAttachment#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ec2_transit_gateway_dx_gateway_attachment#tags DataAwsEc2TransitGatewayDxGatewayAttachment#tags}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param transitGatewayId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ec2_transit_gateway_dx_gateway_attachment#transit_gateway_id DataAwsEc2TransitGatewayDxGatewayAttachment#transit_gateway_id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.ec2.DataAwsEc2TransitGatewayDxGatewayAttachment}.
         */
        @Override
        public imports.aws.ec2.DataAwsEc2TransitGatewayDxGatewayAttachment build() {
            return new imports.aws.ec2.DataAwsEc2TransitGatewayDxGatewayAttachment(
                this.scope,
                this.id,
        ...
        private imports.aws.ec2.DataAwsEc2TransitGatewayDxGatewayAttachmentConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.ec2.DataAwsEc2TransitGatewayDxGatewayAttachmentConfig.Builder();
            }
            return this.config;
        }
    }
