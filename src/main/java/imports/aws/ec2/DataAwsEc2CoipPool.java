...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.DataAwsEc2CoipPool")
public class DataAwsEc2CoipPool extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.ec2.DataAwsEc2CoipPool.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     * @param config
     */
    public DataAwsEc2CoipPool(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.ec2.DataAwsEc2CoipPoolConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.ec2.DataAwsEc2CoipPoolFilterList getFilter() {
        return software.amazon.jsii.Kernel.get(this, "filter", software.amazon.jsii.NativeType.forClass(imports.aws.ec2.DataAwsEc2CoipPoolFilterList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.ec2.DataAwsEc2CoipPool}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ec2.DataAwsEc2CoipPool> {
        /**
        ...
        private imports.aws.ec2.DataAwsEc2CoipPoolConfig.Builder config;
         ...
         * @param filter filter block. This parameter is required.
         */
        public Builder filter(final java.util.List<? extends imports.aws.ec2.DataAwsEc2CoipPoolFilter> filter) {
            this.config().filter(filter);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ec2_coip_pool#id DataAwsEc2CoipPool#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param localGatewayRouteTableId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ec2_coip_pool#local_gateway_route_table_id DataAwsEc2CoipPool#local_gateway_route_table_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param poolId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ec2_coip_pool#pool_id DataAwsEc2CoipPool#pool_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ec2_coip_pool#tags DataAwsEc2CoipPool#tags}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.ec2.DataAwsEc2CoipPool}.
         */
        @Override
        public imports.aws.ec2.DataAwsEc2CoipPool build() {
            return new imports.aws.ec2.DataAwsEc2CoipPool(
                this.scope,
                this.id,
        ...
        private imports.aws.ec2.DataAwsEc2CoipPoolConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.ec2.DataAwsEc2CoipPoolConfig.Builder();
            }
            return this.config;
        }
    }
