...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.Ec2AvailabilityZoneGroup")
public class Ec2AvailabilityZoneGroup extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.ec2.Ec2AvailabilityZoneGroup.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public Ec2AvailabilityZoneGroup(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.ec2.Ec2AvailabilityZoneGroupConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.ec2.Ec2AvailabilityZoneGroup}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ec2.Ec2AvailabilityZoneGroup> {
        /**
        ...
        private final imports.aws.ec2.Ec2AvailabilityZoneGroupConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.ec2.Ec2AvailabilityZoneGroupConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/ec2_availability_zone_group#id Ec2AvailabilityZoneGroup#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.ec2.Ec2AvailabilityZoneGroup}.
         */
        @Override
        public imports.aws.ec2.Ec2AvailabilityZoneGroup build() {
            return new imports.aws.ec2.Ec2AvailabilityZoneGroup(
                this.scope,
                this.id,
                this.config.build()
            );
