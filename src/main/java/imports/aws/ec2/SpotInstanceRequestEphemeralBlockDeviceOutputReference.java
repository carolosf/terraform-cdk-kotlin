...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.SpotInstanceRequestEphemeralBlockDeviceOutputReference")
public class SpotInstanceRequestEphemeralBlockDeviceOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected SpotInstanceRequestEphemeralBlockDeviceOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected SpotInstanceRequestEphemeralBlockDeviceOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.ec2.SpotInstanceRequestEphemeralBlockDevice value) {
