...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.AmiCopyEbsBlockDeviceOutputReference")
public class AmiCopyEbsBlockDeviceOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected AmiCopyEbsBlockDeviceOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected AmiCopyEbsBlockDeviceOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.ec2.AmiCopyEbsBlockDevice value) {
