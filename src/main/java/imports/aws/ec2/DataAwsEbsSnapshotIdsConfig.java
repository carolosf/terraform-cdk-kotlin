...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.DataAwsEbsSnapshotIdsConfig")
...
public interface DataAwsEbsSnapshotIdsConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<DataAwsEbsSnapshotIdsConfig> {
         ...
         * @return {@code this}
         */
        public Builder filter(java.util.List<? extends imports.aws.ec2.DataAwsEbsSnapshotIdsFilter> filter) {
            this.filter = filter;
            return this;
        }

        /**
         * Sets the value of {@link DataAwsEbsSnapshotIdsConfig#getId}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ebs_snapshot_ids#id DataAwsEbsSnapshotIds#id}.
         *           Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2.
         *           If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
         * @return {@code this}
         */
         ...
         * @param restorableByUserIds Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ebs_snapshot_ids#restorable_by_user_ids DataAwsEbsSnapshotIds#restorable_by_user_ids}.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link DataAwsEbsSnapshotIdsConfig#getConnection}
        ...
        /**
         * Sets the value of {@link DataAwsEbsSnapshotIdsConfig#getForEach}
        ...
        /**
         * Sets the value of {@link DataAwsEbsSnapshotIdsConfig#getProvisioners}
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DataAwsEbsSnapshotIdsConfig {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.ec2.DataAwsEbsSnapshotIdsConfig"));
