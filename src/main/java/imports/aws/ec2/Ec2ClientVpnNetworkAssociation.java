...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.Ec2ClientVpnNetworkAssociation")
public class Ec2ClientVpnNetworkAssociation extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.ec2.Ec2ClientVpnNetworkAssociation.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public Ec2ClientVpnNetworkAssociation(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.ec2.Ec2ClientVpnNetworkAssociationConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.ec2.Ec2ClientVpnNetworkAssociation}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ec2.Ec2ClientVpnNetworkAssociation> {
        /**
        ...
        private final imports.aws.ec2.Ec2ClientVpnNetworkAssociationConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.ec2.Ec2ClientVpnNetworkAssociationConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/ec2_client_vpn_network_association#id Ec2ClientVpnNetworkAssociation#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param securityGroups Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/ec2_client_vpn_network_association#security_groups Ec2ClientVpnNetworkAssociation#security_groups}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.ec2.Ec2ClientVpnNetworkAssociation}.
         */
        @Override
        public imports.aws.ec2.Ec2ClientVpnNetworkAssociation build() {
            return new imports.aws.ec2.Ec2ClientVpnNetworkAssociation(
                this.scope,
                this.id,
                this.config.build()
            );
