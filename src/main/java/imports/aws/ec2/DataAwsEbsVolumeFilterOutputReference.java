...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.DataAwsEbsVolumeFilterOutputReference")
public class DataAwsEbsVolumeFilterOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsEbsVolumeFilterOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsEbsVolumeFilterOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.ec2.DataAwsEbsVolumeFilter value) {
