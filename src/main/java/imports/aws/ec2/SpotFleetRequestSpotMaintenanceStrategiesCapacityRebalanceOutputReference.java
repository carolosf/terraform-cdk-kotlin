...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.SpotFleetRequestSpotMaintenanceStrategiesCapacityRebalanceOutputReference")
public class SpotFleetRequestSpotMaintenanceStrategiesCapacityRebalanceOutputReference extends com.hashicorp.cdktf.ComplexObject {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.ec2.SpotFleetRequestSpotMaintenanceStrategiesCapacityRebalance getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.ec2.SpotFleetRequestSpotMaintenanceStrategiesCapacityRebalance.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.ec2.SpotFleetRequestSpotMaintenanceStrategiesCapacityRebalance value) {
