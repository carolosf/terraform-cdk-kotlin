...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.DataAwsEc2TransitGatewayDxGatewayAttachmentFilterList")
public class DataAwsEc2TransitGatewayDxGatewayAttachmentFilterList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsEc2TransitGatewayDxGatewayAttachmentFilterList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsEc2TransitGatewayDxGatewayAttachmentFilterList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.ec2.DataAwsEc2TransitGatewayDxGatewayAttachmentFilterOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.ec2.DataAwsEc2TransitGatewayDxGatewayAttachmentFilterOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.aws.ec2.DataAwsEc2TransitGatewayDxGatewayAttachmentFilter> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
