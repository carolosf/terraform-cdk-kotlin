...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.DataAwsLaunchTemplateFilterOutputReference")
public class DataAwsLaunchTemplateFilterOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsLaunchTemplateFilterOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsLaunchTemplateFilterOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.ec2.DataAwsLaunchTemplateFilter value) {
