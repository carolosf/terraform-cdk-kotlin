...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.DataAwsEc2LocalGatewayVirtualInterfaceGroup")
public class DataAwsEc2LocalGatewayVirtualInterfaceGroup extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.ec2.DataAwsEc2LocalGatewayVirtualInterfaceGroup.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     * @param config
     */
    public DataAwsEc2LocalGatewayVirtualInterfaceGroup(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.ec2.DataAwsEc2LocalGatewayVirtualInterfaceGroupConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.ec2.DataAwsEc2LocalGatewayVirtualInterfaceGroupFilterList getFilter() {
        return software.amazon.jsii.Kernel.get(this, "filter", software.amazon.jsii.NativeType.forClass(imports.aws.ec2.DataAwsEc2LocalGatewayVirtualInterfaceGroupFilterList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.ec2.DataAwsEc2LocalGatewayVirtualInterfaceGroup}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ec2.DataAwsEc2LocalGatewayVirtualInterfaceGroup> {
        /**
        ...
        private imports.aws.ec2.DataAwsEc2LocalGatewayVirtualInterfaceGroupConfig.Builder config;
         ...
         * @param filter filter block. This parameter is required.
         */
        public Builder filter(final java.util.List<? extends imports.aws.ec2.DataAwsEc2LocalGatewayVirtualInterfaceGroupFilter> filter) {
            this.config().filter(filter);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ec2_local_gateway_virtual_interface_group#id DataAwsEc2LocalGatewayVirtualInterfaceGroup#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param localGatewayId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ec2_local_gateway_virtual_interface_group#local_gateway_id DataAwsEc2LocalGatewayVirtualInterfaceGroup#local_gateway_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ec2_local_gateway_virtual_interface_group#tags DataAwsEc2LocalGatewayVirtualInterfaceGroup#tags}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.ec2.DataAwsEc2LocalGatewayVirtualInterfaceGroup}.
         */
        @Override
        public imports.aws.ec2.DataAwsEc2LocalGatewayVirtualInterfaceGroup build() {
            return new imports.aws.ec2.DataAwsEc2LocalGatewayVirtualInterfaceGroup(
                this.scope,
                this.id,
        ...
        private imports.aws.ec2.DataAwsEc2LocalGatewayVirtualInterfaceGroupConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.ec2.DataAwsEc2LocalGatewayVirtualInterfaceGroupConfig.Builder();
            }
            return this.config;
        }
    }
