...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ec2.Ec2TrafficMirrorFilterRuleSourcePortRangeOutputReference")
public class Ec2TrafficMirrorFilterRuleSourcePortRangeOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected Ec2TrafficMirrorFilterRuleSourcePortRangeOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected Ec2TrafficMirrorFilterRuleSourcePortRangeOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public Ec2TrafficMirrorFilterRuleSourcePortRangeOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.ec2.Ec2TrafficMirrorFilterRuleSourcePortRange getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.ec2.Ec2TrafficMirrorFilterRuleSourcePortRange.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.ec2.Ec2TrafficMirrorFilterRuleSourcePortRange value) {
