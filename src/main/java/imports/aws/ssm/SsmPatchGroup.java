...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ssm.SsmPatchGroup")
public class SsmPatchGroup extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.ssm.SsmPatchGroup.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public SsmPatchGroup(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.ssm.SsmPatchGroupConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable java.lang.String getBaselineIdInput() {
    ...
    public @org.jetbrains.annotations.Nullable java.lang.String getPatchGroupInput() {
    ...
    /**
     * A fluent builder for {@link imports.aws.ssm.SsmPatchGroup}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ssm.SsmPatchGroup> {
        /**
        ...
        private final imports.aws.ssm.SsmPatchGroupConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.ssm.SsmPatchGroupConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/ssm_patch_group#id SsmPatchGroup#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.ssm.SsmPatchGroup}.
         */
        @Override
        public imports.aws.ssm.SsmPatchGroup build() {
            return new imports.aws.ssm.SsmPatchGroup(
                this.scope,
                this.id,
                this.config.build()
            );
