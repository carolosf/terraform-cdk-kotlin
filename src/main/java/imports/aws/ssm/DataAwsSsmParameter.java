...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ssm.DataAwsSsmParameter")
public class DataAwsSsmParameter extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsSsmParameter(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsSsmParameter(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.ssm.DataAwsSsmParameter.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsSsmParameter(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.ssm.DataAwsSsmParameterConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.ssm.DataAwsSsmParameter}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ssm.DataAwsSsmParameter> {
        /**
        ...
        private final imports.aws.ssm.DataAwsSsmParameterConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.ssm.DataAwsSsmParameterConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ssm_parameter#id DataAwsSsmParameter#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param withDecryption Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ssm_parameter#with_decryption DataAwsSsmParameter#with_decryption}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.ssm.DataAwsSsmParameter}.
         */
        @Override
        public imports.aws.ssm.DataAwsSsmParameter build() {
            return new imports.aws.ssm.DataAwsSsmParameter(
                this.scope,
                this.id,
                this.config.build()
            );
