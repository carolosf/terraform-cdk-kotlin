...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.globalaccelerator.GlobalacceleratorAcceleratorTimeouts")
@software.amazon.jsii.Jsii.Proxy(GlobalacceleratorAcceleratorTimeouts.Jsii$Proxy.class)
public interface GlobalacceleratorAcceleratorTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link GlobalacceleratorAcceleratorTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link GlobalacceleratorAcceleratorTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<GlobalacceleratorAcceleratorTimeouts> {
        java.lang.String create;
        java.lang.String update;

        /**
         * Sets the value of {@link GlobalacceleratorAcceleratorTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link GlobalacceleratorAcceleratorTimeouts#getUpdate}
         ...
         * @return a new instance of {@link GlobalacceleratorAcceleratorTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public GlobalacceleratorAcceleratorTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link GlobalacceleratorAcceleratorTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements GlobalacceleratorAcceleratorTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.globalaccelerator.GlobalacceleratorAcceleratorTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            GlobalacceleratorAcceleratorTimeouts.Jsii$Proxy that = (GlobalacceleratorAcceleratorTimeouts.Jsii$Proxy) o;
