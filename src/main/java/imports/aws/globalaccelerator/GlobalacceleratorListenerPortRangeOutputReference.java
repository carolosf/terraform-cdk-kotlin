...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.globalaccelerator.GlobalacceleratorListenerPortRangeOutputReference")
public class GlobalacceleratorListenerPortRangeOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected GlobalacceleratorListenerPortRangeOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected GlobalacceleratorListenerPortRangeOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.globalaccelerator.GlobalacceleratorListenerPortRange value) {
