...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ram.RamResourceAssociation")
public class RamResourceAssociation extends com.hashicorp.cdktf.TerraformResource {

    protected RamResourceAssociation(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RamResourceAssociation(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.ram.RamResourceAssociation.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public RamResourceAssociation(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.ram.RamResourceAssociationConfig config) {
    ...
    public @org.jetbrains.annotations.Nullable java.lang.String getResourceShareArnInput() {
    ...
    /**
     * A fluent builder for {@link imports.aws.ram.RamResourceAssociation}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ram.RamResourceAssociation> {
        /**
        ...
        private final imports.aws.ram.RamResourceAssociationConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.ram.RamResourceAssociationConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/ram_resource_association#id RamResourceAssociation#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.ram.RamResourceAssociation}.
         */
        @Override
        public imports.aws.ram.RamResourceAssociation build() {
            return new imports.aws.ram.RamResourceAssociation(
                this.scope,
                this.id,
                this.config.build()
            );
