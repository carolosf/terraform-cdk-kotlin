...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ram.RamResourceShareAccepterTimeoutsOutputReference")
public class RamResourceShareAccepterTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected RamResourceShareAccepterTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RamResourceShareAccepterTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public RamResourceShareAccepterTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.ram.RamResourceShareAccepterTimeouts value) {
