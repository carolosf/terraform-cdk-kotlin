 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:20.314Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.wafregional.WafregionalRateBasedRule")
public class WafregionalRateBasedRule extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.wafregional.WafregionalRateBasedRule.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public WafregionalRateBasedRule(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.wafregional.WafregionalRateBasedRuleConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.wafregional.WafregionalRateBasedRulePredicateList getPredicate() {
        return software.amazon.jsii.Kernel.get(this, "predicate", software.amazon.jsii.NativeType.forClass(imports.aws.wafregional.WafregionalRateBasedRulePredicateList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.wafregional.WafregionalRateBasedRule}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.wafregional.WafregionalRateBasedRule> {
        /**
        ...
        private final imports.aws.wafregional.WafregionalRateBasedRuleConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.wafregional.WafregionalRateBasedRuleConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/wafregional_rate_based_rule#id WafregionalRateBasedRule#id}. This parameter is required.
         */
         ...
         * @param predicate predicate block. This parameter is required.
         */
        public Builder predicate(final java.util.List<? extends imports.aws.wafregional.WafregionalRateBasedRulePredicate> predicate) {
            this.config.predicate(predicate);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/wafregional_rate_based_rule#tags WafregionalRateBasedRule#tags}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tagsAll Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/wafregional_rate_based_rule#tags_all WafregionalRateBasedRule#tags_all}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.wafregional.WafregionalRateBasedRule}.
         */
        @Override
        public imports.aws.wafregional.WafregionalRateBasedRule build() {
            return new imports.aws.wafregional.WafregionalRateBasedRule(
                this.scope,
                this.id,
                this.config.build()
            );
