...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.wafregional.WafregionalWebAclAssociation")
public class WafregionalWebAclAssociation extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.wafregional.WafregionalWebAclAssociation.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public WafregionalWebAclAssociation(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.wafregional.WafregionalWebAclAssociationConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.wafregional.WafregionalWebAclAssociation}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.wafregional.WafregionalWebAclAssociation> {
        /**
        ...
        private final imports.aws.wafregional.WafregionalWebAclAssociationConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.wafregional.WafregionalWebAclAssociationConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/wafregional_web_acl_association#id WafregionalWebAclAssociation#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.wafregional.WafregionalWebAclAssociation}.
         */
        @Override
        public imports.aws.wafregional.WafregionalWebAclAssociation build() {
            return new imports.aws.wafregional.WafregionalWebAclAssociation(
                this.scope,
                this.id,
                this.config.build()
            );
