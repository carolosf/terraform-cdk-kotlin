...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.wafregional.WafregionalWebAclLoggingConfigurationRedactedFields")
...
public interface WafregionalWebAclLoggingConfigurationRedactedFields extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<WafregionalWebAclLoggingConfigurationRedactedFields> {
         ...
         * @return {@code this}
         */
        public Builder fieldToMatch(com.hashicorp.cdktf.IResolvable fieldToMatch) {
         ...
         * @return {@code this}
         */
        public Builder fieldToMatch(java.util.List<? extends imports.aws.wafregional.WafregionalWebAclLoggingConfigurationRedactedFieldsFieldToMatch> fieldToMatch) {
            this.fieldToMatch = fieldToMatch;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements WafregionalWebAclLoggingConfigurationRedactedFields {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.wafregional.WafregionalWebAclLoggingConfigurationRedactedFields"));
