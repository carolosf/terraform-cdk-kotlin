...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.CloudsearchDomainServiceAccessPolicyTimeoutsOutputReference")
public class CloudsearchDomainServiceAccessPolicyTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected CloudsearchDomainServiceAccessPolicyTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected CloudsearchDomainServiceAccessPolicyTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public CloudsearchDomainServiceAccessPolicyTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.CloudsearchDomainServiceAccessPolicyTimeouts value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
