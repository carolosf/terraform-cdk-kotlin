...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.s3.S3BucketObjectLockConfigurationRule")
...
public interface S3BucketObjectLockConfigurationRule extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull imports.aws.s3.S3BucketObjectLockConfigurationRuleDefaultRetention getDefaultRetention();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<S3BucketObjectLockConfigurationRule> {
        imports.aws.s3.S3BucketObjectLockConfigurationRuleDefaultRetention defaultRetention;
         ...
         * @return {@code this}
         */
        public Builder defaultRetention(imports.aws.s3.S3BucketObjectLockConfigurationRuleDefaultRetention defaultRetention) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements S3BucketObjectLockConfigurationRule {
        private final imports.aws.s3.S3BucketObjectLockConfigurationRuleDefaultRetention defaultRetention;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.defaultRetention = software.amazon.jsii.Kernel.get(this, "defaultRetention", software.amazon.jsii.NativeType.forClass(imports.aws.s3.S3BucketObjectLockConfigurationRuleDefaultRetention.class));
        }
        ...
        @Override
        public final imports.aws.s3.S3BucketObjectLockConfigurationRuleDefaultRetention getDefaultRetention() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.s3.S3BucketObjectLockConfigurationRule"));
