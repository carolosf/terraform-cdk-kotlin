...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.s3.S3BucketLifecycleRuleNoncurrentVersionTransition")
@software.amazon.jsii.Jsii.Proxy(S3BucketLifecycleRuleNoncurrentVersionTransition.Jsii$Proxy.class)
public interface S3BucketLifecycleRuleNoncurrentVersionTransition extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link S3BucketLifecycleRuleNoncurrentVersionTransition}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link S3BucketLifecycleRuleNoncurrentVersionTransition}
     */
    public static final class Builder implements software.amazon.jsii.Builder<S3BucketLifecycleRuleNoncurrentVersionTransition> {
        java.lang.String storageClass;
        java.lang.Number days;

        /**
         * Sets the value of {@link S3BucketLifecycleRuleNoncurrentVersionTransition#getStorageClass}
        ...
        /**
         * Sets the value of {@link S3BucketLifecycleRuleNoncurrentVersionTransition#getDays}
         ...
         * @return a new instance of {@link S3BucketLifecycleRuleNoncurrentVersionTransition}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public S3BucketLifecycleRuleNoncurrentVersionTransition build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link S3BucketLifecycleRuleNoncurrentVersionTransition}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements S3BucketLifecycleRuleNoncurrentVersionTransition {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.s3.S3BucketLifecycleRuleNoncurrentVersionTransition"));
        ...
        public final boolean equals(final Object o) {
            ...
            S3BucketLifecycleRuleNoncurrentVersionTransition.Jsii$Proxy that = (S3BucketLifecycleRuleNoncurrentVersionTransition.Jsii$Proxy) o;
