...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.s3.S3ControlMultiRegionAccessPointTimeouts")
@software.amazon.jsii.Jsii.Proxy(S3ControlMultiRegionAccessPointTimeouts.Jsii$Proxy.class)
public interface S3ControlMultiRegionAccessPointTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link S3ControlMultiRegionAccessPointTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link S3ControlMultiRegionAccessPointTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<S3ControlMultiRegionAccessPointTimeouts> {
        ...
        /**
         * Sets the value of {@link S3ControlMultiRegionAccessPointTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link S3ControlMultiRegionAccessPointTimeouts#getDelete}
         ...
         * @return a new instance of {@link S3ControlMultiRegionAccessPointTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public S3ControlMultiRegionAccessPointTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link S3ControlMultiRegionAccessPointTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements S3ControlMultiRegionAccessPointTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.s3.S3ControlMultiRegionAccessPointTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            S3ControlMultiRegionAccessPointTimeouts.Jsii$Proxy that = (S3ControlMultiRegionAccessPointTimeouts.Jsii$Proxy) o;
