...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.s3.S3ControlObjectLambdaAccessPointPolicy")
public class S3ControlObjectLambdaAccessPointPolicy extends com.hashicorp.cdktf.TerraformResource {

    protected S3ControlObjectLambdaAccessPointPolicy(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected S3ControlObjectLambdaAccessPointPolicy(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.s3.S3ControlObjectLambdaAccessPointPolicy.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public S3ControlObjectLambdaAccessPointPolicy(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.s3.S3ControlObjectLambdaAccessPointPolicyConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.s3.S3ControlObjectLambdaAccessPointPolicy}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.s3.S3ControlObjectLambdaAccessPointPolicy> {
        /**
        ...
        private final imports.aws.s3.S3ControlObjectLambdaAccessPointPolicyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.s3.S3ControlObjectLambdaAccessPointPolicyConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param accountId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/s3control_object_lambda_access_point_policy#account_id S3ControlObjectLambdaAccessPointPolicy#account_id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/s3control_object_lambda_access_point_policy#id S3ControlObjectLambdaAccessPointPolicy#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.s3.S3ControlObjectLambdaAccessPointPolicy}.
         */
        @Override
        public imports.aws.s3.S3ControlObjectLambdaAccessPointPolicy build() {
            return new imports.aws.s3.S3ControlObjectLambdaAccessPointPolicy(
                this.scope,
                this.id,
                this.config.build()
            );
