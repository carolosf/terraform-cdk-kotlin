...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.s3.S3BucketAccelerateConfiguration")
public class S3BucketAccelerateConfiguration extends com.hashicorp.cdktf.TerraformResource {

    protected S3BucketAccelerateConfiguration(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected S3BucketAccelerateConfiguration(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.s3.S3BucketAccelerateConfiguration.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public S3BucketAccelerateConfiguration(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.s3.S3BucketAccelerateConfigurationConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.s3.S3BucketAccelerateConfiguration}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.s3.S3BucketAccelerateConfiguration> {
        /**
        ...
        private final imports.aws.s3.S3BucketAccelerateConfigurationConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.s3.S3BucketAccelerateConfigurationConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param expectedBucketOwner Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/s3_bucket_accelerate_configuration#expected_bucket_owner S3BucketAccelerateConfiguration#expected_bucket_owner}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/s3_bucket_accelerate_configuration#id S3BucketAccelerateConfiguration#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.s3.S3BucketAccelerateConfiguration}.
         */
        @Override
        public imports.aws.s3.S3BucketAccelerateConfiguration build() {
            return new imports.aws.s3.S3BucketAccelerateConfiguration(
                this.scope,
                this.id,
                this.config.build()
            );
