...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.s3.S3BucketAnalyticsConfigurationStorageClassAnalysis")
...
public interface S3BucketAnalyticsConfigurationStorageClassAnalysis extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull imports.aws.s3.S3BucketAnalyticsConfigurationStorageClassAnalysisDataExport getDataExport();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<S3BucketAnalyticsConfigurationStorageClassAnalysis> {
        imports.aws.s3.S3BucketAnalyticsConfigurationStorageClassAnalysisDataExport dataExport;
         ...
         * @return {@code this}
         */
        public Builder dataExport(imports.aws.s3.S3BucketAnalyticsConfigurationStorageClassAnalysisDataExport dataExport) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements S3BucketAnalyticsConfigurationStorageClassAnalysis {
        private final imports.aws.s3.S3BucketAnalyticsConfigurationStorageClassAnalysisDataExport dataExport;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.dataExport = software.amazon.jsii.Kernel.get(this, "dataExport", software.amazon.jsii.NativeType.forClass(imports.aws.s3.S3BucketAnalyticsConfigurationStorageClassAnalysisDataExport.class));
        }
        ...
        protected Jsii$Proxy(final Builder builder) {
            ...
            this.dataExport = java.util.Objects.requireNonNull(builder.dataExport, "dataExport is required");
        }

        @Override
        public final imports.aws.s3.S3BucketAnalyticsConfigurationStorageClassAnalysisDataExport getDataExport() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.s3.S3BucketAnalyticsConfigurationStorageClassAnalysis"));
