...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.s3.S3BucketCorsConfiguration")
public class S3BucketCorsConfiguration extends com.hashicorp.cdktf.TerraformResource {

    protected S3BucketCorsConfiguration(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected S3BucketCorsConfiguration(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.s3.S3BucketCorsConfiguration.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public S3BucketCorsConfiguration(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.s3.S3BucketCorsConfigurationConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.s3.S3BucketCorsConfigurationCorsRuleList getCorsRule() {
        return software.amazon.jsii.Kernel.get(this, "corsRule", software.amazon.jsii.NativeType.forClass(imports.aws.s3.S3BucketCorsConfigurationCorsRuleList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.s3.S3BucketCorsConfiguration}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.s3.S3BucketCorsConfiguration> {
        /**
        ...
        private final imports.aws.s3.S3BucketCorsConfigurationConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.s3.S3BucketCorsConfigurationConfig.Builder();
        }
         ...
         * @param corsRule cors_rule block. This parameter is required.
         */
        public Builder corsRule(final java.util.List<? extends imports.aws.s3.S3BucketCorsConfigurationCorsRule> corsRule) {
            this.config.corsRule(corsRule);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param expectedBucketOwner Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/s3_bucket_cors_configuration#expected_bucket_owner S3BucketCorsConfiguration#expected_bucket_owner}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/s3_bucket_cors_configuration#id S3BucketCorsConfiguration#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.s3.S3BucketCorsConfiguration}.
         */
        @Override
        public imports.aws.s3.S3BucketCorsConfiguration build() {
            return new imports.aws.s3.S3BucketCorsConfiguration(
                this.scope,
                this.id,
                this.config.build()
            );
