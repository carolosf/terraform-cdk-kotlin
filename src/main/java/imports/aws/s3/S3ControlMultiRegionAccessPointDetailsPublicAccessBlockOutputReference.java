...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.s3.S3ControlMultiRegionAccessPointDetailsPublicAccessBlockOutputReference")
public class S3ControlMultiRegionAccessPointDetailsPublicAccessBlockOutputReference extends com.hashicorp.cdktf.ComplexObject {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.s3.S3ControlMultiRegionAccessPointDetailsPublicAccessBlock getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.s3.S3ControlMultiRegionAccessPointDetailsPublicAccessBlock.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.s3.S3ControlMultiRegionAccessPointDetailsPublicAccessBlock value) {
