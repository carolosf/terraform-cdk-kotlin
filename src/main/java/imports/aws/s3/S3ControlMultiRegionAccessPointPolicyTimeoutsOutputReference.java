...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.s3.S3ControlMultiRegionAccessPointPolicyTimeoutsOutputReference")
public class S3ControlMultiRegionAccessPointPolicyTimeoutsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected S3ControlMultiRegionAccessPointPolicyTimeoutsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected S3ControlMultiRegionAccessPointPolicyTimeoutsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public S3ControlMultiRegionAccessPointPolicyTimeoutsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.s3.S3ControlMultiRegionAccessPointPolicyTimeouts value) {
