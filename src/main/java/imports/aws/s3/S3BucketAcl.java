 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:20.051Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.s3.S3BucketAcl")
public class S3BucketAcl extends com.hashicorp.cdktf.TerraformResource {

    protected S3BucketAcl(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected S3BucketAcl(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.s3.S3BucketAcl.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public S3BucketAcl(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.s3.S3BucketAclConfig config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public void putAccessControlPolicy(final @org.jetbrains.annotations.NotNull imports.aws.s3.S3BucketAclAccessControlPolicy value) {
        software.amazon.jsii.Kernel.call(this, "putAccessControlPolicy", software.amazon.jsii.NativeType.VOID, new Object[] { java.util.Objects.requireNonNull(value, "value is required") });
    }

    public void resetAccessControlPolicy() {
        software.amazon.jsii.Kernel.call(this, "resetAccessControlPolicy", software.amazon.jsii.NativeType.VOID);
    }
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.s3.S3BucketAclAccessControlPolicyOutputReference getAccessControlPolicy() {
        return software.amazon.jsii.Kernel.get(this, "accessControlPolicy", software.amazon.jsii.NativeType.forClass(imports.aws.s3.S3BucketAclAccessControlPolicyOutputReference.class));
    }

    public @org.jetbrains.annotations.Nullable imports.aws.s3.S3BucketAclAccessControlPolicy getAccessControlPolicyInput() {
        return software.amazon.jsii.Kernel.get(this, "accessControlPolicyInput", software.amazon.jsii.NativeType.forClass(imports.aws.s3.S3BucketAclAccessControlPolicy.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.s3.S3BucketAcl}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.s3.S3BucketAcl> {
        /**
        ...
        private final imports.aws.s3.S3BucketAclConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.s3.S3BucketAclConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param bucket Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/s3_bucket_acl#bucket S3BucketAcl#bucket}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param accessControlPolicy access_control_policy block. This parameter is required.
         */
        public Builder accessControlPolicy(final imports.aws.s3.S3BucketAclAccessControlPolicy accessControlPolicy) {
            this.config.accessControlPolicy(accessControlPolicy);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param acl Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/s3_bucket_acl#acl S3BucketAcl#acl}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param expectedBucketOwner Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/s3_bucket_acl#expected_bucket_owner S3BucketAcl#expected_bucket_owner}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.s3.S3BucketAcl}.
         */
        @Override
        public imports.aws.s3.S3BucketAcl build() {
            return new imports.aws.s3.S3BucketAcl(
                this.scope,
                this.id,
                this.config.build()
            );
