...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.s3.S3BucketAclAccessControlPolicyGrantOutputReference")
public class S3BucketAclAccessControlPolicyGrantOutputReference extends com.hashicorp.cdktf.ComplexObject {
    ...
    public void putGrantee(final @org.jetbrains.annotations.NotNull imports.aws.s3.S3BucketAclAccessControlPolicyGrantGrantee value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.s3.S3BucketAclAccessControlPolicyGrantGranteeOutputReference getGrantee() {
        return software.amazon.jsii.Kernel.get(this, "grantee", software.amazon.jsii.NativeType.forClass(imports.aws.s3.S3BucketAclAccessControlPolicyGrantGranteeOutputReference.class));
    }

    public @org.jetbrains.annotations.Nullable imports.aws.s3.S3BucketAclAccessControlPolicyGrantGrantee getGranteeInput() {
        return software.amazon.jsii.Kernel.get(this, "granteeInput", software.amazon.jsii.NativeType.forClass(imports.aws.s3.S3BucketAclAccessControlPolicyGrantGrantee.class));
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.s3.S3BucketAclAccessControlPolicyGrant value) {
