...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.s3.S3BucketAclAccessControlPolicyGrantGranteeOutputReference")
public class S3BucketAclAccessControlPolicyGrantGranteeOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected S3BucketAclAccessControlPolicyGrantGranteeOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected S3BucketAclAccessControlPolicyGrantGranteeOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public S3BucketAclAccessControlPolicyGrantGranteeOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.s3.S3BucketAclAccessControlPolicyGrantGrantee getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.s3.S3BucketAclAccessControlPolicyGrantGrantee.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.s3.S3BucketAclAccessControlPolicyGrantGrantee value) {
