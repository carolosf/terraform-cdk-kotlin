...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.s3.S3BucketReplicationConfigurationA")
public class S3BucketReplicationConfigurationA extends com.hashicorp.cdktf.TerraformResource {

    protected S3BucketReplicationConfigurationA(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected S3BucketReplicationConfigurationA(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.s3.S3BucketReplicationConfigurationA.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public S3BucketReplicationConfigurationA(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.s3.S3BucketReplicationConfigurationAConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.s3.S3BucketReplicationConfigurationRuleList getRule() {
        return software.amazon.jsii.Kernel.get(this, "rule", software.amazon.jsii.NativeType.forClass(imports.aws.s3.S3BucketReplicationConfigurationRuleList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.s3.S3BucketReplicationConfigurationA}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.s3.S3BucketReplicationConfigurationA> {
        /**
        ...
        private final imports.aws.s3.S3BucketReplicationConfigurationAConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.s3.S3BucketReplicationConfigurationAConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param role Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/s3_bucket_replication_configuration#role S3BucketReplicationConfigurationA#role}. This parameter is required.
         */
         ...
         * @param rule rule block. This parameter is required.
         */
        public Builder rule(final java.util.List<? extends imports.aws.s3.S3BucketReplicationConfigurationRule> rule) {
            this.config.rule(rule);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/s3_bucket_replication_configuration#id S3BucketReplicationConfigurationA#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param token Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/s3_bucket_replication_configuration#token S3BucketReplicationConfigurationA#token}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.s3.S3BucketReplicationConfigurationA}.
         */
        @Override
        public imports.aws.s3.S3BucketReplicationConfigurationA build() {
            return new imports.aws.s3.S3BucketReplicationConfigurationA(
                this.scope,
                this.id,
                this.config.build()
            );
