...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.s3.S3BucketLifecycleConfiguration")
public class S3BucketLifecycleConfiguration extends com.hashicorp.cdktf.TerraformResource {

    protected S3BucketLifecycleConfiguration(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected S3BucketLifecycleConfiguration(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.s3.S3BucketLifecycleConfiguration.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public S3BucketLifecycleConfiguration(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.s3.S3BucketLifecycleConfigurationConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.s3.S3BucketLifecycleConfigurationRuleList getRule() {
        return software.amazon.jsii.Kernel.get(this, "rule", software.amazon.jsii.NativeType.forClass(imports.aws.s3.S3BucketLifecycleConfigurationRuleList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.s3.S3BucketLifecycleConfiguration}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.s3.S3BucketLifecycleConfiguration> {
        /**
        ...
        private final imports.aws.s3.S3BucketLifecycleConfigurationConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.s3.S3BucketLifecycleConfigurationConfig.Builder();
        }
         ...
         * @param rule rule block. This parameter is required.
         */
        public Builder rule(final java.util.List<? extends imports.aws.s3.S3BucketLifecycleConfigurationRule> rule) {
            this.config.rule(rule);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param expectedBucketOwner Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/s3_bucket_lifecycle_configuration#expected_bucket_owner S3BucketLifecycleConfiguration#expected_bucket_owner}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.s3.S3BucketLifecycleConfiguration}.
         */
        @Override
        public imports.aws.s3.S3BucketLifecycleConfiguration build() {
            return new imports.aws.s3.S3BucketLifecycleConfiguration(
                this.scope,
                this.id,
                this.config.build()
            );
