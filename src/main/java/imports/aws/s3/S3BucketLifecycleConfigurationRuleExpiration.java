...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.s3.S3BucketLifecycleConfigurationRuleExpiration")
@software.amazon.jsii.Jsii.Proxy(S3BucketLifecycleConfigurationRuleExpiration.Jsii$Proxy.class)
public interface S3BucketLifecycleConfigurationRuleExpiration extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link S3BucketLifecycleConfigurationRuleExpiration}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link S3BucketLifecycleConfigurationRuleExpiration}
     */
    public static final class Builder implements software.amazon.jsii.Builder<S3BucketLifecycleConfigurationRuleExpiration> {
        java.lang.String date;
        java.lang.Number days;
        java.lang.Object expiredObjectDeleteMarker;

        /**
         * Sets the value of {@link S3BucketLifecycleConfigurationRuleExpiration#getDate}
        ...
        /**
         * Sets the value of {@link S3BucketLifecycleConfigurationRuleExpiration#getDays}
        ...
        /**
         * Sets the value of {@link S3BucketLifecycleConfigurationRuleExpiration#getExpiredObjectDeleteMarker}
         * @param expiredObjectDeleteMarker Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/s3_bucket_lifecycle_configuration#expired_object_delete_marker S3BucketLifecycleConfiguration#expired_object_delete_marker}.
         * @return {@code this}
         */
         ...
         * @return a new instance of {@link S3BucketLifecycleConfigurationRuleExpiration}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public S3BucketLifecycleConfigurationRuleExpiration build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link S3BucketLifecycleConfigurationRuleExpiration}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements S3BucketLifecycleConfigurationRuleExpiration {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.s3.S3BucketLifecycleConfigurationRuleExpiration"));
        ...
        public final boolean equals(final Object o) {
            ...
            S3BucketLifecycleConfigurationRuleExpiration.Jsii$Proxy that = (S3BucketLifecycleConfigurationRuleExpiration.Jsii$Proxy) o;
