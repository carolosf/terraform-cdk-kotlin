...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.kinesis.KinesisAnalyticsApplicationOutputsLambda")
@software.amazon.jsii.Jsii.Proxy(KinesisAnalyticsApplicationOutputsLambda.Jsii$Proxy.class)
public interface KinesisAnalyticsApplicationOutputsLambda extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link KinesisAnalyticsApplicationOutputsLambda}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link KinesisAnalyticsApplicationOutputsLambda}
     */
    public static final class Builder implements software.amazon.jsii.Builder<KinesisAnalyticsApplicationOutputsLambda> {
        java.lang.String resourceArn;
        java.lang.String roleArn;

        /**
         * Sets the value of {@link KinesisAnalyticsApplicationOutputsLambda#getResourceArn}
        ...
        /**
         * Sets the value of {@link KinesisAnalyticsApplicationOutputsLambda#getRoleArn}
         ...
         * @return a new instance of {@link KinesisAnalyticsApplicationOutputsLambda}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public KinesisAnalyticsApplicationOutputsLambda build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link KinesisAnalyticsApplicationOutputsLambda}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements KinesisAnalyticsApplicationOutputsLambda {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.kinesis.KinesisAnalyticsApplicationOutputsLambda"));
        ...
        public final boolean equals(final Object o) {
            ...
            KinesisAnalyticsApplicationOutputsLambda.Jsii$Proxy that = (KinesisAnalyticsApplicationOutputsLambda.Jsii$Proxy) o;
