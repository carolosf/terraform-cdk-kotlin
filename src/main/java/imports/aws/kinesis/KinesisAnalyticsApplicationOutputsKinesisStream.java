...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.kinesis.KinesisAnalyticsApplicationOutputsKinesisStream")
@software.amazon.jsii.Jsii.Proxy(KinesisAnalyticsApplicationOutputsKinesisStream.Jsii$Proxy.class)
public interface KinesisAnalyticsApplicationOutputsKinesisStream extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link KinesisAnalyticsApplicationOutputsKinesisStream}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link KinesisAnalyticsApplicationOutputsKinesisStream}
     */
    public static final class Builder implements software.amazon.jsii.Builder<KinesisAnalyticsApplicationOutputsKinesisStream> {
        java.lang.String resourceArn;
        java.lang.String roleArn;

        /**
         * Sets the value of {@link KinesisAnalyticsApplicationOutputsKinesisStream#getResourceArn}
        ...
        /**
         * Sets the value of {@link KinesisAnalyticsApplicationOutputsKinesisStream#getRoleArn}
         ...
         * @return a new instance of {@link KinesisAnalyticsApplicationOutputsKinesisStream}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public KinesisAnalyticsApplicationOutputsKinesisStream build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link KinesisAnalyticsApplicationOutputsKinesisStream}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements KinesisAnalyticsApplicationOutputsKinesisStream {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.kinesis.KinesisAnalyticsApplicationOutputsKinesisStream"));
        ...
        public final boolean equals(final Object o) {
            ...
            KinesisAnalyticsApplicationOutputsKinesisStream.Jsii$Proxy that = (KinesisAnalyticsApplicationOutputsKinesisStream.Jsii$Proxy) o;
