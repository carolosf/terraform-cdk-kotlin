...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.kinesis.Kinesisanalyticsv2ApplicationSnapshotTimeouts")
@software.amazon.jsii.Jsii.Proxy(Kinesisanalyticsv2ApplicationSnapshotTimeouts.Jsii$Proxy.class)
public interface Kinesisanalyticsv2ApplicationSnapshotTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link Kinesisanalyticsv2ApplicationSnapshotTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link Kinesisanalyticsv2ApplicationSnapshotTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<Kinesisanalyticsv2ApplicationSnapshotTimeouts> {
        java.lang.String create;
        java.lang.String delete;

        /**
         * Sets the value of {@link Kinesisanalyticsv2ApplicationSnapshotTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link Kinesisanalyticsv2ApplicationSnapshotTimeouts#getDelete}
         ...
         * @return a new instance of {@link Kinesisanalyticsv2ApplicationSnapshotTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public Kinesisanalyticsv2ApplicationSnapshotTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link Kinesisanalyticsv2ApplicationSnapshotTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements Kinesisanalyticsv2ApplicationSnapshotTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.kinesis.Kinesisanalyticsv2ApplicationSnapshotTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            Kinesisanalyticsv2ApplicationSnapshotTimeouts.Jsii$Proxy that = (Kinesisanalyticsv2ApplicationSnapshotTimeouts.Jsii$Proxy) o;
