...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.kinesis.KinesisAnalyticsApplicationReferenceDataSourcesSchema")
...
public interface KinesisAnalyticsApplicationReferenceDataSourcesSchema extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull imports.aws.kinesis.KinesisAnalyticsApplicationReferenceDataSourcesSchemaRecordFormat getRecordFormat();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<KinesisAnalyticsApplicationReferenceDataSourcesSchema> {
        ...
        imports.aws.kinesis.KinesisAnalyticsApplicationReferenceDataSourcesSchemaRecordFormat recordFormat;
         ...
         * @return {@code this}
         */
        public Builder recordColumns(java.util.List<? extends imports.aws.kinesis.KinesisAnalyticsApplicationReferenceDataSourcesSchemaRecordColumns> recordColumns) {
            this.recordColumns = recordColumns;
            return this;
        }
         ...
         * @return {@code this}
         */
        public Builder recordFormat(imports.aws.kinesis.KinesisAnalyticsApplicationReferenceDataSourcesSchemaRecordFormat recordFormat) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements KinesisAnalyticsApplicationReferenceDataSourcesSchema {
        ...
        private final imports.aws.kinesis.KinesisAnalyticsApplicationReferenceDataSourcesSchemaRecordFormat recordFormat;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.recordFormat = software.amazon.jsii.Kernel.get(this, "recordFormat", software.amazon.jsii.NativeType.forClass(imports.aws.kinesis.KinesisAnalyticsApplicationReferenceDataSourcesSchemaRecordFormat.class));
        ...
        @Override
        public final imports.aws.kinesis.KinesisAnalyticsApplicationReferenceDataSourcesSchemaRecordFormat getRecordFormat() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.kinesis.KinesisAnalyticsApplicationReferenceDataSourcesSchema"));
