...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.kinesis.KinesisAnalyticsApplicationInputsKinesisStream")
@software.amazon.jsii.Jsii.Proxy(KinesisAnalyticsApplicationInputsKinesisStream.Jsii$Proxy.class)
public interface KinesisAnalyticsApplicationInputsKinesisStream extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link KinesisAnalyticsApplicationInputsKinesisStream}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link KinesisAnalyticsApplicationInputsKinesisStream}
     */
    public static final class Builder implements software.amazon.jsii.Builder<KinesisAnalyticsApplicationInputsKinesisStream> {
        java.lang.String resourceArn;
        java.lang.String roleArn;

        /**
         * Sets the value of {@link KinesisAnalyticsApplicationInputsKinesisStream#getResourceArn}
        ...
        /**
         * Sets the value of {@link KinesisAnalyticsApplicationInputsKinesisStream#getRoleArn}
         ...
         * @return a new instance of {@link KinesisAnalyticsApplicationInputsKinesisStream}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public KinesisAnalyticsApplicationInputsKinesisStream build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link KinesisAnalyticsApplicationInputsKinesisStream}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements KinesisAnalyticsApplicationInputsKinesisStream {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.kinesis.KinesisAnalyticsApplicationInputsKinesisStream"));
        ...
        public final boolean equals(final Object o) {
            ...
            KinesisAnalyticsApplicationInputsKinesisStream.Jsii$Proxy that = (KinesisAnalyticsApplicationInputsKinesisStream.Jsii$Proxy) o;
