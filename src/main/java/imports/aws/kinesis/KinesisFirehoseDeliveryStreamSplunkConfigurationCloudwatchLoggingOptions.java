...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.kinesis.KinesisFirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions")
@software.amazon.jsii.Jsii.Proxy(KinesisFirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions.Jsii$Proxy.class)
public interface KinesisFirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link KinesisFirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link KinesisFirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions}
     */
    public static final class Builder implements software.amazon.jsii.Builder<KinesisFirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions> {
        java.lang.Object enabled;
        java.lang.String logGroupName;
        java.lang.String logStreamName;

        /**
         * Sets the value of {@link KinesisFirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions#getEnabled}
        ...
        /**
         * Sets the value of {@link KinesisFirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions#getLogGroupName}
        ...
        /**
         * Sets the value of {@link KinesisFirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions#getLogStreamName}
         ...
         * @return a new instance of {@link KinesisFirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public KinesisFirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link KinesisFirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements KinesisFirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.kinesis.KinesisFirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions"));
        ...
        public final boolean equals(final Object o) {
            ...
            KinesisFirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions.Jsii$Proxy that = (KinesisFirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions.Jsii$Proxy) o;
