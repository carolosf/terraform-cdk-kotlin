 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:20.110Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.secretsmanager.DataAwsSecretsmanagerSecret")
public class DataAwsSecretsmanagerSecret extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.secretsmanager.DataAwsSecretsmanagerSecret.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     * @param config
     */
    public DataAwsSecretsmanagerSecret(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.secretsmanager.DataAwsSecretsmanagerSecretConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.secretsmanager.DataAwsSecretsmanagerSecretRotationRulesList getRotationRules() {
        return software.amazon.jsii.Kernel.get(this, "rotationRules", software.amazon.jsii.NativeType.forClass(imports.aws.secretsmanager.DataAwsSecretsmanagerSecretRotationRulesList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.secretsmanager.DataAwsSecretsmanagerSecret}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.secretsmanager.DataAwsSecretsmanagerSecret> {
        /**
        ...
        private imports.aws.secretsmanager.DataAwsSecretsmanagerSecretConfig.Builder config;
         ...
         * <p>
         * @return {@code this}
         * @param arn Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/secretsmanager_secret#arn DataAwsSecretsmanagerSecret#arn}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/secretsmanager_secret#id DataAwsSecretsmanagerSecret#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param name Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/secretsmanager_secret#name DataAwsSecretsmanagerSecret#name}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.secretsmanager.DataAwsSecretsmanagerSecret}.
         */
        @Override
        public imports.aws.secretsmanager.DataAwsSecretsmanagerSecret build() {
            return new imports.aws.secretsmanager.DataAwsSecretsmanagerSecret(
                this.scope,
                this.id,
        ...
        private imports.aws.secretsmanager.DataAwsSecretsmanagerSecretConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.secretsmanager.DataAwsSecretsmanagerSecretConfig.Builder();
            }
            return this.config;
        }
    }
