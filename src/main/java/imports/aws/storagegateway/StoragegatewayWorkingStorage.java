...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.storagegateway.StoragegatewayWorkingStorage")
public class StoragegatewayWorkingStorage extends com.hashicorp.cdktf.TerraformResource {

    protected StoragegatewayWorkingStorage(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected StoragegatewayWorkingStorage(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.storagegateway.StoragegatewayWorkingStorage.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public StoragegatewayWorkingStorage(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.storagegateway.StoragegatewayWorkingStorageConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.storagegateway.StoragegatewayWorkingStorage}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.storagegateway.StoragegatewayWorkingStorage> {
        /**
        ...
        private final imports.aws.storagegateway.StoragegatewayWorkingStorageConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.storagegateway.StoragegatewayWorkingStorageConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/storagegateway_working_storage#id StoragegatewayWorkingStorage#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.storagegateway.StoragegatewayWorkingStorage}.
         */
        @Override
        public imports.aws.storagegateway.StoragegatewayWorkingStorage build() {
            return new imports.aws.storagegateway.StoragegatewayWorkingStorage(
                this.scope,
                this.id,
                this.config.build()
            );
