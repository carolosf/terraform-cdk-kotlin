...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:20.215Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.storagegateway.StoragegatewayNfsFileShareTimeouts")
@software.amazon.jsii.Jsii.Proxy(StoragegatewayNfsFileShareTimeouts.Jsii$Proxy.class)
public interface StoragegatewayNfsFileShareTimeouts extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link StoragegatewayNfsFileShareTimeouts}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link StoragegatewayNfsFileShareTimeouts}
     */
    public static final class Builder implements software.amazon.jsii.Builder<StoragegatewayNfsFileShareTimeouts> {
        java.lang.String create;
        java.lang.String delete;
        java.lang.String update;

        /**
         * Sets the value of {@link StoragegatewayNfsFileShareTimeouts#getCreate}
        ...
        /**
         * Sets the value of {@link StoragegatewayNfsFileShareTimeouts#getDelete}
        ...
        /**
         * Sets the value of {@link StoragegatewayNfsFileShareTimeouts#getUpdate}
         ...
         * @return a new instance of {@link StoragegatewayNfsFileShareTimeouts}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public StoragegatewayNfsFileShareTimeouts build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link StoragegatewayNfsFileShareTimeouts}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StoragegatewayNfsFileShareTimeouts {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.storagegateway.StoragegatewayNfsFileShareTimeouts"));
        ...
        public final boolean equals(final Object o) {
            ...
            StoragegatewayNfsFileShareTimeouts.Jsii$Proxy that = (StoragegatewayNfsFileShareTimeouts.Jsii$Proxy) o;
