...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:20.213Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.storagegateway.StoragegatewayFileSystemAssociationCacheAttributesOutputReference")
public class StoragegatewayFileSystemAssociationCacheAttributesOutputReference extends com.hashicorp.cdktf.ComplexObject {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.storagegateway.StoragegatewayFileSystemAssociationCacheAttributes getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.storagegateway.StoragegatewayFileSystemAssociationCacheAttributes.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.storagegateway.StoragegatewayFileSystemAssociationCacheAttributes value) {
