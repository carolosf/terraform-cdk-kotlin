...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.servicediscovery.ServiceDiscoveryServiceHealthCheckConfigOutputReference")
public class ServiceDiscoveryServiceHealthCheckConfigOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected ServiceDiscoveryServiceHealthCheckConfigOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected ServiceDiscoveryServiceHealthCheckConfigOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public ServiceDiscoveryServiceHealthCheckConfigOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.servicediscovery.ServiceDiscoveryServiceHealthCheckConfig getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.servicediscovery.ServiceDiscoveryServiceHealthCheckConfig.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.servicediscovery.ServiceDiscoveryServiceHealthCheckConfig value) {
