...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.imagebuilder.DataAwsImagebuilderComponent")
public class DataAwsImagebuilderComponent extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsImagebuilderComponent(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsImagebuilderComponent(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.imagebuilder.DataAwsImagebuilderComponent.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsImagebuilderComponent(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.imagebuilder.DataAwsImagebuilderComponentConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.imagebuilder.DataAwsImagebuilderComponent}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.imagebuilder.DataAwsImagebuilderComponent> {
        /**
        ...
        private final imports.aws.imagebuilder.DataAwsImagebuilderComponentConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.imagebuilder.DataAwsImagebuilderComponentConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/imagebuilder_component#id DataAwsImagebuilderComponent#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param tags Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/imagebuilder_component#tags DataAwsImagebuilderComponent#tags}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.imagebuilder.DataAwsImagebuilderComponent}.
         */
        @Override
        public imports.aws.imagebuilder.DataAwsImagebuilderComponent build() {
            return new imports.aws.imagebuilder.DataAwsImagebuilderComponent(
                this.scope,
                this.id,
                this.config.build()
            );
