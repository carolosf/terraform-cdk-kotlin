...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.imagebuilder.ImagebuilderImagePipelineImageTestsConfiguration")
@software.amazon.jsii.Jsii.Proxy(ImagebuilderImagePipelineImageTestsConfiguration.Jsii$Proxy.class)
public interface ImagebuilderImagePipelineImageTestsConfiguration extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link ImagebuilderImagePipelineImageTestsConfiguration}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ImagebuilderImagePipelineImageTestsConfiguration}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ImagebuilderImagePipelineImageTestsConfiguration> {
        ...
        /**
         * Sets the value of {@link ImagebuilderImagePipelineImageTestsConfiguration#getImageTestsEnabled}
         * @param imageTestsEnabled Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/imagebuilder_image_pipeline#image_tests_enabled ImagebuilderImagePipeline#image_tests_enabled}.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link ImagebuilderImagePipelineImageTestsConfiguration#getTimeoutMinutes}
         * @param timeoutMinutes Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/imagebuilder_image_pipeline#timeout_minutes ImagebuilderImagePipeline#timeout_minutes}.
         * @return {@code this}
         */
         ...
         * @return a new instance of {@link ImagebuilderImagePipelineImageTestsConfiguration}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ImagebuilderImagePipelineImageTestsConfiguration build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ImagebuilderImagePipelineImageTestsConfiguration}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ImagebuilderImagePipelineImageTestsConfiguration {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.imagebuilder.ImagebuilderImagePipelineImageTestsConfiguration"));
        ...
        public final boolean equals(final Object o) {
            ...
            ImagebuilderImagePipelineImageTestsConfiguration.Jsii$Proxy that = (ImagebuilderImagePipelineImageTestsConfiguration.Jsii$Proxy) o;
