...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.imagebuilder.DataAwsImagebuilderImageRecipes")
public class DataAwsImagebuilderImageRecipes extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsImagebuilderImageRecipes(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsImagebuilderImageRecipes(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.imagebuilder.DataAwsImagebuilderImageRecipes.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     * @param config
     */
    public DataAwsImagebuilderImageRecipes(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.imagebuilder.DataAwsImagebuilderImageRecipesConfig config) {
     ...
     * @param id The scoped construct ID. This parameter is required.
     */
    public DataAwsImagebuilderImageRecipes(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.imagebuilder.DataAwsImagebuilderImageRecipesFilterList getFilter() {
        return software.amazon.jsii.Kernel.get(this, "filter", software.amazon.jsii.NativeType.forClass(imports.aws.imagebuilder.DataAwsImagebuilderImageRecipesFilterList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.imagebuilder.DataAwsImagebuilderImageRecipes}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.imagebuilder.DataAwsImagebuilderImageRecipes> {
        /**
        ...
        private imports.aws.imagebuilder.DataAwsImagebuilderImageRecipesConfig.Builder config;
         ...
         * @param filter filter block. This parameter is required.
         */
        public Builder filter(final java.util.List<? extends imports.aws.imagebuilder.DataAwsImagebuilderImageRecipesFilter> filter) {
            this.config().filter(filter);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/imagebuilder_image_recipes#id DataAwsImagebuilderImageRecipes#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param owner Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/imagebuilder_image_recipes#owner DataAwsImagebuilderImageRecipes#owner}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.imagebuilder.DataAwsImagebuilderImageRecipes}.
         */
        @Override
        public imports.aws.imagebuilder.DataAwsImagebuilderImageRecipes build() {
            return new imports.aws.imagebuilder.DataAwsImagebuilderImageRecipes(
                this.scope,
                this.id,
        ...
        private imports.aws.imagebuilder.DataAwsImagebuilderImageRecipesConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.imagebuilder.DataAwsImagebuilderImageRecipesConfig.Builder();
            }
            return this.config;
        }
    }
