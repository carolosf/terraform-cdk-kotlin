...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.imagebuilder.DataAwsImagebuilderImagePipelineImageTestsConfigurationList")
public class DataAwsImagebuilderImagePipelineImageTestsConfigurationList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsImagebuilderImagePipelineImageTestsConfigurationList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsImagebuilderImagePipelineImageTestsConfigurationList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.imagebuilder.DataAwsImagebuilderImagePipelineImageTestsConfigurationOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.imagebuilder.DataAwsImagebuilderImagePipelineImageTestsConfigurationOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
