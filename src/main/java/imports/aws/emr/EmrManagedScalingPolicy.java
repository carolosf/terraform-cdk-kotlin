...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.emr.EmrManagedScalingPolicy")
public class EmrManagedScalingPolicy extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.emr.EmrManagedScalingPolicy.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public EmrManagedScalingPolicy(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.emr.EmrManagedScalingPolicyConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.emr.EmrManagedScalingPolicyComputeLimitsList getComputeLimits() {
        return software.amazon.jsii.Kernel.get(this, "computeLimits", software.amazon.jsii.NativeType.forClass(imports.aws.emr.EmrManagedScalingPolicyComputeLimitsList.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.emr.EmrManagedScalingPolicy}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.emr.EmrManagedScalingPolicy> {
        /**
        ...
        private final imports.aws.emr.EmrManagedScalingPolicyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.emr.EmrManagedScalingPolicyConfig.Builder();
        }
         ...
         * @param computeLimits compute_limits block. This parameter is required.
         */
        public Builder computeLimits(final java.util.List<? extends imports.aws.emr.EmrManagedScalingPolicyComputeLimits> computeLimits) {
            this.config.computeLimits(computeLimits);
            return this;
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/emr_managed_scaling_policy#id EmrManagedScalingPolicy#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.emr.EmrManagedScalingPolicy}.
         */
        @Override
        public imports.aws.emr.EmrManagedScalingPolicy build() {
            return new imports.aws.emr.EmrManagedScalingPolicy(
                this.scope,
                this.id,
                this.config.build()
            );
