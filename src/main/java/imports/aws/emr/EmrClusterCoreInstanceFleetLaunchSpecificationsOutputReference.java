...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.emr.EmrClusterCoreInstanceFleetLaunchSpecificationsOutputReference")
public class EmrClusterCoreInstanceFleetLaunchSpecificationsOutputReference extends com.hashicorp.cdktf.ComplexObject {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.emr.EmrClusterCoreInstanceFleetLaunchSpecificationsOnDemandSpecificationList getOnDemandSpecification() {
        return software.amazon.jsii.Kernel.get(this, "onDemandSpecification", software.amazon.jsii.NativeType.forClass(imports.aws.emr.EmrClusterCoreInstanceFleetLaunchSpecificationsOnDemandSpecificationList.class));
    }

    public @org.jetbrains.annotations.NotNull imports.aws.emr.EmrClusterCoreInstanceFleetLaunchSpecificationsSpotSpecificationList getSpotSpecification() {
        return software.amazon.jsii.Kernel.get(this, "spotSpecification", software.amazon.jsii.NativeType.forClass(imports.aws.emr.EmrClusterCoreInstanceFleetLaunchSpecificationsSpotSpecificationList.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.emr.EmrClusterCoreInstanceFleetLaunchSpecifications getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.emr.EmrClusterCoreInstanceFleetLaunchSpecifications.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.emr.EmrClusterCoreInstanceFleetLaunchSpecifications value) {
