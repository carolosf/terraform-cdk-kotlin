...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:19.679Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.emr.EmrClusterMasterInstanceFleetLaunchSpecifications")
@software.amazon.jsii.Jsii.Proxy(EmrClusterMasterInstanceFleetLaunchSpecifications.Jsii$Proxy.class)
public interface EmrClusterMasterInstanceFleetLaunchSpecifications extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link EmrClusterMasterInstanceFleetLaunchSpecifications}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link EmrClusterMasterInstanceFleetLaunchSpecifications}
     */
    public static final class Builder implements software.amazon.jsii.Builder<EmrClusterMasterInstanceFleetLaunchSpecifications> {
        java.lang.Object onDemandSpecification;
        java.lang.Object spotSpecification;

        /**
         * Sets the value of {@link EmrClusterMasterInstanceFleetLaunchSpecifications#getOnDemandSpecification}
         ...
         * @return {@code this}
         */
        public Builder onDemandSpecification(java.util.List<? extends imports.aws.emr.EmrClusterMasterInstanceFleetLaunchSpecificationsOnDemandSpecification> onDemandSpecification) {
            this.onDemandSpecification = onDemandSpecification;
            return this;
        }

        /**
         * Sets the value of {@link EmrClusterMasterInstanceFleetLaunchSpecifications#getSpotSpecification}
         ...
         * @return {@code this}
         */
        public Builder spotSpecification(java.util.List<? extends imports.aws.emr.EmrClusterMasterInstanceFleetLaunchSpecificationsSpotSpecification> spotSpecification) {
            this.spotSpecification = spotSpecification;
            return this;
        }
         ...
         * @return a new instance of {@link EmrClusterMasterInstanceFleetLaunchSpecifications}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public EmrClusterMasterInstanceFleetLaunchSpecifications build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link EmrClusterMasterInstanceFleetLaunchSpecifications}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements EmrClusterMasterInstanceFleetLaunchSpecifications {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.emr.EmrClusterMasterInstanceFleetLaunchSpecifications"));
        ...
        public final boolean equals(final Object o) {
            ...
            EmrClusterMasterInstanceFleetLaunchSpecifications.Jsii$Proxy that = (EmrClusterMasterInstanceFleetLaunchSpecifications.Jsii$Proxy) o;
