...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.emr.EmrSecurityConfiguration")
public class EmrSecurityConfiguration extends com.hashicorp.cdktf.TerraformResource {

    protected EmrSecurityConfiguration(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected EmrSecurityConfiguration(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.emr.EmrSecurityConfiguration.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public EmrSecurityConfiguration(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.emr.EmrSecurityConfigurationConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.emr.EmrSecurityConfiguration}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.emr.EmrSecurityConfiguration> {
        /**
        ...
        private final imports.aws.emr.EmrSecurityConfigurationConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.emr.EmrSecurityConfigurationConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/emr_security_configuration#id EmrSecurityConfiguration#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param name Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/emr_security_configuration#name EmrSecurityConfiguration#name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param namePrefix Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/emr_security_configuration#name_prefix EmrSecurityConfiguration#name_prefix}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.emr.EmrSecurityConfiguration}.
         */
        @Override
        public imports.aws.emr.EmrSecurityConfiguration build() {
            return new imports.aws.emr.EmrSecurityConfiguration(
                this.scope,
                this.id,
                this.config.build()
            );
