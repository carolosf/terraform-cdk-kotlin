...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.emr.EmrClusterCoreInstanceFleetOutputReference")
public class EmrClusterCoreInstanceFleetOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected EmrClusterCoreInstanceFleetOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected EmrClusterCoreInstanceFleetOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public EmrClusterCoreInstanceFleetOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void putLaunchSpecifications(final @org.jetbrains.annotations.NotNull imports.aws.emr.EmrClusterCoreInstanceFleetLaunchSpecifications value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.emr.EmrClusterCoreInstanceFleetInstanceTypeConfigsList getInstanceTypeConfigs() {
        return software.amazon.jsii.Kernel.get(this, "instanceTypeConfigs", software.amazon.jsii.NativeType.forClass(imports.aws.emr.EmrClusterCoreInstanceFleetInstanceTypeConfigsList.class));
    }

    public @org.jetbrains.annotations.NotNull imports.aws.emr.EmrClusterCoreInstanceFleetLaunchSpecificationsOutputReference getLaunchSpecifications() {
        return software.amazon.jsii.Kernel.get(this, "launchSpecifications", software.amazon.jsii.NativeType.forClass(imports.aws.emr.EmrClusterCoreInstanceFleetLaunchSpecificationsOutputReference.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.emr.EmrClusterCoreInstanceFleetLaunchSpecifications getLaunchSpecificationsInput() {
        return software.amazon.jsii.Kernel.get(this, "launchSpecificationsInput", software.amazon.jsii.NativeType.forClass(imports.aws.emr.EmrClusterCoreInstanceFleetLaunchSpecifications.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.emr.EmrClusterCoreInstanceFleet getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.emr.EmrClusterCoreInstanceFleet.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.emr.EmrClusterCoreInstanceFleet value) {
