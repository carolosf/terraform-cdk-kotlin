...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.datapipeline.DataAwsDatapipelinePipelineDefinitionParameterObjectList")
public class DataAwsDatapipelinePipelineDefinitionParameterObjectList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsDatapipelinePipelineDefinitionParameterObjectList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsDatapipelinePipelineDefinitionParameterObjectList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.datapipeline.DataAwsDatapipelinePipelineDefinitionParameterObjectOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.datapipeline.DataAwsDatapipelinePipelineDefinitionParameterObjectOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
