...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.datapipeline.DataAwsDatapipelinePipelineDefinitionPipelineObjectFieldList")
public class DataAwsDatapipelinePipelineDefinitionPipelineObjectFieldList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsDatapipelinePipelineDefinitionPipelineObjectFieldList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsDatapipelinePipelineDefinitionPipelineObjectFieldList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.datapipeline.DataAwsDatapipelinePipelineDefinitionPipelineObjectFieldOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.datapipeline.DataAwsDatapipelinePipelineDefinitionPipelineObjectFieldOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
