...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.datapipeline.DataAwsDatapipelinePipelineDefinitionParameterObjectAttributeList")
public class DataAwsDatapipelinePipelineDefinitionParameterObjectAttributeList extends com.hashicorp.cdktf.ComplexList {

    protected DataAwsDatapipelinePipelineDefinitionParameterObjectAttributeList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsDatapipelinePipelineDefinitionParameterObjectAttributeList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.datapipeline.DataAwsDatapipelinePipelineDefinitionParameterObjectAttributeOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.datapipeline.DataAwsDatapipelinePipelineDefinitionParameterObjectAttributeOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
