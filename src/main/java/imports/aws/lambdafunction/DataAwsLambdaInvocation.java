...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.lambdafunction.DataAwsLambdaInvocation")
public class DataAwsLambdaInvocation extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsLambdaInvocation(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsLambdaInvocation(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.lambdafunction.DataAwsLambdaInvocation.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsLambdaInvocation(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.lambdafunction.DataAwsLambdaInvocationConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.lambdafunction.DataAwsLambdaInvocation}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.lambdafunction.DataAwsLambdaInvocation> {
        /**
        ...
        private final imports.aws.lambdafunction.DataAwsLambdaInvocationConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.lambdafunction.DataAwsLambdaInvocationConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param functionName Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/lambda_invocation#function_name DataAwsLambdaInvocation#function_name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param input Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/lambda_invocation#input DataAwsLambdaInvocation#input}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/lambda_invocation#id DataAwsLambdaInvocation#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param qualifier Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/lambda_invocation#qualifier DataAwsLambdaInvocation#qualifier}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.lambdafunction.DataAwsLambdaInvocation}.
         */
        @Override
        public imports.aws.lambdafunction.DataAwsLambdaInvocation build() {
            return new imports.aws.lambdafunction.DataAwsLambdaInvocation(
                this.scope,
                this.id,
                this.config.build()
            );
