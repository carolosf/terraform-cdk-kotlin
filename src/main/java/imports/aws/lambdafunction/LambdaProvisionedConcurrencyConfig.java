...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.lambdafunction.LambdaProvisionedConcurrencyConfig")
public class LambdaProvisionedConcurrencyConfig extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.lambdafunction.LambdaProvisionedConcurrencyConfig.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public LambdaProvisionedConcurrencyConfig(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.lambdafunction.LambdaProvisionedConcurrencyConfigConfig config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public void putTimeouts(final @org.jetbrains.annotations.NotNull imports.aws.lambdafunction.LambdaProvisionedConcurrencyConfigTimeouts value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.lambdafunction.LambdaProvisionedConcurrencyConfigTimeoutsOutputReference getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.aws.lambdafunction.LambdaProvisionedConcurrencyConfigTimeoutsOutputReference.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.lambdafunction.LambdaProvisionedConcurrencyConfig}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.lambdafunction.LambdaProvisionedConcurrencyConfig> {
        /**
        ...
        private final imports.aws.lambdafunction.LambdaProvisionedConcurrencyConfigConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.lambdafunction.LambdaProvisionedConcurrencyConfigConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param functionName Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/lambda_provisioned_concurrency_config#function_name LambdaProvisionedConcurrencyConfig#function_name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param provisionedConcurrentExecutions Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/lambda_provisioned_concurrency_config#provisioned_concurrent_executions LambdaProvisionedConcurrencyConfig#provisioned_concurrent_executions}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param qualifier Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/lambda_provisioned_concurrency_config#qualifier LambdaProvisionedConcurrencyConfig#qualifier}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/lambda_provisioned_concurrency_config#id LambdaProvisionedConcurrencyConfig#id}. This parameter is required.
         */
         ...
         */
        public Builder timeouts(final imports.aws.lambdafunction.LambdaProvisionedConcurrencyConfigTimeouts timeouts) {
            this.config.timeouts(timeouts);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.aws.lambdafunction.LambdaProvisionedConcurrencyConfig}.
         */
        @Override
        public imports.aws.lambdafunction.LambdaProvisionedConcurrencyConfig build() {
            return new imports.aws.lambdafunction.LambdaProvisionedConcurrencyConfig(
                this.scope,
                this.id,
                this.config.build()
            );
