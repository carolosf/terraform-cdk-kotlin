...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.lambdafunction.LambdaLayerVersionPermission")
public class LambdaLayerVersionPermission extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.lambdafunction.LambdaLayerVersionPermission.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public LambdaLayerVersionPermission(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.lambdafunction.LambdaLayerVersionPermissionConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.lambdafunction.LambdaLayerVersionPermission}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.lambdafunction.LambdaLayerVersionPermission> {
        /**
        ...
        private final imports.aws.lambdafunction.LambdaLayerVersionPermissionConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.lambdafunction.LambdaLayerVersionPermissionConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/lambda_layer_version_permission#id LambdaLayerVersionPermission#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param organizationId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/lambda_layer_version_permission#organization_id LambdaLayerVersionPermission#organization_id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.lambdafunction.LambdaLayerVersionPermission}.
         */
        @Override
        public imports.aws.lambdafunction.LambdaLayerVersionPermission build() {
            return new imports.aws.lambdafunction.LambdaLayerVersionPermission(
                this.scope,
                this.id,
                this.config.build()
            );
