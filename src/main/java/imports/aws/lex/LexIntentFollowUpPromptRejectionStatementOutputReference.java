...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.lex.LexIntentFollowUpPromptRejectionStatementOutputReference")
public class LexIntentFollowUpPromptRejectionStatementOutputReference extends com.hashicorp.cdktf.ComplexObject {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.lex.LexIntentFollowUpPromptRejectionStatementMessageList getMessage() {
        return software.amazon.jsii.Kernel.get(this, "message", software.amazon.jsii.NativeType.forClass(imports.aws.lex.LexIntentFollowUpPromptRejectionStatementMessageList.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.lex.LexIntentFollowUpPromptRejectionStatement getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.lex.LexIntentFollowUpPromptRejectionStatement.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.lex.LexIntentFollowUpPromptRejectionStatement value) {
