...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.lex.LexIntentConclusionStatementMessage")
@software.amazon.jsii.Jsii.Proxy(LexIntentConclusionStatementMessage.Jsii$Proxy.class)
public interface LexIntentConclusionStatementMessage extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link LexIntentConclusionStatementMessage}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link LexIntentConclusionStatementMessage}
     */
    public static final class Builder implements software.amazon.jsii.Builder<LexIntentConclusionStatementMessage> {
        java.lang.String content;
        java.lang.String contentType;
        java.lang.Number groupNumber;

        /**
         * Sets the value of {@link LexIntentConclusionStatementMessage#getContent}
        ...
        /**
         * Sets the value of {@link LexIntentConclusionStatementMessage#getContentType}
        ...
        /**
         * Sets the value of {@link LexIntentConclusionStatementMessage#getGroupNumber}
         ...
         * @return a new instance of {@link LexIntentConclusionStatementMessage}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public LexIntentConclusionStatementMessage build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link LexIntentConclusionStatementMessage}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements LexIntentConclusionStatementMessage {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.lex.LexIntentConclusionStatementMessage"));
        ...
        public final boolean equals(final Object o) {
            ...
            LexIntentConclusionStatementMessage.Jsii$Proxy that = (LexIntentConclusionStatementMessage.Jsii$Proxy) o;
