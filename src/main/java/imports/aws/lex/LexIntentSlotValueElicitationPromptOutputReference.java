...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.lex.LexIntentSlotValueElicitationPromptOutputReference")
public class LexIntentSlotValueElicitationPromptOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected LexIntentSlotValueElicitationPromptOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected LexIntentSlotValueElicitationPromptOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public LexIntentSlotValueElicitationPromptOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public @org.jetbrains.annotations.NotNull imports.aws.lex.LexIntentSlotValueElicitationPromptMessageList getMessage() {
        return software.amazon.jsii.Kernel.get(this, "message", software.amazon.jsii.NativeType.forClass(imports.aws.lex.LexIntentSlotValueElicitationPromptMessageList.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.lex.LexIntentSlotValueElicitationPrompt getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.lex.LexIntentSlotValueElicitationPrompt.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.lex.LexIntentSlotValueElicitationPrompt value) {
