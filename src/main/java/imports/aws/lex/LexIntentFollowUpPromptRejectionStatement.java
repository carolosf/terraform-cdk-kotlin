...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:19.864Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.lex.LexIntentFollowUpPromptRejectionStatement")
@software.amazon.jsii.Jsii.Proxy(LexIntentFollowUpPromptRejectionStatement.Jsii$Proxy.class)
public interface LexIntentFollowUpPromptRejectionStatement extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link LexIntentFollowUpPromptRejectionStatement}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link LexIntentFollowUpPromptRejectionStatement}
     */
    public static final class Builder implements software.amazon.jsii.Builder<LexIntentFollowUpPromptRejectionStatement> {
        java.lang.Object message;
        java.lang.String responseCard;

        /**
         * Sets the value of {@link LexIntentFollowUpPromptRejectionStatement#getMessage}
         ...
         * @return {@code this}
         */
        public Builder message(java.util.List<? extends imports.aws.lex.LexIntentFollowUpPromptRejectionStatementMessage> message) {
            this.message = message;
            return this;
        }

        /**
         * Sets the value of {@link LexIntentFollowUpPromptRejectionStatement#getResponseCard}
         ...
         * @return a new instance of {@link LexIntentFollowUpPromptRejectionStatement}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public LexIntentFollowUpPromptRejectionStatement build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link LexIntentFollowUpPromptRejectionStatement}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements LexIntentFollowUpPromptRejectionStatement {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.lex.LexIntentFollowUpPromptRejectionStatement"));
        ...
        public final boolean equals(final Object o) {
            ...
            LexIntentFollowUpPromptRejectionStatement.Jsii$Proxy that = (LexIntentFollowUpPromptRejectionStatement.Jsii$Proxy) o;
