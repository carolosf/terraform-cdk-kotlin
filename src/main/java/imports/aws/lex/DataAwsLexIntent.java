...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.lex.DataAwsLexIntent")
public class DataAwsLexIntent extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsLexIntent(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsLexIntent(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.lex.DataAwsLexIntent.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsLexIntent(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.lex.DataAwsLexIntentConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.lex.DataAwsLexIntent}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.lex.DataAwsLexIntent> {
        /**
        ...
        private final imports.aws.lex.DataAwsLexIntentConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.lex.DataAwsLexIntentConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/lex_intent#id DataAwsLexIntent#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param version Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/lex_intent#version DataAwsLexIntent#version}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.lex.DataAwsLexIntent}.
         */
        @Override
        public imports.aws.lex.DataAwsLexIntent build() {
            return new imports.aws.lex.DataAwsLexIntent(
                this.scope,
                this.id,
                this.config.build()
            );
