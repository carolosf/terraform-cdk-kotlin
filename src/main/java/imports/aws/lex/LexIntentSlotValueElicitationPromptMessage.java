...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.lex.LexIntentSlotValueElicitationPromptMessage")
@software.amazon.jsii.Jsii.Proxy(LexIntentSlotValueElicitationPromptMessage.Jsii$Proxy.class)
public interface LexIntentSlotValueElicitationPromptMessage extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link LexIntentSlotValueElicitationPromptMessage}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link LexIntentSlotValueElicitationPromptMessage}
     */
    public static final class Builder implements software.amazon.jsii.Builder<LexIntentSlotValueElicitationPromptMessage> {
        java.lang.String content;
        java.lang.String contentType;
        java.lang.Number groupNumber;

        /**
         * Sets the value of {@link LexIntentSlotValueElicitationPromptMessage#getContent}
        ...
        /**
         * Sets the value of {@link LexIntentSlotValueElicitationPromptMessage#getContentType}
        ...
        /**
         * Sets the value of {@link LexIntentSlotValueElicitationPromptMessage#getGroupNumber}
         ...
         * @return a new instance of {@link LexIntentSlotValueElicitationPromptMessage}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public LexIntentSlotValueElicitationPromptMessage build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link LexIntentSlotValueElicitationPromptMessage}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements LexIntentSlotValueElicitationPromptMessage {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.lex.LexIntentSlotValueElicitationPromptMessage"));
        ...
        public final boolean equals(final Object o) {
            ...
            LexIntentSlotValueElicitationPromptMessage.Jsii$Proxy that = (LexIntentSlotValueElicitationPromptMessage.Jsii$Proxy) o;
