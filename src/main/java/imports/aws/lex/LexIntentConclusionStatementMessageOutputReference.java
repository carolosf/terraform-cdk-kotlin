...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.lex.LexIntentConclusionStatementMessageOutputReference")
public class LexIntentConclusionStatementMessageOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected LexIntentConclusionStatementMessageOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected LexIntentConclusionStatementMessageOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.lex.LexIntentConclusionStatementMessage value) {
