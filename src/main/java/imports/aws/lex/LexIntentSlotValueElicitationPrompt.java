...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.lex.LexIntentSlotValueElicitationPrompt")
@software.amazon.jsii.Jsii.Proxy(LexIntentSlotValueElicitationPrompt.Jsii$Proxy.class)
public interface LexIntentSlotValueElicitationPrompt extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link LexIntentSlotValueElicitationPrompt}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link LexIntentSlotValueElicitationPrompt}
     */
    public static final class Builder implements software.amazon.jsii.Builder<LexIntentSlotValueElicitationPrompt> {
        java.lang.Number maxAttempts;
        java.lang.Object message;
        java.lang.String responseCard;

        /**
         * Sets the value of {@link LexIntentSlotValueElicitationPrompt#getMaxAttempts}
        ...
        /**
         * Sets the value of {@link LexIntentSlotValueElicitationPrompt#getMessage}
         ...
         * @return {@code this}
         */
        public Builder message(java.util.List<? extends imports.aws.lex.LexIntentSlotValueElicitationPromptMessage> message) {
            this.message = message;
            return this;
        }

        /**
         * Sets the value of {@link LexIntentSlotValueElicitationPrompt#getResponseCard}
         ...
         * @return a new instance of {@link LexIntentSlotValueElicitationPrompt}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public LexIntentSlotValueElicitationPrompt build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link LexIntentSlotValueElicitationPrompt}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements LexIntentSlotValueElicitationPrompt {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.lex.LexIntentSlotValueElicitationPrompt"));
        ...
        public final boolean equals(final Object o) {
            ...
            LexIntentSlotValueElicitationPrompt.Jsii$Proxy that = (LexIntentSlotValueElicitationPrompt.Jsii$Proxy) o;
