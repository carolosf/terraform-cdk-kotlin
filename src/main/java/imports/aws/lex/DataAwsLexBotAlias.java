...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.lex.DataAwsLexBotAlias")
public class DataAwsLexBotAlias extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsLexBotAlias(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsLexBotAlias(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.lex.DataAwsLexBotAlias.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsLexBotAlias(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.lex.DataAwsLexBotAliasConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.lex.DataAwsLexBotAlias}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.lex.DataAwsLexBotAlias> {
        /**
        ...
        private final imports.aws.lex.DataAwsLexBotAliasConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.lex.DataAwsLexBotAliasConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/lex_bot_alias#id DataAwsLexBotAlias#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.lex.DataAwsLexBotAlias}.
         */
        @Override
        public imports.aws.lex.DataAwsLexBotAlias build() {
            return new imports.aws.lex.DataAwsLexBotAlias(
                this.scope,
                this.id,
                this.config.build()
            );
