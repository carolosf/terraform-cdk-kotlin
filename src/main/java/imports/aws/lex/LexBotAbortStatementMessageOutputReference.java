...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.lex.LexBotAbortStatementMessageOutputReference")
public class LexBotAbortStatementMessageOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected LexBotAbortStatementMessageOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected LexBotAbortStatementMessageOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.lex.LexBotAbortStatementMessage value) {
