...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.lex.DataAwsLexBot")
public class DataAwsLexBot extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataAwsLexBot(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsLexBot(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.lex.DataAwsLexBot.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsLexBot(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.lex.DataAwsLexBotConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IResolvable getChildDirected() {
        return software.amazon.jsii.Kernel.get(this, "childDirected", software.amazon.jsii.NativeType.forClass(com.hashicorp.cdktf.IResolvable.class));
    }
    ...
    public @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IResolvable getDetectSentiment() {
        return software.amazon.jsii.Kernel.get(this, "detectSentiment", software.amazon.jsii.NativeType.forClass(com.hashicorp.cdktf.IResolvable.class));
    }

    public @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IResolvable getEnableModelImprovements() {
        return software.amazon.jsii.Kernel.get(this, "enableModelImprovements", software.amazon.jsii.NativeType.forClass(com.hashicorp.cdktf.IResolvable.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.lex.DataAwsLexBot}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.lex.DataAwsLexBot> {
        /**
        ...
        private final imports.aws.lex.DataAwsLexBotConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.lex.DataAwsLexBotConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param name Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/lex_bot#name DataAwsLexBot#name}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/lex_bot#id DataAwsLexBot#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param version Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/lex_bot#version DataAwsLexBot#version}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.lex.DataAwsLexBot}.
         */
        @Override
        public imports.aws.lex.DataAwsLexBot build() {
            return new imports.aws.lex.DataAwsLexBot(
                this.scope,
                this.id,
                this.config.build()
            );
