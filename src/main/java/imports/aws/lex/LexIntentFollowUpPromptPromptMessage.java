...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.lex.LexIntentFollowUpPromptPromptMessage")
@software.amazon.jsii.Jsii.Proxy(LexIntentFollowUpPromptPromptMessage.Jsii$Proxy.class)
public interface LexIntentFollowUpPromptPromptMessage extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link LexIntentFollowUpPromptPromptMessage}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link LexIntentFollowUpPromptPromptMessage}
     */
    public static final class Builder implements software.amazon.jsii.Builder<LexIntentFollowUpPromptPromptMessage> {
        java.lang.String content;
        java.lang.String contentType;
        java.lang.Number groupNumber;

        /**
         * Sets the value of {@link LexIntentFollowUpPromptPromptMessage#getContent}
        ...
        /**
         * Sets the value of {@link LexIntentFollowUpPromptPromptMessage#getContentType}
        ...
        /**
         * Sets the value of {@link LexIntentFollowUpPromptPromptMessage#getGroupNumber}
         ...
         * @return a new instance of {@link LexIntentFollowUpPromptPromptMessage}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public LexIntentFollowUpPromptPromptMessage build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link LexIntentFollowUpPromptPromptMessage}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements LexIntentFollowUpPromptPromptMessage {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.lex.LexIntentFollowUpPromptPromptMessage"));
        ...
        public final boolean equals(final Object o) {
            ...
            LexIntentFollowUpPromptPromptMessage.Jsii$Proxy that = (LexIntentFollowUpPromptPromptMessage.Jsii$Proxy) o;
