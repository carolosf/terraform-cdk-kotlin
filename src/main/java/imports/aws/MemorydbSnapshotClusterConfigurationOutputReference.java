...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.MemorydbSnapshotClusterConfigurationOutputReference")
public class MemorydbSnapshotClusterConfigurationOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected MemorydbSnapshotClusterConfigurationOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected MemorydbSnapshotClusterConfigurationOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.MemorydbSnapshotClusterConfiguration getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.MemorydbSnapshotClusterConfiguration.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.MemorydbSnapshotClusterConfiguration value) {
