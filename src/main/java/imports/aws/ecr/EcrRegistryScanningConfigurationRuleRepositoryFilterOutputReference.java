...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ecr.EcrRegistryScanningConfigurationRuleRepositoryFilterOutputReference")
public class EcrRegistryScanningConfigurationRuleRepositoryFilterOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected EcrRegistryScanningConfigurationRuleRepositoryFilterOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected EcrRegistryScanningConfigurationRuleRepositoryFilterOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.ecr.EcrRegistryScanningConfigurationRuleRepositoryFilter value) {
