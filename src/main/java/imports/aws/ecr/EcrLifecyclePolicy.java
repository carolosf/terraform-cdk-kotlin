...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ecr.EcrLifecyclePolicy")
public class EcrLifecyclePolicy extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.ecr.EcrLifecyclePolicy.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public EcrLifecyclePolicy(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.ecr.EcrLifecyclePolicyConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.ecr.EcrLifecyclePolicy}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ecr.EcrLifecyclePolicy> {
        /**
        ...
        private final imports.aws.ecr.EcrLifecyclePolicyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.ecr.EcrLifecyclePolicyConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/ecr_lifecycle_policy#id EcrLifecyclePolicy#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.ecr.EcrLifecyclePolicy}.
         */
        @Override
        public imports.aws.ecr.EcrLifecyclePolicy build() {
            return new imports.aws.ecr.EcrLifecyclePolicy(
                this.scope,
                this.id,
                this.config.build()
            );
