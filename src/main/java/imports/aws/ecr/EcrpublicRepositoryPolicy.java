...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ecr.EcrpublicRepositoryPolicy")
public class EcrpublicRepositoryPolicy extends com.hashicorp.cdktf.TerraformResource {

    protected EcrpublicRepositoryPolicy(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected EcrpublicRepositoryPolicy(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.ecr.EcrpublicRepositoryPolicy.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public EcrpublicRepositoryPolicy(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.ecr.EcrpublicRepositoryPolicyConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.ecr.EcrpublicRepositoryPolicy}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ecr.EcrpublicRepositoryPolicy> {
        /**
        ...
        private final imports.aws.ecr.EcrpublicRepositoryPolicyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.ecr.EcrpublicRepositoryPolicyConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/ecrpublic_repository_policy#id EcrpublicRepositoryPolicy#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.ecr.EcrpublicRepositoryPolicy}.
         */
        @Override
        public imports.aws.ecr.EcrpublicRepositoryPolicy build() {
            return new imports.aws.ecr.EcrpublicRepositoryPolicy(
                this.scope,
                this.id,
                this.config.build()
            );
