...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ecr.EcrRepositoryPolicy")
public class EcrRepositoryPolicy extends com.hashicorp.cdktf.TerraformResource {

    protected EcrRepositoryPolicy(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected EcrRepositoryPolicy(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.ecr.EcrRepositoryPolicy.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public EcrRepositoryPolicy(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.ecr.EcrRepositoryPolicyConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.ecr.EcrRepositoryPolicy}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ecr.EcrRepositoryPolicy> {
        /**
        ...
        private final imports.aws.ecr.EcrRepositoryPolicyConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.ecr.EcrRepositoryPolicyConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/ecr_repository_policy#id EcrRepositoryPolicy#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.ecr.EcrRepositoryPolicy}.
         */
        @Override
        public imports.aws.ecr.EcrRepositoryPolicy build() {
            return new imports.aws.ecr.EcrRepositoryPolicy(
                this.scope,
                this.id,
                this.config.build()
            );
