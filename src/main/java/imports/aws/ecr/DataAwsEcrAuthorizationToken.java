...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ecr.DataAwsEcrAuthorizationToken")
public class DataAwsEcrAuthorizationToken extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.ecr.DataAwsEcrAuthorizationToken.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     * @param config
     */
    public DataAwsEcrAuthorizationToken(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.Nullable imports.aws.ecr.DataAwsEcrAuthorizationTokenConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.ecr.DataAwsEcrAuthorizationToken}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ecr.DataAwsEcrAuthorizationToken> {
        /**
        ...
        private imports.aws.ecr.DataAwsEcrAuthorizationTokenConfig.Builder config;
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ecr_authorization_token#id DataAwsEcrAuthorizationToken#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param registryId Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ecr_authorization_token#registry_id DataAwsEcrAuthorizationToken#registry_id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.ecr.DataAwsEcrAuthorizationToken}.
         */
        @Override
        public imports.aws.ecr.DataAwsEcrAuthorizationToken build() {
            return new imports.aws.ecr.DataAwsEcrAuthorizationToken(
                this.scope,
                this.id,
        ...
        private imports.aws.ecr.DataAwsEcrAuthorizationTokenConfig.Builder config() {
            if (this.config == null) {
                this.config = new imports.aws.ecr.DataAwsEcrAuthorizationTokenConfig.Builder();
            }
            return this.config;
        }
    }
