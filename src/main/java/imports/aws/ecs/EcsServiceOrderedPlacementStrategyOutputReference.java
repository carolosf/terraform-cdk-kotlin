...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ecs.EcsServiceOrderedPlacementStrategyOutputReference")
public class EcsServiceOrderedPlacementStrategyOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected EcsServiceOrderedPlacementStrategyOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected EcsServiceOrderedPlacementStrategyOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.ecs.EcsServiceOrderedPlacementStrategy value) {
