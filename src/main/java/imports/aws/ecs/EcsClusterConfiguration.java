...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ecs.EcsClusterConfiguration")
...
public interface EcsClusterConfiguration extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.aws.ecs.EcsClusterConfigurationExecuteCommandConfiguration getExecuteCommandConfiguration() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<EcsClusterConfiguration> {
        imports.aws.ecs.EcsClusterConfigurationExecuteCommandConfiguration executeCommandConfiguration;
         ...
         * @return {@code this}
         */
        public Builder executeCommandConfiguration(imports.aws.ecs.EcsClusterConfigurationExecuteCommandConfiguration executeCommandConfiguration) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements EcsClusterConfiguration {
        private final imports.aws.ecs.EcsClusterConfigurationExecuteCommandConfiguration executeCommandConfiguration;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.executeCommandConfiguration = software.amazon.jsii.Kernel.get(this, "executeCommandConfiguration", software.amazon.jsii.NativeType.forClass(imports.aws.ecs.EcsClusterConfigurationExecuteCommandConfiguration.class));
        }
        ...
        @Override
        public final imports.aws.ecs.EcsClusterConfigurationExecuteCommandConfiguration getExecuteCommandConfiguration() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("hashicorp_aws.ecs.EcsClusterConfiguration"));
