...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ecs.DataAwsEcsTaskDefinition")
public class DataAwsEcsTaskDefinition extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.ecs.DataAwsEcsTaskDefinition.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataAwsEcsTaskDefinition(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.ecs.DataAwsEcsTaskDefinitionConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.ecs.DataAwsEcsTaskDefinition}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.ecs.DataAwsEcsTaskDefinition> {
        /**
        ...
        private final imports.aws.ecs.DataAwsEcsTaskDefinitionConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.ecs.DataAwsEcsTaskDefinitionConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/d/ecs_task_definition#id DataAwsEcsTaskDefinition#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.ecs.DataAwsEcsTaskDefinition}.
         */
        @Override
        public imports.aws.ecs.DataAwsEcsTaskDefinition build() {
            return new imports.aws.ecs.DataAwsEcsTaskDefinition(
                this.scope,
                this.id,
                this.config.build()
            );
