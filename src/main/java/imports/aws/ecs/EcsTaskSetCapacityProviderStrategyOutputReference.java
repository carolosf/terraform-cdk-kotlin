...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.ecs.EcsTaskSetCapacityProviderStrategyOutputReference")
public class EcsTaskSetCapacityProviderStrategyOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected EcsTaskSetCapacityProviderStrategyOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected EcsTaskSetCapacityProviderStrategyOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.ecs.EcsTaskSetCapacityProviderStrategy value) {
