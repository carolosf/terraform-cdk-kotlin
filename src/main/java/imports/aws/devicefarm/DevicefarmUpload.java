...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.devicefarm.DevicefarmUpload")
public class DevicefarmUpload extends com.hashicorp.cdktf.TerraformResource {

    protected DevicefarmUpload(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DevicefarmUpload(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.devicefarm.DevicefarmUpload.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DevicefarmUpload(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.devicefarm.DevicefarmUploadConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.devicefarm.DevicefarmUpload}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.devicefarm.DevicefarmUpload> {
        /**
        ...
        private final imports.aws.devicefarm.DevicefarmUploadConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.devicefarm.DevicefarmUploadConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param contentType Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/devicefarm_upload#content_type DevicefarmUpload#content_type}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/devicefarm_upload#id DevicefarmUpload#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.devicefarm.DevicefarmUpload}.
         */
        @Override
        public imports.aws.devicefarm.DevicefarmUpload build() {
            return new imports.aws.devicefarm.DevicefarmUpload(
                this.scope,
                this.id,
                this.config.build()
            );
