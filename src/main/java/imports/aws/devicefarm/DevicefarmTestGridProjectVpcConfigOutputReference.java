...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.devicefarm.DevicefarmTestGridProjectVpcConfigOutputReference")
public class DevicefarmTestGridProjectVpcConfigOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DevicefarmTestGridProjectVpcConfigOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DevicefarmTestGridProjectVpcConfigOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public DevicefarmTestGridProjectVpcConfigOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.devicefarm.DevicefarmTestGridProjectVpcConfig getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.devicefarm.DevicefarmTestGridProjectVpcConfig.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.devicefarm.DevicefarmTestGridProjectVpcConfig value) {
