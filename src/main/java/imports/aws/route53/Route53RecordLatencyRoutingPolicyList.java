...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.route53.Route53RecordLatencyRoutingPolicyList")
public class Route53RecordLatencyRoutingPolicyList extends com.hashicorp.cdktf.ComplexList {

    protected Route53RecordLatencyRoutingPolicyList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected Route53RecordLatencyRoutingPolicyList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public Route53RecordLatencyRoutingPolicyList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.route53.Route53RecordLatencyRoutingPolicyOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.route53.Route53RecordLatencyRoutingPolicyOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.aws.route53.Route53RecordLatencyRoutingPolicy> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
