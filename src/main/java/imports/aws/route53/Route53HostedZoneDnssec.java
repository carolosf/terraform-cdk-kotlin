...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.route53.Route53HostedZoneDnssec")
public class Route53HostedZoneDnssec extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.route53.Route53HostedZoneDnssec.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public Route53HostedZoneDnssec(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.route53.Route53HostedZoneDnssecConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.route53.Route53HostedZoneDnssec}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.route53.Route53HostedZoneDnssec> {
        /**
        ...
        private final imports.aws.route53.Route53HostedZoneDnssecConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.route53.Route53HostedZoneDnssecConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/route53_hosted_zone_dnssec#id Route53HostedZoneDnssec#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param signingStatus Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/route53_hosted_zone_dnssec#signing_status Route53HostedZoneDnssec#signing_status}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.route53.Route53HostedZoneDnssec}.
         */
        @Override
        public imports.aws.route53.Route53HostedZoneDnssec build() {
            return new imports.aws.route53.Route53HostedZoneDnssec(
                this.scope,
                this.id,
                this.config.build()
            );
