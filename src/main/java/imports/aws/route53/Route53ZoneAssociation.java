...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.route53.Route53ZoneAssociation")
public class Route53ZoneAssociation extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.route53.Route53ZoneAssociation.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public Route53ZoneAssociation(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.route53.Route53ZoneAssociationConfig config) {
    ...
    public @org.jetbrains.annotations.NotNull java.lang.String getOwningAccount() {
        return software.amazon.jsii.Kernel.get(this, "owningAccount", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.aws.route53.Route53ZoneAssociation}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.route53.Route53ZoneAssociation> {
        /**
        ...
        private final imports.aws.route53.Route53ZoneAssociationConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.route53.Route53ZoneAssociationConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/route53_zone_association#id Route53ZoneAssociation#id}. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param vpcRegion Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/route53_zone_association#vpc_region Route53ZoneAssociation#vpc_region}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.route53.Route53ZoneAssociation}.
         */
        @Override
        public imports.aws.route53.Route53ZoneAssociation build() {
            return new imports.aws.route53.Route53ZoneAssociation(
                this.scope,
                this.id,
                this.config.build()
            );
