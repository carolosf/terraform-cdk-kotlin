...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.route53.DataAwsRoute53ResolverEndpointFilterOutputReference")
public class DataAwsRoute53ResolverEndpointFilterOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataAwsRoute53ResolverEndpointFilterOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataAwsRoute53ResolverEndpointFilterOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.route53.DataAwsRoute53ResolverEndpointFilter value) {
