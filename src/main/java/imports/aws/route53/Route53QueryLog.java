...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.route53.Route53QueryLog")
public class Route53QueryLog extends com.hashicorp.cdktf.TerraformResource {

    protected Route53QueryLog(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected Route53QueryLog(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.aws.route53.Route53QueryLog.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public Route53QueryLog(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.aws.route53.Route53QueryLogConfig config) {
    ...
    /**
     * A fluent builder for {@link imports.aws.route53.Route53QueryLog}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.aws.route53.Route53QueryLog> {
        /**
        ...
        private final imports.aws.route53.Route53QueryLogConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.aws.route53.Route53QueryLogConfig.Builder();
        }
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/route53_query_log#id Route53QueryLog#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.aws.route53.Route53QueryLog}.
         */
        @Override
        public imports.aws.route53.Route53QueryLog build() {
            return new imports.aws.route53.Route53QueryLog(
                this.scope,
                this.id,
                this.config.build()
            );
