...
@javax.annotation.Generated(value = "jsii-pacmak/1.65.0 (build 7a02b7f)", date = "2022-08-20T11:58:19.704Z")
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.fsx.FsxOntapFileSystemEndpointsInterclusterList")
public class FsxOntapFileSystemEndpointsInterclusterList extends com.hashicorp.cdktf.ComplexList {

    protected FsxOntapFileSystemEndpointsInterclusterList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected FsxOntapFileSystemEndpointsInterclusterList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public FsxOntapFileSystemEndpointsInterclusterList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.aws.fsx.FsxOntapFileSystemEndpointsInterclusterOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.aws.fsx.FsxOntapFileSystemEndpointsInterclusterOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
