...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.fsx.FsxOpenzfsVolumeUserAndGroupQuotasOutputReference")
public class FsxOpenzfsVolumeUserAndGroupQuotasOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected FsxOpenzfsVolumeUserAndGroupQuotasOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected FsxOpenzfsVolumeUserAndGroupQuotasOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.fsx.FsxOpenzfsVolumeUserAndGroupQuotas value) {
