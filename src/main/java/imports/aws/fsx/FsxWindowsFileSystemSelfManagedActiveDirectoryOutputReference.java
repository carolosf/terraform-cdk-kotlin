...
@software.amazon.jsii.Jsii(module = imports.aws.$Module.class, fqn = "hashicorp_aws.fsx.FsxWindowsFileSystemSelfManagedActiveDirectoryOutputReference")
public class FsxWindowsFileSystemSelfManagedActiveDirectoryOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected FsxWindowsFileSystemSelfManagedActiveDirectoryOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected FsxWindowsFileSystemSelfManagedActiveDirectoryOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public FsxWindowsFileSystemSelfManagedActiveDirectoryOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public @org.jetbrains.annotations.Nullable imports.aws.fsx.FsxWindowsFileSystemSelfManagedActiveDirectory getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.aws.fsx.FsxWindowsFileSystemSelfManagedActiveDirectory.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.aws.fsx.FsxWindowsFileSystemSelfManagedActiveDirectory value) {
